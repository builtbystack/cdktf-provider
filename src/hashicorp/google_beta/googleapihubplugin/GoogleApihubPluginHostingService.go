...
type GoogleApihubPluginHostingService struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apihub_plugin#service_uri GoogleApihubPlugin#service_uri}
