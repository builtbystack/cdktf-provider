...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleParameterManagerRegionalParameterVersion.GoogleParameterManagerRegionalParameterVersionConfig",
		reflect.TypeOf((*GoogleParameterManagerRegionalParameterVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleParameterManagerRegionalParameterVersion.GoogleParameterManagerRegionalParameterVersionTimeouts",
