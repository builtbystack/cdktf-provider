...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamPrincipalAccessBoundaryPolicy.GoogleIamPrincipalAccessBoundaryPolicyConfig",
		reflect.TypeOf((*GoogleIamPrincipalAccessBoundaryPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleIamPrincipalAccessBoundaryPolicy.GoogleIamPrincipalAccessBoundaryPolicyDetails",
		reflect.TypeOf((*GoogleIamPrincipalAccessBoundaryPolicyDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIamPrincipalAccessBoundaryPolicy.GoogleIamPrincipalAccessBoundaryPolicyDetailsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamPrincipalAccessBoundaryPolicy.GoogleIamPrincipalAccessBoundaryPolicyTimeouts",
