...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleFirestoreIndex.GoogleFirestoreIndexFieldsVectorConfig",
		reflect.TypeOf((*GoogleFirestoreIndexFieldsVectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleFirestoreIndex.GoogleFirestoreIndexFieldsVectorConfigFlat",
		reflect.TypeOf((*GoogleFirestoreIndexFieldsVectorConfigFlat)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleFirestoreIndex.GoogleFirestoreIndexFieldsVectorConfigFlatOutputReference",
