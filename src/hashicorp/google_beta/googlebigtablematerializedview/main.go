...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewConfig",
		reflect.TypeOf((*GoogleBigtableMaterializedViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewTimeouts",
