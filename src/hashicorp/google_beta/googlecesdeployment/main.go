...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleCesDeployment.GoogleCesDeploymentChannelProfilePersonaProperty",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleCesDeployment.GoogleCesDeploymentChannelProfileWebWidgetConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleCesDeployment.GoogleCesDeploymentConfig",
		reflect.TypeOf((*GoogleCesDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleCesDeployment.GoogleCesDeploymentTimeouts",
		reflect.TypeOf((*GoogleCesDeploymentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleCesDeployment.GoogleCesDeploymentTimeoutsOutputReference",
