...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterConfig",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterPropertiesList",
