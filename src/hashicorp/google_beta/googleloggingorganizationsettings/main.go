...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsTimeouts",
		reflect.TypeOf((*GoogleLoggingOrganizationSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsTimeoutsOutputReference",
