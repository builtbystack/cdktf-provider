...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleStorageFolder.GoogleStorageFolderConfig",
		reflect.TypeOf((*GoogleStorageFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleStorageFolder.GoogleStorageFolderTimeouts",
		reflect.TypeOf((*GoogleStorageFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleStorageFolder.GoogleStorageFolderTimeoutsOutputReference",
