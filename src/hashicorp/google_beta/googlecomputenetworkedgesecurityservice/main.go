...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeNetworkEdgeSecurityService.GoogleComputeNetworkEdgeSecurityServiceConfig",
		reflect.TypeOf((*GoogleComputeNetworkEdgeSecurityServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeNetworkEdgeSecurityService.GoogleComputeNetworkEdgeSecurityServiceTimeouts",
