...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionConfig",
		reflect.TypeOf((*GoogleSpannerInstancePartitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeouts",
		reflect.TypeOf((*GoogleSpannerInstancePartitionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeoutsOutputReference",
