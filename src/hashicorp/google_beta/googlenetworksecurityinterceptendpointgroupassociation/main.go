...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkSecurityInterceptEndpointGroupAssociation.GoogleNetworkSecurityInterceptEndpointGroupAssociationLocationsDetails",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkSecurityInterceptEndpointGroupAssociation.GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeouts",
		reflect.TypeOf((*GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleNetworkSecurityInterceptEndpointGroupAssociation.GoogleNetworkSecurityInterceptEndpointGroupAssociationTimeoutsOutputReference",
