...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_backup_dr_backup_vault google_backup_dr_backup_vault}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_backup_dr_backup_vault google_backup_dr_backup_vault} Resource.
func NewGoogleBackupDrBackupVault(scope constructs.Construct, id *string, config *GoogleBackupDrBackupVaultConfig) GoogleBackupDrBackupVault {
	...
	_jsii_.Create(
		"google-beta.googleBackupDrBackupVault.GoogleBackupDrBackupVault",
