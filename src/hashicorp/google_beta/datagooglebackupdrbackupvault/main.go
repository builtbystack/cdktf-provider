...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultConfig",
		reflect.TypeOf((*DataGoogleBackupDrBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultEncryptionConfig",
