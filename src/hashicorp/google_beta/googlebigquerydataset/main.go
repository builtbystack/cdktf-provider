...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryDataset.GoogleBigqueryDatasetAccessCondition",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryDataset.GoogleBigqueryDatasetExternalCatalogDatasetOptions",
