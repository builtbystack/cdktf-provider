...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_security_feedback google_apigee_security_feedback}.
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_security_feedback google_apigee_security_feedback} Resource.
func NewGoogleApigeeSecurityFeedback(scope constructs.Construct, id *string, config *GoogleApigeeSecurityFeedbackConfig) GoogleApigeeSecurityFeedback {
	...
	_jsii_.Create(
		"google-beta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedback",
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleApigeeSecurityFeedback)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a GoogleApigeeSecurityFeedback resource upon running "cdktf plan <stack-name>".
func GoogleApigeeSecurityFeedback_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleApigeeSecurityFeedback) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
