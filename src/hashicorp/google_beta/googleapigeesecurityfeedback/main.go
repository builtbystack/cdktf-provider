...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackConfig",
		reflect.TypeOf((*GoogleApigeeSecurityFeedbackConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackFeedbackContexts",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackTimeouts",
