...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingOrganizationBucketConfig.GoogleLoggingOrganizationBucketConfigConfig",
		reflect.TypeOf((*GoogleLoggingOrganizationBucketConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingOrganizationBucketConfig.GoogleLoggingOrganizationBucketConfigIndexConfigs",
		reflect.TypeOf((*GoogleLoggingOrganizationBucketConfigIndexConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleLoggingOrganizationBucketConfig.GoogleLoggingOrganizationBucketConfigIndexConfigsList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleLoggingOrganizationBucketConfig.GoogleLoggingOrganizationBucketConfigIndexConfigsOutputReference",
