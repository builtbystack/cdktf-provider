...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaAcl.GoogleManagedKafkaAclAclEntries",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaAcl.GoogleManagedKafkaAclConfig",
		reflect.TypeOf((*GoogleManagedKafkaAclConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeouts",
