...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorConfig",
		reflect.TypeOf((*GoogleManagedKafkaConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTaskRestartPolicy",
		reflect.TypeOf((*GoogleManagedKafkaConnectorTaskRestartPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTaskRestartPolicyOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTimeouts",
		reflect.TypeOf((*GoogleManagedKafkaConnectorTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTimeoutsOutputReference",
