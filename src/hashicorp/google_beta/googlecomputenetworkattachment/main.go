...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeNetworkAttachment.GoogleComputeNetworkAttachmentConnectionEndpoints",
		reflect.TypeOf((*GoogleComputeNetworkAttachmentConnectionEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeNetworkAttachment.GoogleComputeNetworkAttachmentConnectionEndpointsList",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeNetworkAttachment.GoogleComputeNetworkAttachmentTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeNetworkAttachment.GoogleComputeNetworkAttachmentTimeoutsOutputReference",
