...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeouts",
		reflect.TypeOf((*GoogleGkeBackupRestoreChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeoutsOutputReference",
