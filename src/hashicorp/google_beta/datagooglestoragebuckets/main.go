...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBuckets",
		reflect.TypeOf((*DataGoogleStorageBucketsBuckets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsOutputReference",
