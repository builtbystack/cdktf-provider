...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleFirebaseAppCheckDeviceCheckConfig.GoogleFirebaseAppCheckDeviceCheckConfigConfig",
		reflect.TypeOf((*GoogleFirebaseAppCheckDeviceCheckConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleFirebaseAppCheckDeviceCheckConfig.GoogleFirebaseAppCheckDeviceCheckConfigTimeouts",
		reflect.TypeOf((*GoogleFirebaseAppCheckDeviceCheckConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleFirebaseAppCheckDeviceCheckConfig.GoogleFirebaseAppCheckDeviceCheckConfigTimeoutsOutputReference",
