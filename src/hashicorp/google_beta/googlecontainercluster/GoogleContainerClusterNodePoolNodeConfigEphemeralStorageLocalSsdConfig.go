...
type GoogleContainerClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_container_cluster#data_cache_count GoogleContainerCluster#data_cache_count}
