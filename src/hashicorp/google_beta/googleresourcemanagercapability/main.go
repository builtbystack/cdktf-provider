...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleResourceManagerCapability.GoogleResourceManagerCapabilityConfig",
		reflect.TypeOf((*GoogleResourceManagerCapabilityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleResourceManagerCapability.GoogleResourceManagerCapabilityTimeouts",
		reflect.TypeOf((*GoogleResourceManagerCapabilityTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleResourceManagerCapability.GoogleResourceManagerCapabilityTimeoutsOutputReference",
