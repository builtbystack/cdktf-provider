...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccounts",
		reflect.TypeOf((*DataGoogleServiceAccountsAccounts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccountsList",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleServiceAccounts.DataGoogleServiceAccountsConfig",
