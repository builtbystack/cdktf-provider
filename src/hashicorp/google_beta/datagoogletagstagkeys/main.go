...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysConfig",
		reflect.TypeOf((*DataGoogleTagsTagKeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeys",
		reflect.TypeOf((*DataGoogleTagsTagKeysKeys)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysOutputReference",
