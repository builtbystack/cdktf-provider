...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleStorageManagedFolder.GoogleStorageManagedFolderConfig",
		reflect.TypeOf((*GoogleStorageManagedFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleStorageManagedFolder.GoogleStorageManagedFolderTimeouts",
		reflect.TypeOf((*GoogleStorageManagedFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleStorageManagedFolder.GoogleStorageManagedFolderTimeoutsOutputReference",
