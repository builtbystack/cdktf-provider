...
func init() {
	...
	_jsii_.RegisterClass(
		"google-beta.googleEventarcTrigger.GoogleEventarcTriggerDestinationHttpEndpointOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleEventarcTrigger.GoogleEventarcTriggerDestinationNetworkConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleEventarcTrigger.GoogleEventarcTriggerRetryPolicy",
