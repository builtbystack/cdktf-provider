...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleKmsCryptoKey.GoogleKmsCryptoKeyPrimary",
		reflect.TypeOf((*GoogleKmsCryptoKeyPrimary)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleKmsCryptoKey.GoogleKmsCryptoKeyPrimaryList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleKmsCryptoKey.GoogleKmsCryptoKeyPrimaryOutputReference",
