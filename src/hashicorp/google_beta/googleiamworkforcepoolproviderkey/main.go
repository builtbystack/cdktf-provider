...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKeyConfig",
		reflect.TypeOf((*GoogleIamWorkforcePoolProviderKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKeyKeyData",
		reflect.TypeOf((*GoogleIamWorkforcePoolProviderKeyKeyData)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKeyKeyDataOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKeyTimeouts",
		reflect.TypeOf((*GoogleIamWorkforcePoolProviderKeyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKeyTimeoutsOutputReference",
