...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeDatabase.GoogleBiglakeDatabaseConfig",
		reflect.TypeOf((*GoogleBiglakeDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeDatabase.GoogleBiglakeDatabaseHiveOptions",
		reflect.TypeOf((*GoogleBiglakeDatabaseHiveOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBiglakeDatabase.GoogleBiglakeDatabaseHiveOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeDatabase.GoogleBiglakeDatabaseTimeouts",
		reflect.TypeOf((*GoogleBiglakeDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBiglakeDatabase.GoogleBiglakeDatabaseTimeoutsOutputReference",
