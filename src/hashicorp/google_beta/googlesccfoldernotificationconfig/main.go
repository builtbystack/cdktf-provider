...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccFolderNotificationConfig.GoogleSccFolderNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccFolderNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSccFolderNotificationConfig.GoogleSccFolderNotificationConfigStreamingConfig",
		reflect.TypeOf((*GoogleSccFolderNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleSccFolderNotificationConfig.GoogleSccFolderNotificationConfigStreamingConfigOutputReference",
	...
	_jsii_.RegisterClass(
		"google-beta.googleSccFolderNotificationConfig.GoogleSccFolderNotificationConfigTimeoutsOutputReference",
