...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapWebRegionBackendServiceIamMember.GoogleIapWebRegionBackendServiceIamMemberCondition",
		reflect.TypeOf((*GoogleIapWebRegionBackendServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIapWebRegionBackendServiceIamMember.GoogleIapWebRegionBackendServiceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapWebRegionBackendServiceIamMember.GoogleIapWebRegionBackendServiceIamMemberConfig",
