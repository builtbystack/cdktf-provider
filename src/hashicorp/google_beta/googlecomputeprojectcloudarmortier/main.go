...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeProjectCloudArmorTier.GoogleComputeProjectCloudArmorTierConfig",
		reflect.TypeOf((*GoogleComputeProjectCloudArmorTierConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeProjectCloudArmorTier.GoogleComputeProjectCloudArmorTierTimeouts",
