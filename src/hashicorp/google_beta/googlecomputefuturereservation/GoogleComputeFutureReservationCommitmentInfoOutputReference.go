...
func (g *jsiiProxy_GoogleComputeFutureReservationCommitmentInfoOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleComputeFutureReservationCommitmentInfoOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
