...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeApi.GoogleApigeeApiConfig",
		reflect.TypeOf((*GoogleApigeeApiConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeApi.GoogleApigeeApiMetaData",
		reflect.TypeOf((*GoogleApigeeApiMetaData)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleApigeeApi.GoogleApigeeApiMetaDataList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleApigeeApi.GoogleApigeeApiMetaDataOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeApi.GoogleApigeeApiTimeouts",
		reflect.TypeOf((*GoogleApigeeApiTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleApigeeApi.GoogleApigeeApiTimeoutsOutputReference",
