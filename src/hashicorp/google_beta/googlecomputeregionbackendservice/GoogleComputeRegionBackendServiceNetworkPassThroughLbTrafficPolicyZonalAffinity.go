...
type GoogleComputeRegionBackendServiceNetworkPassThroughLbTrafficPolicyZonalAffinity struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_region_backend_service#spillover GoogleComputeRegionBackendService#spillover}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_region_backend_service#spillover_ratio GoogleComputeRegionBackendService#spillover_ratio}
