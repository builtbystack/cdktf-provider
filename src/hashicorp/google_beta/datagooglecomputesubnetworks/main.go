...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksConfig",
		reflect.TypeOf((*DataGoogleComputeSubnetworksConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworks",
		reflect.TypeOf((*DataGoogleComputeSubnetworksSubnetworks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksOutputReference",
