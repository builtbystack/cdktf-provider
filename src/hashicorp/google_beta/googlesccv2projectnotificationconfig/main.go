...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2ProjectNotificationConfig.GoogleSccV2ProjectNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccV2ProjectNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2ProjectNotificationConfig.GoogleSccV2ProjectNotificationConfigStreamingConfig",
	...
	_jsii_.RegisterClass(
		"google-beta.googleSccV2ProjectNotificationConfig.GoogleSccV2ProjectNotificationConfigTimeoutsOutputReference",
