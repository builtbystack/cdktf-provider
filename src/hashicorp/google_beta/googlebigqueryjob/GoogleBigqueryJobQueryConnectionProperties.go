...
type GoogleBigqueryJobQueryConnectionProperties struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_bigquery_job#key GoogleBigqueryJob#key}
	Key *string `field:"required" json:"key" yaml:"key"`
	// The value of the property to set.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_bigquery_job#value GoogleBigqueryJob#value}
