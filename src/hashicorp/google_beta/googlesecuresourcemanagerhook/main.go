...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "pushOption", GoGetter: "PushOption"},
			_jsii_.MemberProperty{JsiiProperty: "pushOptionInput", GoGetter: "PushOptionInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetPushOption", GoMethod: "ResetPushOption"},
			_jsii_.MemberMethod{JsiiMethod: "resetSensitiveQueryString", GoMethod: "ResetSensitiveQueryString"},
			_jsii_.MemberMethod{JsiiMethod: "resetTimeouts", GoMethod: "ResetTimeouts"},
			_jsii_.MemberProperty{JsiiProperty: "sensitiveQueryString", GoGetter: "SensitiveQueryString"},
			_jsii_.MemberProperty{JsiiProperty: "sensitiveQueryStringInput", GoGetter: "SensitiveQueryStringInput"},
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookConfig",
		reflect.TypeOf((*GoogleSecureSourceManagerHookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookPushOption",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookTimeouts",
