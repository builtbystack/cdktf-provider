...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasConfig",
		reflect.TypeOf((*GoogleSaasRuntimeSaasConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasLocations",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasTimeouts",
