...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeTable.GoogleBiglakeTableConfig",
		reflect.TypeOf((*GoogleBiglakeTableConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeTable.GoogleBiglakeTableHiveOptions",
		reflect.TypeOf((*GoogleBiglakeTableHiveOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBiglakeTable.GoogleBiglakeTableHiveOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeTable.GoogleBiglakeTableTimeouts",
		reflect.TypeOf((*GoogleBiglakeTableTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBiglakeTable.GoogleBiglakeTableTimeoutsOutputReference",
