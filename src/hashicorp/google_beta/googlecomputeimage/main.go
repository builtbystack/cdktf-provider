...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeImage.GoogleComputeImageShieldedInstanceInitialStateKeks",
		reflect.TypeOf((*GoogleComputeImageShieldedInstanceInitialStateKeks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeImage.GoogleComputeImageShieldedInstanceInitialStateKeksList",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeImage.GoogleComputeImageShieldedInstanceInitialStatePk",
	...
	_jsii_.RegisterClass(
		"google-beta.googleComputeImage.GoogleComputeImageSourceDiskEncryptionKeyOutputReference",
