...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingCondition",
		reflect.TypeOf((*GoogleIapTunnelDestGroupIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingConfig",
