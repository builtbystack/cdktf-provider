...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesConfig",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRoles",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesOutputReference",
