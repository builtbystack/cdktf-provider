...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenConfig",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeouts",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeoutsOutputReference",
