...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupAutoAccept",
		reflect.TypeOf((*GoogleNetworkConnectivityGroupAutoAccept)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupAutoAcceptOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupConfig",
		reflect.TypeOf((*GoogleNetworkConnectivityGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupTimeouts",
