...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) IgmpQuery() *string {
	var returns *string
	_jsii_.Get(
		j,
		"igmpQuery",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) IgmpQueryInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"igmpQueryInput",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) MacAddress() *string {
	var returns *string
	_jsii_.Get(
		j,
		"macAddress",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) ParentNicName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"parentNicName",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) Vlan() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"vlan",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) VlanInput() *float64 {
	var returns *float64
	_jsii_.Get(
		j,
		"vlanInput",
...
func NewGoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference {
	...
	_jsii_.Create(
		"google-beta.googleComputeInstanceFromTemplate.GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference",
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference)SetIgmpQuery(val *string) {
...
func (j *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference)SetVlan(val *float64) {
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) ResetIgmpQuery() {
	_jsii_.InvokeVoid(
		g,
		"resetIgmpQuery",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeInstanceFromTemplateNetworkInterfaceOutputReference) ResetVlan() {
	_jsii_.InvokeVoid(
		g,
		"resetVlan",
		nil, // no parameters
