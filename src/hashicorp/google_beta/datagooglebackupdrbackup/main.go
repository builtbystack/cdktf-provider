...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackups",
		reflect.TypeOf((*DataGoogleBackupDrBackupBackups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupConfig",
