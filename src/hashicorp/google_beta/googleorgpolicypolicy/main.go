...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicyDryRunSpec",
		reflect.TypeOf((*GoogleOrgPolicyPolicyDryRunSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicyDryRunSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicyDryRunSpecRules",
	...
	_jsii_.RegisterClass(
		"google-beta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicyDryRunSpecRulesConditionOutputReference",
	...
	_jsii_.RegisterClass(
		"google-beta.googleOrgPolicyPolicy.GoogleOrgPolicyPolicyDryRunSpecRulesValuesOutputReference",
