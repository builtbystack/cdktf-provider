...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleEventarcMessageBus.GoogleEventarcMessageBusConfig",
		reflect.TypeOf((*GoogleEventarcMessageBusConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleEventarcMessageBus.GoogleEventarcMessageBusLoggingConfig",
		reflect.TypeOf((*GoogleEventarcMessageBusLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleEventarcMessageBus.GoogleEventarcMessageBusLoggingConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleEventarcMessageBus.GoogleEventarcMessageBusTimeouts",
		reflect.TypeOf((*GoogleEventarcMessageBusTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleEventarcMessageBus.GoogleEventarcMessageBusTimeoutsOutputReference",
