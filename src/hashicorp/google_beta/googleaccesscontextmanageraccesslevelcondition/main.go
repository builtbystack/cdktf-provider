...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAccessContextManagerAccessLevelCondition.GoogleAccessContextManagerAccessLevelConditionVpcNetworkSources",
		reflect.TypeOf((*GoogleAccessContextManagerAccessLevelConditionVpcNetworkSources)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleAccessContextManagerAccessLevelCondition.GoogleAccessContextManagerAccessLevelConditionVpcNetworkSourcesList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleAccessContextManagerAccessLevelCondition.GoogleAccessContextManagerAccessLevelConditionVpcNetworkSourcesOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAccessContextManagerAccessLevelCondition.GoogleAccessContextManagerAccessLevelConditionVpcNetworkSourcesVpcSubnetwork",
		reflect.TypeOf((*GoogleAccessContextManagerAccessLevelConditionVpcNetworkSourcesVpcSubnetwork)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleAccessContextManagerAccessLevelCondition.GoogleAccessContextManagerAccessLevelConditionVpcNetworkSourcesVpcSubnetworkOutputReference",
