...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberCondition",
		reflect.TypeOf((*GoogleClouddeployCustomTargetTypeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberConfig",
