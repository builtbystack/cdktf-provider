...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleMigrationCenterGroup.GoogleMigrationCenterGroupConfig",
	...
	_jsii_.RegisterClass(
		"google-beta.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeoutsOutputReference",
