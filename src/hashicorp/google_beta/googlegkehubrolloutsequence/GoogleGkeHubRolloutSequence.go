...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_gke_hub_rollout_sequence google_gke_hub_rollout_sequence}.
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_gke_hub_rollout_sequence google_gke_hub_rollout_sequence} Resource.
func NewGoogleGkeHubRolloutSequence(scope constructs.Construct, id *string, config *GoogleGkeHubRolloutSequenceConfig) GoogleGkeHubRolloutSequence {
	...
	_jsii_.Create(
		"google-beta.googleGkeHubRolloutSequence.GoogleGkeHubRolloutSequence",
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleGkeHubRolloutSequence)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a GoogleGkeHubRolloutSequence resource upon running "cdktf plan <stack-name>".
func GoogleGkeHubRolloutSequence_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleGkeHubRolloutSequence) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleGkeHubRolloutSequence) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleGkeHubRolloutSequence) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
