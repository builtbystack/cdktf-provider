...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBeyondcorpSecurityGatewayApplicationIamBinding.GoogleBeyondcorpSecurityGatewayApplicationIamBindingCondition",
		reflect.TypeOf((*GoogleBeyondcorpSecurityGatewayApplicationIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBeyondcorpSecurityGatewayApplicationIamBinding.GoogleBeyondcorpSecurityGatewayApplicationIamBindingConditionOutputReference",
