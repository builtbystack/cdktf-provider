...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/googlebeyondcorpsecuritygatewayapplicationiambinding/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_beyondcorp_security_gateway_application_iam_binding google_beyondcorp_security_gateway_application_iam_binding}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_beyondcorp_security_gateway_application_iam_binding google_beyondcorp_security_gateway_application_iam_binding} Resource.
func NewGoogleBeyondcorpSecurityGatewayApplicationIamBinding(scope constructs.Construct, id *string, config *GoogleBeyondcorpSecurityGatewayApplicationIamBindingConfig) GoogleBeyondcorpSecurityGatewayApplicationIamBinding {
	...
	_jsii_.Create(
		"google-beta.googleBeyondcorpSecurityGatewayApplicationIamBinding.GoogleBeyondcorpSecurityGatewayApplicationIamBinding",
