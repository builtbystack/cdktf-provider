...
type GoogleChronicleWatchlistEntityPopulationMechanism struct {
	// manual block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_chronicle_watchlist#manual GoogleChronicleWatchlist#manual}
