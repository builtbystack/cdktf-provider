...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeDisk.DataGoogleComputeDiskParams",
		reflect.TypeOf((*DataGoogleComputeDiskParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeDisk.DataGoogleComputeDiskParamsList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeDisk.DataGoogleComputeDiskParamsOutputReference",
