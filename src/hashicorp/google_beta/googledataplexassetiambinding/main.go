...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexAssetIamBinding.GoogleDataplexAssetIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexAssetIamBinding.GoogleDataplexAssetIamBindingConfig",
