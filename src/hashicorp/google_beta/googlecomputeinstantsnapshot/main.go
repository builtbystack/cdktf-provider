...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotConfig",
		reflect.TypeOf((*GoogleComputeInstantSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotTimeouts",
		reflect.TypeOf((*GoogleComputeInstantSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotTimeoutsOutputReference",
