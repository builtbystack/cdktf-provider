...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkSecurityInterceptDeployment.GoogleNetworkSecurityInterceptDeploymentTimeouts",
		reflect.TypeOf((*GoogleNetworkSecurityInterceptDeploymentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleNetworkSecurityInterceptDeployment.GoogleNetworkSecurityInterceptDeploymentTimeoutsOutputReference",
