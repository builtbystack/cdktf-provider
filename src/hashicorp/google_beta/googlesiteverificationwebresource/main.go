...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSiteVerificationWebResource.GoogleSiteVerificationWebResourceConfig",
		reflect.TypeOf((*GoogleSiteVerificationWebResourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSiteVerificationWebResource.GoogleSiteVerificationWebResourceSite",
	...
	_jsii_.RegisterClass(
		"google-beta.googleSiteVerificationWebResource.GoogleSiteVerificationWebResourceTimeoutsOutputReference",
