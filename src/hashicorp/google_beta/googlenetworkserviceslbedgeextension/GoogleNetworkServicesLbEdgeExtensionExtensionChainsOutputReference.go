...
func (j *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference {
	_init_.Initialize()
	...
	_jsii_.Create(
		"google-beta.googleNetworkServicesLbEdgeExtension.GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference",
...
func NewGoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference_Override(g GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleNetworkServicesLbEdgeExtensionExtensionChainsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
