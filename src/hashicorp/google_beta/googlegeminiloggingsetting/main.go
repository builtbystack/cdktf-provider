...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingConfig",
		reflect.TypeOf((*GoogleGeminiLoggingSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts",
		reflect.TypeOf((*GoogleGeminiLoggingSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeoutsOutputReference",
