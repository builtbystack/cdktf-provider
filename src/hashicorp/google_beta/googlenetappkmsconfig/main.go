...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetappKmsconfig.GoogleNetappKmsconfigConfig",
		reflect.TypeOf((*GoogleNetappKmsconfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeouts",
		reflect.TypeOf((*GoogleNetappKmsconfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeoutsOutputReference",
