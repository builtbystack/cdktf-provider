...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeouts",
		reflect.TypeOf((*GoogleGkeBackupBackupChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeoutsOutputReference",
