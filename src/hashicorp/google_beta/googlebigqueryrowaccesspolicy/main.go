...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryRowAccessPolicy.GoogleBigqueryRowAccessPolicyConfig",
		reflect.TypeOf((*GoogleBigqueryRowAccessPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBigqueryRowAccessPolicy.GoogleBigqueryRowAccessPolicyTimeouts",
