...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsConfig",
		reflect.TypeOf((*GoogleComputeInstanceSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsMetadata",
		reflect.TypeOf((*GoogleComputeInstanceSettingsMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsMetadataOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsTimeouts",
		reflect.TypeOf((*GoogleComputeInstanceSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsTimeoutsOutputReference",
