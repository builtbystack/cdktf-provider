...
func (j *jsiiProxy_GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList {
	_init_.Initialize()
...
func NewGoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList_Override(g GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCesAppVersionSnapshotExamplesMessagesChunksToolCallToolsetToolList) Resolve(_context cdktf.IResolveContext) interface{} {
