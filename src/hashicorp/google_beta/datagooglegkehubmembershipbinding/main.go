...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingState",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingStateOutputReference",
