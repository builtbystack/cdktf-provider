...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTargetIamMember.GoogleClouddeployTargetIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleClouddeployTargetIamMember.GoogleClouddeployTargetIamMemberConfig",
