...
func init() {
	...
	_jsii_.RegisterClass(
		"google-beta.googleContainerAwsCluster.GoogleContainerAwsClusterAuthorizationAdminGroupsList",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleContainerAwsCluster.GoogleContainerAwsClusterBinaryAuthorization",
		reflect.TypeOf((*GoogleContainerAwsClusterBinaryAuthorization)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleContainerAwsCluster.GoogleContainerAwsClusterBinaryAuthorizationOutputReference",
