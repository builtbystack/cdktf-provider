...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceConfig",
		reflect.TypeOf((*GoogleFirebaseDataConnectServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceTimeouts",
