...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApphubServiceProjectAttachment.GoogleApphubServiceProjectAttachmentConfig",
		reflect.TypeOf((*GoogleApphubServiceProjectAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleApphubServiceProjectAttachment.GoogleApphubServiceProjectAttachmentTimeouts",
