...
type GoogleCloudRunV2WorkerPoolTemplateContainersStartupProbeGrpc struct {
	// Optional.
	//
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_cloud_run_v2_worker_pool#service GoogleCloudRunV2WorkerPool#service}
