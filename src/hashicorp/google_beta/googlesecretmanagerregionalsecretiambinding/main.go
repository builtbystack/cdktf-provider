...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSecretManagerRegionalSecretIamBinding.GoogleSecretManagerRegionalSecretIamBindingCondition",
		reflect.TypeOf((*GoogleSecretManagerRegionalSecretIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleSecretManagerRegionalSecretIamBinding.GoogleSecretManagerRegionalSecretIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSecretManagerRegionalSecretIamBinding.GoogleSecretManagerRegionalSecretIamBindingConfig",
