...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2ProjectSccBigQueryExport.GoogleSccV2ProjectSccBigQueryExportConfig",
		reflect.TypeOf((*GoogleSccV2ProjectSccBigQueryExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2ProjectSccBigQueryExport.GoogleSccV2ProjectSccBigQueryExportTimeouts",
