...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList)SetWrapsSet(val *bool) {
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) ComputeFqn() *string {
	var returns *string
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) Get(index *float64) DataGoogleComputeRoutersRoutersNatsOutputReference {
	if err := d.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns DataGoogleComputeRoutersRoutersNatsOutputReference
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersNatsList) ToString() *string {
	var returns *string
