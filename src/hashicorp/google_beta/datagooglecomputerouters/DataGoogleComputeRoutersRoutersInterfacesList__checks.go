...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersInterfacesList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (d *jsiiProxy_DataGoogleComputeRoutersRoutersInterfacesList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersInterfacesList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_DataGoogleComputeRoutersRoutersInterfacesList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
