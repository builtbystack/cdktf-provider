...
type GoogleCesToolDataStoreToolModalityConfigsGroundingConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#grounding_level GoogleCesTool#grounding_level}
