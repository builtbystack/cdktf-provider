...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/googleapigeednszone/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_dns_zone google_apigee_dns_zone}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_dns_zone google_apigee_dns_zone} Resource.
func NewGoogleApigeeDnsZone(scope constructs.Construct, id *string, config *GoogleApigeeDnsZoneConfig) GoogleApigeeDnsZone {
	...
	_jsii_.Create(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZone",
