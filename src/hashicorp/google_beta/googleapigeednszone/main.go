...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZoneConfig",
		reflect.TypeOf((*GoogleApigeeDnsZoneConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZonePeeringConfig",
		reflect.TypeOf((*GoogleApigeeDnsZonePeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZonePeeringConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZoneTimeouts",
		reflect.TypeOf((*GoogleApigeeDnsZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleApigeeDnsZone.GoogleApigeeDnsZoneTimeoutsOutputReference",
