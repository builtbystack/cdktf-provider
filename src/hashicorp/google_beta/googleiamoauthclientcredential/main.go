...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialConfig",
		reflect.TypeOf((*GoogleIamOauthClientCredentialConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialTimeouts",
		reflect.TypeOf((*GoogleIamOauthClientCredentialTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialTimeoutsOutputReference",
