...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2FolderNotificationConfig.GoogleSccV2FolderNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccV2FolderNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2FolderNotificationConfig.GoogleSccV2FolderNotificationConfigStreamingConfig",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccV2FolderNotificationConfig.GoogleSccV2FolderNotificationConfigTimeouts",
