...
type GoogleCesAppLoggingSettingsBigqueryExportSettings struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_app#dataset GoogleCesApp#dataset}
	Dataset *string `field:"optional" json:"dataset" yaml:"dataset"`
	// Indicates whether the BigQuery export is enabled.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_app#enabled GoogleCesApp#enabled}
