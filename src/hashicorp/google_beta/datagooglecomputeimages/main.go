...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeImages.DataGoogleComputeImagesConfig",
		reflect.TypeOf((*DataGoogleComputeImagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeImages.DataGoogleComputeImagesImages",
		reflect.TypeOf((*DataGoogleComputeImagesImages)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeImages.DataGoogleComputeImagesImagesList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeImages.DataGoogleComputeImagesImagesOutputReference",
