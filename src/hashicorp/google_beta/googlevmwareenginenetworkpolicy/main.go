...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleVmwareengineNetworkPolicy.GoogleVmwareengineNetworkPolicyExternalIp",
		reflect.TypeOf((*GoogleVmwareengineNetworkPolicyExternalIp)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleVmwareengineNetworkPolicy.GoogleVmwareengineNetworkPolicyExternalIpOutputReference",
	...
	_jsii_.RegisterClass(
		"google-beta.googleVmwareengineNetworkPolicy.GoogleVmwareengineNetworkPolicyInternetAccessOutputReference",
