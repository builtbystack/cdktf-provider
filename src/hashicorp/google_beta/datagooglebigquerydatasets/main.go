...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsConfig",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasets",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsDatasets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasetsList",
