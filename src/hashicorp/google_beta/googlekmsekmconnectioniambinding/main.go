...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingCondition",
		reflect.TypeOf((*GoogleKmsEkmConnectionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingConfig",
