...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/datagoogleaccesscontextmanagersupportedservice/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_access_context_manager_supported_service google_access_context_manager_supported_service}.
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ServiceName() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceName",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ServiceNameInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceNameInput",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ServiceSupportStage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"serviceSupportStage",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) SupportedMethods() DataGoogleAccessContextManagerSupportedServiceSupportedMethodsList {
	var returns DataGoogleAccessContextManagerSupportedServiceSupportedMethodsList
	_jsii_.Get(
		j,
		"supportedMethods",
		&returns,
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) SupportStage() *string {
	var returns *string
	_jsii_.Get(
		j,
		"supportStage",
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleAccessContextManagerSupportedService) Title() *string {
	var returns *string
	_jsii_.Get(
		j,
		"title",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_access_context_manager_supported_service google_access_context_manager_supported_service} Data Source.
func NewDataGoogleAccessContextManagerSupportedService(scope constructs.Construct, id *string, config *DataGoogleAccessContextManagerSupportedServiceConfig) DataGoogleAccessContextManagerSupportedService {
	...
	if err := validateNewDataGoogleAccessContextManagerSupportedServiceParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleAccessContextManagerSupportedService{}

	_jsii_.Create(
		"google-beta.dataGoogleAccessContextManagerSupportedService.DataGoogleAccessContextManagerSupportedService",
...
func DataGoogleAccessContextManagerSupportedService_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google-beta.dataGoogleAccessContextManagerSupportedService.DataGoogleAccessContextManagerSupportedService",
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleAccessContextManagerSupportedService) ToString() *string {
	var returns *string
