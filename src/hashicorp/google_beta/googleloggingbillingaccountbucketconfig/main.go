...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingBillingAccountBucketConfig.GoogleLoggingBillingAccountBucketConfigIndexConfigs",
		reflect.TypeOf((*GoogleLoggingBillingAccountBucketConfigIndexConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleLoggingBillingAccountBucketConfig.GoogleLoggingBillingAccountBucketConfigIndexConfigsList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleLoggingBillingAccountBucketConfig.GoogleLoggingBillingAccountBucketConfigIndexConfigsOutputReference",
