...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionTimeouts",
		reflect.TypeOf((*GoogleApigeeSecurityMonitoringConditionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionTimeoutsOutputReference",
