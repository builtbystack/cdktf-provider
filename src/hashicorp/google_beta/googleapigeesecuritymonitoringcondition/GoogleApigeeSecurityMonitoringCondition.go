...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/googleapigeesecuritymonitoringcondition/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_security_monitoring_condition google_apigee_security_monitoring_condition}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_apigee_security_monitoring_condition google_apigee_security_monitoring_condition} Resource.
func NewGoogleApigeeSecurityMonitoringCondition(scope constructs.Construct, id *string, config *GoogleApigeeSecurityMonitoringConditionConfig) GoogleApigeeSecurityMonitoringCondition {
	...
	_jsii_.Create(
		"google-beta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringCondition",
