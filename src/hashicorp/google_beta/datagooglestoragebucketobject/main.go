...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectRetention",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectRetentionOutputReference",
