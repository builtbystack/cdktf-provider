...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeCatalog.GoogleBiglakeCatalogConfig",
		reflect.TypeOf((*GoogleBiglakeCatalogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBiglakeCatalog.GoogleBiglakeCatalogTimeouts",
		reflect.TypeOf((*GoogleBiglakeCatalogTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBiglakeCatalog.GoogleBiglakeCatalogTimeoutsOutputReference",
