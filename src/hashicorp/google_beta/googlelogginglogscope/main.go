...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingLogScope.GoogleLoggingLogScopeConfig",
		reflect.TypeOf((*GoogleLoggingLogScopeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts",
		reflect.TypeOf((*GoogleLoggingLogScopeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleLoggingLogScope.GoogleLoggingLogScopeTimeoutsOutputReference",
