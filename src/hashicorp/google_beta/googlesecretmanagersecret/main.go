...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSecretManagerSecret.GoogleSecretManagerSecretReplicationAuto",
		reflect.TypeOf((*GoogleSecretManagerSecretReplicationAuto)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSecretManagerSecret.GoogleSecretManagerSecretReplicationAutoCustomerManagedEncryption",
	...
	_jsii_.RegisterClass(
		"google-beta.googleSecretManagerSecret.GoogleSecretManagerSecretReplicationAutoOutputReference",
