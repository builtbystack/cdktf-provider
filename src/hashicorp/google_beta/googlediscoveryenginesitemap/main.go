...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineSitemapConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts",
		reflect.TypeOf((*GoogleDiscoveryEngineSitemapTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeoutsOutputReference",
