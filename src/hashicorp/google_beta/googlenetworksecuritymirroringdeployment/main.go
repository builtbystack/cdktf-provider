...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentConfig",
		reflect.TypeOf((*GoogleNetworkSecurityMirroringDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentTimeouts",
		reflect.TypeOf((*GoogleNetworkSecurityMirroringDeploymentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentTimeoutsOutputReference",
