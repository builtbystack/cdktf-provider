...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleBigtableLogicalView.GoogleBigtableLogicalViewConfig",
		reflect.TypeOf((*GoogleBigtableLogicalViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeouts",
		reflect.TypeOf((*GoogleBigtableLogicalViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeoutsOutputReference",
