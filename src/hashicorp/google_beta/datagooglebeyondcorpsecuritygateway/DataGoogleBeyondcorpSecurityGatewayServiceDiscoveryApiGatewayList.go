...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList {
	_init_.Initialize()
...
func NewDataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList_Override(d DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleBeyondcorpSecurityGatewayServiceDiscoveryApiGatewayList) Resolve(_context cdktf.IResolveContext) interface{} {
