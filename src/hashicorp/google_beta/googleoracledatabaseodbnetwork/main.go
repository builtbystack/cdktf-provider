...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkConfig",
		reflect.TypeOf((*GoogleOracleDatabaseOdbNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkTimeouts",
		reflect.TypeOf((*GoogleOracleDatabaseOdbNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkTimeoutsOutputReference",
