...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexDataProduct.GoogleDataplexDataProductAccessGroupsPrincipal",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexDataProduct.GoogleDataplexDataProductConfig",
		reflect.TypeOf((*GoogleDataplexDataProductConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleDataplexDataProduct.GoogleDataplexDataProductTimeouts",
