...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleColabRuntime.GoogleColabRuntimeConfig",
		reflect.TypeOf((*GoogleColabRuntimeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleColabRuntime.GoogleColabRuntimeNotebookRuntimeTemplateRef",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleColabRuntime.GoogleColabRuntimeTimeouts",
		reflect.TypeOf((*GoogleColabRuntimeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleColabRuntime.GoogleColabRuntimeTimeoutsOutputReference",
