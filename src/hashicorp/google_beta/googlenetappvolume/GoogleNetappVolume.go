...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_netapp_volume google_netapp_volume}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_netapp_volume google_netapp_volume} Resource.
func NewGoogleNetappVolume(scope constructs.Construct, id *string, config *GoogleNetappVolumeConfig) GoogleNetappVolume {
	...
	_jsii_.Create(
		"google-beta.googleNetappVolume.GoogleNetappVolume",
