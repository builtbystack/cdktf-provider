...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceSettings",
		reflect.TypeOf((*GoogleHealthcareWorkspaceSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceSettingsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceTimeouts",
