...
type GoogleCloudfunctionsFunctionSecretVolumesVersions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_cloudfunctions_function#path GoogleCloudfunctionsFunction#path}
