...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberCondition",
		reflect.TypeOf((*GoogleVertexAiEndpointIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberConfig",
