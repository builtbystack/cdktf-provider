...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSpannerInstance.GoogleSpannerInstanceAutoscalingConfig",
		reflect.TypeOf((*GoogleSpannerInstanceAutoscalingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSpannerInstance.GoogleSpannerInstanceAutoscalingConfigAsymmetricAutoscalingOptions",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSpannerInstance.GoogleSpannerInstanceAutoscalingConfigAutoscalingLimits",
		reflect.TypeOf((*GoogleSpannerInstanceAutoscalingConfigAutoscalingLimits)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleSpannerInstance.GoogleSpannerInstanceAutoscalingConfigAutoscalingLimitsOutputReference",
