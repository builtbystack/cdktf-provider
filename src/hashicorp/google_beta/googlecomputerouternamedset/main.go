...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetConfig",
		reflect.TypeOf((*GoogleComputeRouterNamedSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetElements",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetTimeouts",
