...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingCondition",
		reflect.TypeOf((*GoogleStorageManagedFolderIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingConfig",
