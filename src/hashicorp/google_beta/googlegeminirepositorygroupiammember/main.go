...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleGeminiRepositoryGroupIamMember.GoogleGeminiRepositoryGroupIamMemberCondition",
		reflect.TypeOf((*GoogleGeminiRepositoryGroupIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleGeminiRepositoryGroupIamMember.GoogleGeminiRepositoryGroupIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleGeminiRepositoryGroupIamMember.GoogleGeminiRepositoryGroupIamMemberConfig",
