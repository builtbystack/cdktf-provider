...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/googleoracledatabaseexadbvmcluster/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_oracle_database_exadb_vm_cluster google_oracle_database_exadb_vm_cluster}.
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_oracle_database_exadb_vm_cluster google_oracle_database_exadb_vm_cluster} Resource.
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleOracleDatabaseExadbVmCluster)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a GoogleOracleDatabaseExadbVmCluster resource upon running "cdktf plan <stack-name>".
func GoogleOracleDatabaseExadbVmCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleOracleDatabaseExadbVmCluster) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
