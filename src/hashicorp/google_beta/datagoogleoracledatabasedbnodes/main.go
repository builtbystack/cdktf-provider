...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleOracleDatabaseDbNodes.DataGoogleOracleDatabaseDbNodesDbNodes",
		reflect.TypeOf((*DataGoogleOracleDatabaseDbNodesDbNodes)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleOracleDatabaseDbNodes.DataGoogleOracleDatabaseDbNodesDbNodesList",
	...
	_jsii_.RegisterClass(
		"google-beta.dataGoogleOracleDatabaseDbNodes.DataGoogleOracleDatabaseDbNodesDbNodesOutputReference",
