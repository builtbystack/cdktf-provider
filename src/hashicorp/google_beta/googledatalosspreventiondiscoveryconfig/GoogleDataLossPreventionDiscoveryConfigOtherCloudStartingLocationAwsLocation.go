...
type GoogleDataLossPreventionDiscoveryConfigOtherCloudStartingLocationAwsLocation struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_data_loss_prevention_discovery_config#account_id GoogleDataLossPreventionDiscoveryConfig#account_id}
	AccountId *string `field:"optional" json:"accountId" yaml:"accountId"`
	// All AWS assets stored in Asset Inventory that didn't match other AWS discovery configs.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_data_loss_prevention_discovery_config#all_asset_inventory_assets GoogleDataLossPreventionDiscoveryConfig#all_asset_inventory_assets}
