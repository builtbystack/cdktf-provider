...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetConfig",
		reflect.TypeOf((*DataGoogleVmwareengineSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetDhcpAddressRanges",
