...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleOrganizations.DataGoogleOrganizationsConfig",
		reflect.TypeOf((*DataGoogleOrganizationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleOrganizations.DataGoogleOrganizationsOrganizations",
		reflect.TypeOf((*DataGoogleOrganizationsOrganizations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleOrganizations.DataGoogleOrganizationsOrganizationsList",
