...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleOracleDatabaseOdbSubnet.GoogleOracleDatabaseOdbSubnetConfig",
		reflect.TypeOf((*GoogleOracleDatabaseOdbSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleOracleDatabaseOdbSubnet.GoogleOracleDatabaseOdbSubnetTimeouts",
