...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberCondition",
		reflect.TypeOf((*GoogleLoggingLogViewIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberConfig",
