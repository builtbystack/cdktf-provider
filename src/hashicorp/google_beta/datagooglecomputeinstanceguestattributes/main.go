...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValue",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesQueryValue)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValueList",
