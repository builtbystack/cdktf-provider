...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google_beta/datagoogleartifactregistrymavenartifact/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_artifact_registry_maven_artifact google_artifact_registry_maven_artifact}.
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ArtifactIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"artifactIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) CreateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"createTime",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) DependsOn() *[]*string {
	var returns *[]*string
	_jsii_.Get(
		j,
		"dependsOn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) FriendlyUniqueId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"friendlyUniqueId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GroupId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GroupIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"groupIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Id() *string {
	var returns *string
	_jsii_.Get(
		j,
		"id",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) IdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"idInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Location() *string {
	var returns *string
	_jsii_.Get(
		j,
		"location",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) LocationInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"locationInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Name() *string {
	var returns *string
	_jsii_.Get(
		j,
		"name",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Node() constructs.Node {
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) PomUri() *string {
	var returns *string
	_jsii_.Get(
		j,
		"pomUri",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Project() *string {
	var returns *string
	_jsii_.Get(
		j,
		"project",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ProjectInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"projectInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) RepositoryId() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryId",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) RepositoryIdInput() *string {
	var returns *string
	_jsii_.Get(
		j,
		"repositoryIdInput",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) TerraformResourceType() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) UpdateTime() *string {
	var returns *string
	_jsii_.Get(
		j,
		"updateTime",
...
func (j *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) Version() *string {
	var returns *string
	_jsii_.Get(
		j,
		"version",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_artifact_registry_maven_artifact google_artifact_registry_maven_artifact} Data Source.
func NewDataGoogleArtifactRegistryMavenArtifact(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryMavenArtifactConfig) DataGoogleArtifactRegistryMavenArtifact {
	...
	if err := validateNewDataGoogleArtifactRegistryMavenArtifactParameters(scope, id, config); err != nil {
		panic(err)
	}
	j := jsiiProxy_DataGoogleArtifactRegistryMavenArtifact{}

	_jsii_.Create(
		"google-beta.dataGoogleArtifactRegistryMavenArtifact.DataGoogleArtifactRegistryMavenArtifact",
...
func DataGoogleArtifactRegistryMavenArtifact_TfResourceType() *string {
	_init_.Initialize()
	var returns *string
	_jsii_.StaticGet(
		"google-beta.dataGoogleArtifactRegistryMavenArtifact.DataGoogleArtifactRegistryMavenArtifact",
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetBooleanMapAttribute(terraformAttribute *string) *map[string]*bool {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetListAttribute(terraformAttribute *string) *[]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetNumberAttribute(terraformAttribute *string) *float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetNumberListAttribute(terraformAttribute *string) *[]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetNumberMapAttribute(terraformAttribute *string) *map[string]*float64 {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetStringAttribute(terraformAttribute *string) *string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) GetStringMapAttribute(terraformAttribute *string) *map[string]*string {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) OverrideLogicalId(newLogicalId *string) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ResetId() {
	_jsii_.InvokeVoid(
		d,
		"resetId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ResetOverrideLogicalId() {
	_jsii_.InvokeVoid(
		d,
		"resetOverrideLogicalId",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ResetProject() {
	_jsii_.InvokeVoid(
		d,
		"resetProject",
		nil, // no parameters
...
func (d *jsiiProxy_DataGoogleArtifactRegistryMavenArtifact) ToString() *string {
	var returns *string
