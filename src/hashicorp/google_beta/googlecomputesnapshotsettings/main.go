...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeSnapshotSettings.GoogleComputeSnapshotSettingsStorageLocationLocations",
		reflect.TypeOf((*GoogleComputeSnapshotSettingsStorageLocationLocations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleComputeSnapshotSettings.GoogleComputeSnapshotSettingsStorageLocationLocationsList",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleComputeSnapshotSettings.GoogleComputeSnapshotSettingsTimeouts",
