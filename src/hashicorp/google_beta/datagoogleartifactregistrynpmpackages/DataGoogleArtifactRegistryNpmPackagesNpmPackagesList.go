...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackagesNpmPackagesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewDataGoogleArtifactRegistryNpmPackagesNpmPackagesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) DataGoogleArtifactRegistryNpmPackagesNpmPackagesList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"google-beta.dataGoogleArtifactRegistryNpmPackages.DataGoogleArtifactRegistryNpmPackagesNpmPackagesList",
...
func NewDataGoogleArtifactRegistryNpmPackagesNpmPackagesList_Override(d DataGoogleArtifactRegistryNpmPackagesNpmPackagesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_DataGoogleArtifactRegistryNpmPackagesNpmPackagesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackagesNpmPackagesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (d *jsiiProxy_DataGoogleArtifactRegistryNpmPackagesNpmPackagesList) Resolve(_context cdktf.IResolveContext) interface{} {
