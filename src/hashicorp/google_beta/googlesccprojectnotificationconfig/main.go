...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleSccProjectNotificationConfig.GoogleSccProjectNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccProjectNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleSccProjectNotificationConfig.GoogleSccProjectNotificationConfigStreamingConfig",
		reflect.TypeOf((*GoogleSccProjectNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleSccProjectNotificationConfig.GoogleSccProjectNotificationConfigStreamingConfigOutputReference",
	...
	_jsii_.RegisterClass(
		"google-beta.googleSccProjectNotificationConfig.GoogleSccProjectNotificationConfigTimeoutsOutputReference",
