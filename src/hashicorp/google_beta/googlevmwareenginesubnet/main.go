...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleVmwareengineSubnet.GoogleVmwareengineSubnetConfig",
		reflect.TypeOf((*GoogleVmwareengineSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleVmwareengineSubnet.GoogleVmwareengineSubnetDhcpAddressRanges",
		reflect.TypeOf((*GoogleVmwareengineSubnetDhcpAddressRanges)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleVmwareengineSubnet.GoogleVmwareengineSubnetDhcpAddressRangesList",
	...
	_jsii_.RegisterClass(
		"google-beta.googleVmwareengineSubnet.GoogleVmwareengineSubnetTimeoutsOutputReference",
