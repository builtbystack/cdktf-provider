...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleParameterManagerParameter.GoogleParameterManagerParameterConfig",
		reflect.TypeOf((*GoogleParameterManagerParameterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleParameterManagerParameter.GoogleParameterManagerParameterPolicyMember",
		reflect.TypeOf((*GoogleParameterManagerParameterPolicyMember)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleParameterManagerParameter.GoogleParameterManagerParameterPolicyMemberList",
	...
	_jsii_.RegisterStruct(
		"google-beta.googleParameterManagerParameter.GoogleParameterManagerParameterTimeouts",
		reflect.TypeOf((*GoogleParameterManagerParameterTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleParameterManagerParameter.GoogleParameterManagerParameterTimeoutsOutputReference",
