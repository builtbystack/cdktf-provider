...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAccessContextManagerServicePerimeterDryRunResource.GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts",
		reflect.TypeOf((*GoogleAccessContextManagerServicePerimeterDryRunResourceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleAccessContextManagerServicePerimeterDryRunResource.GoogleAccessContextManagerServicePerimeterDryRunResourceTimeoutsOutputReference",
