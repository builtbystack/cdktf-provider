...
func init() {
	...
	_jsii_.RegisterStruct(
		"google-beta.googleAlloydbUser.GoogleAlloydbUserConfig",
		reflect.TypeOf((*GoogleAlloydbUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google-beta.googleAlloydbUser.GoogleAlloydbUserTimeouts",
		reflect.TypeOf((*GoogleAlloydbUserTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google-beta.googleAlloydbUser.GoogleAlloydbUserTimeoutsOutputReference",
