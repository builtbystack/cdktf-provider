...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglecomputestoragepooltypes/internal"
...
func NewDataGoogleComputeStoragePoolTypes(scope constructs.Construct, id *string, config *DataGoogleComputeStoragePoolTypesConfig) DataGoogleComputeStoragePoolTypes {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleComputeStoragePoolTypes.DataGoogleComputeStoragePoolTypes",
