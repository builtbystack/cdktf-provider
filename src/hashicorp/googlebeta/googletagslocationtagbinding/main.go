...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingConfig",
		reflect.TypeOf((*GoogleTagsLocationTagBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingTimeouts",
		reflect.TypeOf((*GoogleTagsLocationTagBindingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleTagsLocationTagBinding.GoogleTagsLocationTagBindingTimeoutsOutputReference",
