...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEdgeSecurityService.GoogleComputeNetworkEdgeSecurityServiceConfig",
		reflect.TypeOf((*GoogleComputeNetworkEdgeSecurityServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEdgeSecurityService.GoogleComputeNetworkEdgeSecurityServiceTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkEdgeSecurityServiceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeNetworkEdgeSecurityService.GoogleComputeNetworkEdgeSecurityServiceTimeoutsOutputReference",
