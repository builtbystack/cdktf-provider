...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContactCenterInsightsView.GoogleContactCenterInsightsViewConfig",
		reflect.TypeOf((*GoogleContactCenterInsightsViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleContactCenterInsightsView.GoogleContactCenterInsightsViewTimeouts",
		reflect.TypeOf((*GoogleContactCenterInsightsViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleContactCenterInsightsView.GoogleContactCenterInsightsViewTimeoutsOutputReference",
