...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googledataprocjob/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dataproc_job google_dataproc_job}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dataproc_job google_dataproc_job} Resource.
func NewGoogleDataprocJob(scope constructs.Construct, id *string, config *GoogleDataprocJobConfig) GoogleDataprocJob {
	...
	_jsii_.Create(
		"googlebeta.googleDataprocJob.GoogleDataprocJob",
