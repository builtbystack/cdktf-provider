...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeApi.GoogleApigeeApiConfig",
		reflect.TypeOf((*GoogleApigeeApiConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeApi.GoogleApigeeApiMetaData",
		reflect.TypeOf((*GoogleApigeeApiMetaData)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeApi.GoogleApigeeApiMetaDataList",
	...
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeApi.GoogleApigeeApiMetaDataOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeApi.GoogleApigeeApiTimeouts",
		reflect.TypeOf((*GoogleApigeeApiTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeApi.GoogleApigeeApiTimeoutsOutputReference",
