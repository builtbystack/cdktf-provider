...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployTargetIamBinding.GoogleClouddeployTargetIamBindingCondition",
		reflect.TypeOf((*GoogleClouddeployTargetIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleClouddeployTargetIamBinding.GoogleClouddeployTargetIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployTargetIamBinding.GoogleClouddeployTargetIamBindingConfig",
