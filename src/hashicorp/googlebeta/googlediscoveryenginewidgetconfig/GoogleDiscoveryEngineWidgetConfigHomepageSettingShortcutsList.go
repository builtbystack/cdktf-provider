...
func (j *jsiiProxy_GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList {
	_init_.Initialize()
...
func NewGoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList_Override(g GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleDiscoveryEngineWidgetConfigHomepageSettingShortcutsList) Resolve(_context cdktf.IResolveContext) interface{} {
