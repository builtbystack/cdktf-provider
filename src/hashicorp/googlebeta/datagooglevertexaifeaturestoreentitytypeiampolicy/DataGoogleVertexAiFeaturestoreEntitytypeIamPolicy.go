...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglevertexaifeaturestoreentitytypeiampolicy/internal"
...
func NewDataGoogleVertexAiFeaturestoreEntitytypeIamPolicy(scope constructs.Construct, id *string, config *DataGoogleVertexAiFeaturestoreEntitytypeIamPolicyConfig) DataGoogleVertexAiFeaturestoreEntitytypeIamPolicy {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleVertexAiFeaturestoreEntitytypeIamPolicy.DataGoogleVertexAiFeaturestoreEntitytypeIamPolicy",
