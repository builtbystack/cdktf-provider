...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContainerAzureClient.GoogleContainerAzureClientConfig",
		reflect.TypeOf((*GoogleContainerAzureClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleContainerAzureClient.GoogleContainerAzureClientTimeouts",
		reflect.TypeOf((*GoogleContainerAzureClientTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleContainerAzureClient.GoogleContainerAzureClientTimeoutsOutputReference",
