...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFolderIamBinding.GoogleFolderIamBindingCondition",
		reflect.TypeOf((*GoogleFolderIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFolderIamBinding.GoogleFolderIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFolderIamBinding.GoogleFolderIamBindingConfig",
