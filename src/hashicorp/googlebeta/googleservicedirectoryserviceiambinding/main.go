...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceDirectoryServiceIamBinding.GoogleServiceDirectoryServiceIamBindingCondition",
		reflect.TypeOf((*GoogleServiceDirectoryServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceDirectoryServiceIamBinding.GoogleServiceDirectoryServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceDirectoryServiceIamBinding.GoogleServiceDirectoryServiceIamBindingConfig",
