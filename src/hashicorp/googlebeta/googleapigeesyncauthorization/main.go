...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSyncAuthorization.GoogleApigeeSyncAuthorizationConfig",
		reflect.TypeOf((*GoogleApigeeSyncAuthorizationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSyncAuthorization.GoogleApigeeSyncAuthorizationTimeouts",
		reflect.TypeOf((*GoogleApigeeSyncAuthorizationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeSyncAuthorization.GoogleApigeeSyncAuthorizationTimeoutsOutputReference",
