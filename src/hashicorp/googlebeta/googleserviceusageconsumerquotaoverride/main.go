...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideConfig",
		reflect.TypeOf((*GoogleServiceUsageConsumerQuotaOverrideConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideTimeouts",
		reflect.TypeOf((*GoogleServiceUsageConsumerQuotaOverrideTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceUsageConsumerQuotaOverride.GoogleServiceUsageConsumerQuotaOverrideTimeoutsOutputReference",
