...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleedgenetworkinterconnectattachment/internal"
...
func NewGoogleEdgenetworkInterconnectAttachment(scope constructs.Construct, id *string, config *GoogleEdgenetworkInterconnectAttachmentConfig) GoogleEdgenetworkInterconnectAttachment {
	...
	_jsii_.Create(
		"googlebeta.googleEdgenetworkInterconnectAttachment.GoogleEdgenetworkInterconnectAttachment",
