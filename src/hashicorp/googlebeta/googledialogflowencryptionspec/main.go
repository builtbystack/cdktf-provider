...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDialogflowEncryptionSpec.GoogleDialogflowEncryptionSpecConfig",
		reflect.TypeOf((*GoogleDialogflowEncryptionSpecConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDialogflowEncryptionSpec.GoogleDialogflowEncryptionSpecEncryptionSpec",
		reflect.TypeOf((*GoogleDialogflowEncryptionSpecEncryptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDialogflowEncryptionSpec.GoogleDialogflowEncryptionSpecEncryptionSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDialogflowEncryptionSpec.GoogleDialogflowEncryptionSpecTimeouts",
		reflect.TypeOf((*GoogleDialogflowEncryptionSpecTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDialogflowEncryptionSpec.GoogleDialogflowEncryptionSpecTimeoutsOutputReference",
