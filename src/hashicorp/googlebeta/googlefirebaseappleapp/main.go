...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAppleApp.GoogleFirebaseAppleAppConfig",
		reflect.TypeOf((*GoogleFirebaseAppleAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseAppleAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseAppleApp.GoogleFirebaseAppleAppTimeoutsOutputReference",
