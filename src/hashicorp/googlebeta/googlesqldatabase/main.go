...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSqlDatabase.GoogleSqlDatabaseConfig",
		reflect.TypeOf((*GoogleSqlDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSqlDatabase.GoogleSqlDatabaseTimeouts",
		reflect.TypeOf((*GoogleSqlDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSqlDatabase.GoogleSqlDatabaseTimeoutsOutputReference",
