...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotConfig",
		reflect.TypeOf((*GoogleComputeInstantSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotTimeouts",
		reflect.TypeOf((*GoogleComputeInstantSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstantSnapshot.GoogleComputeInstantSnapshotTimeoutsOutputReference",
