...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextConfig",
		reflect.TypeOf((*GoogleKmsSecretCiphertextConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeouts",
		reflect.TypeOf((*GoogleKmsSecretCiphertextTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleKmsSecretCiphertext.GoogleKmsSecretCiphertextTimeoutsOutputReference",
