...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlenetappstoragepool/internal"
...
func NewGoogleNetappStoragePool(scope constructs.Construct, id *string, config *GoogleNetappStoragePoolConfig) GoogleNetappStoragePool {
	...
	_jsii_.Create(
		"googlebeta.googleNetappStoragePool.GoogleNetappStoragePool",
