...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglegkehubmembershipbinding/internal"
...
func NewDataGoogleGkeHubMembershipBinding(scope constructs.Construct, id *string, config *DataGoogleGkeHubMembershipBindingConfig) DataGoogleGkeHubMembershipBinding {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBinding",
