...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingConfig",
		reflect.TypeOf((*DataGoogleGkeHubMembershipBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingState",
		reflect.TypeOf((*DataGoogleGkeHubMembershipBindingState)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingStateList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingStateOutputReference",
