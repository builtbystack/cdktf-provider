...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupConfig",
		reflect.TypeOf((*GoogleNetworkSecurityAddressGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityAddressGroup.GoogleNetworkSecurityAddressGroupTimeouts",
