...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeImageIamMember.GoogleComputeImageIamMemberCondition",
		reflect.TypeOf((*GoogleComputeImageIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeImageIamMember.GoogleComputeImageIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeImageIamMember.GoogleComputeImageIamMemberConfig",
