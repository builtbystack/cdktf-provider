...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityUrlLists.GoogleNetworkSecurityUrlListsConfig",
		reflect.TypeOf((*GoogleNetworkSecurityUrlListsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityUrlLists.GoogleNetworkSecurityUrlListsTimeouts",
		reflect.TypeOf((*GoogleNetworkSecurityUrlListsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetworkSecurityUrlLists.GoogleNetworkSecurityUrlListsTimeoutsOutputReference",
