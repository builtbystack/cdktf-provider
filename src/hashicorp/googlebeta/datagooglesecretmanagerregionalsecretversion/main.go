...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionConfig",
		reflect.TypeOf((*DataGoogleSecretManagerRegionalSecretVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryption",
		reflect.TypeOf((*DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSecretManagerRegionalSecretVersion.DataGoogleSecretManagerRegionalSecretVersionCustomerManagedEncryptionOutputReference",
