...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccSource.GoogleSccSourceConfig",
		reflect.TypeOf((*GoogleSccSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccSource.GoogleSccSourceTimeouts",
		reflect.TypeOf((*GoogleSccSourceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccSource.GoogleSccSourceTimeoutsOutputReference",
