...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecomputerouternat/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_router_nat google_compute_router_nat}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_router_nat google_compute_router_nat} Resource.
func NewGoogleComputeRouterNat(scope constructs.Construct, id *string, config *GoogleComputeRouterNatConfig) GoogleComputeRouterNat {
	...
	_jsii_.Create(
		"googlebeta.googleComputeRouterNat.GoogleComputeRouterNat",
