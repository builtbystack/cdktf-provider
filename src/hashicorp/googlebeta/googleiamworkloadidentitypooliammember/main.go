...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIamWorkloadIdentityPoolIamMember.GoogleIamWorkloadIdentityPoolIamMemberCondition",
		reflect.TypeOf((*GoogleIamWorkloadIdentityPoolIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIamWorkloadIdentityPoolIamMember.GoogleIamWorkloadIdentityPoolIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIamWorkloadIdentityPoolIamMember.GoogleIamWorkloadIdentityPoolIamMemberConfig",
