...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryConfig",
		reflect.TypeOf((*GoogleCloudbuildv2RepositoryConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryTimeouts",
		reflect.TypeOf((*GoogleCloudbuildv2RepositoryTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudbuildv2Repository.GoogleCloudbuildv2RepositoryTimeoutsOutputReference",
