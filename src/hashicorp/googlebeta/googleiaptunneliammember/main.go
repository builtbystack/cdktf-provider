...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelIamMember.GoogleIapTunnelIamMemberCondition",
		reflect.TypeOf((*GoogleIapTunnelIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapTunnelIamMember.GoogleIapTunnelIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelIamMember.GoogleIapTunnelIamMemberConfig",
