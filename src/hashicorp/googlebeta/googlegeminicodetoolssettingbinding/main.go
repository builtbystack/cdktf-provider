...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiCodeToolsSettingBinding.GoogleGeminiCodeToolsSettingBindingConfig",
		reflect.TypeOf((*GoogleGeminiCodeToolsSettingBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiCodeToolsSettingBinding.GoogleGeminiCodeToolsSettingBindingTimeouts",
