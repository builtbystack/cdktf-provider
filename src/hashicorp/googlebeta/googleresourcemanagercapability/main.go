...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleResourceManagerCapability.GoogleResourceManagerCapabilityConfig",
		reflect.TypeOf((*GoogleResourceManagerCapabilityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleResourceManagerCapability.GoogleResourceManagerCapabilityTimeouts",
		reflect.TypeOf((*GoogleResourceManagerCapabilityTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleResourceManagerCapability.GoogleResourceManagerCapabilityTimeoutsOutputReference",
