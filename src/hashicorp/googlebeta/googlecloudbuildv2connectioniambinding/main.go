...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2ConnectionIamBinding.GoogleCloudbuildv2ConnectionIamBindingCondition",
		reflect.TypeOf((*GoogleCloudbuildv2ConnectionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudbuildv2ConnectionIamBinding.GoogleCloudbuildv2ConnectionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2ConnectionIamBinding.GoogleCloudbuildv2ConnectionIamBindingConfig",
