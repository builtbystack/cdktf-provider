...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentConfig",
		reflect.TypeOf((*GoogleNetworkSecurityMirroringDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentTimeouts",
		reflect.TypeOf((*GoogleNetworkSecurityMirroringDeploymentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetworkSecurityMirroringDeployment.GoogleNetworkSecurityMirroringDeploymentTimeoutsOutputReference",
