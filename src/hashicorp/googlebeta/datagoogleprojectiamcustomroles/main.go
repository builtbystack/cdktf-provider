...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesConfig",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRoles",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesOutputReference",
