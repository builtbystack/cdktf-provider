...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccEventThreatDetectionCustomModule.GoogleSccEventThreatDetectionCustomModuleConfig",
		reflect.TypeOf((*GoogleSccEventThreatDetectionCustomModuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccEventThreatDetectionCustomModule.GoogleSccEventThreatDetectionCustomModuleTimeouts",
		reflect.TypeOf((*GoogleSccEventThreatDetectionCustomModuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccEventThreatDetectionCustomModule.GoogleSccEventThreatDetectionCustomModuleTimeoutsOutputReference",
