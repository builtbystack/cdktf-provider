...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeIcebergNamespaceIamMember)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergNamespaceIamMember.GoogleBiglakeIcebergNamespaceIamMemberCondition",
		reflect.TypeOf((*GoogleBiglakeIcebergNamespaceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBiglakeIcebergNamespaceIamMember.GoogleBiglakeIcebergNamespaceIamMemberConditionOutputReference",
		reflect.TypeOf((*GoogleBiglakeIcebergNamespaceIamMemberConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergNamespaceIamMember.GoogleBiglakeIcebergNamespaceIamMemberConfig",
		reflect.TypeOf((*GoogleBiglakeIcebergNamespaceIamMemberConfig)(nil)).Elem(),
	)
}
