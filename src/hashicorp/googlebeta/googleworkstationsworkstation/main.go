...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstation.GoogleWorkstationsWorkstationConfig",
		reflect.TypeOf((*GoogleWorkstationsWorkstationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstation.GoogleWorkstationsWorkstationTimeouts",
