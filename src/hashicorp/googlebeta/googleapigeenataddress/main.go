...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressConfig",
		reflect.TypeOf((*GoogleApigeeNatAddressConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressTimeouts",
		reflect.TypeOf((*GoogleApigeeNatAddressTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeNatAddress.GoogleApigeeNatAddressTimeoutsOutputReference",
