...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSharedVpcHostProject.GoogleComputeSharedVpcHostProjectConfig",
		reflect.TypeOf((*GoogleComputeSharedVpcHostProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSharedVpcHostProject.GoogleComputeSharedVpcHostProjectTimeouts",
		reflect.TypeOf((*GoogleComputeSharedVpcHostProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSharedVpcHostProject.GoogleComputeSharedVpcHostProjectTimeoutsOutputReference",
