...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseStorageBucket.GoogleFirebaseStorageBucketConfig",
		reflect.TypeOf((*GoogleFirebaseStorageBucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseStorageBucket.GoogleFirebaseStorageBucketTimeouts",
		reflect.TypeOf((*GoogleFirebaseStorageBucketTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseStorageBucket.GoogleFirebaseStorageBucketTimeoutsOutputReference",
