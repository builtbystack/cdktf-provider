...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList {
	_init_.Initialize()
...
func NewGoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList_Override(g GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsParametersList) Resolve(_context cdktf.IResolveContext) interface{} {
