...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleCloudSecurityComplianceFrameworkCloudControlDetailsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList {
	_init_.Initialize()
...
func NewGoogleCloudSecurityComplianceFrameworkCloudControlDetailsList_Override(g GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkCloudControlDetailsList) Resolve(_context cdktf.IResolveContext) interface{} {
