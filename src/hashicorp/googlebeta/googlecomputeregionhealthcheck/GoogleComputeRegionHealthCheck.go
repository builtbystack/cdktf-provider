...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecomputeregionhealthcheck/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_region_health_check google_compute_region_health_check}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_region_health_check google_compute_region_health_check} Resource.
func NewGoogleComputeRegionHealthCheck(scope constructs.Construct, id *string, config *GoogleComputeRegionHealthCheckConfig) GoogleComputeRegionHealthCheck {
	...
	_jsii_.Create(
		"googlebeta.googleComputeRegionHealthCheck.GoogleComputeRegionHealthCheck",
