...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingSite.GoogleFirebaseHostingSiteConfig",
		reflect.TypeOf((*GoogleFirebaseHostingSiteConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeouts",
		reflect.TypeOf((*GoogleFirebaseHostingSiteTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseHostingSite.GoogleFirebaseHostingSiteTimeoutsOutputReference",
