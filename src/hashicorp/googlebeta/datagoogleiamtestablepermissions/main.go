...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsConfig",
		reflect.TypeOf((*DataGoogleIamTestablePermissionsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissions",
		reflect.TypeOf((*DataGoogleIamTestablePermissionsPermissions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleIamTestablePermissions.DataGoogleIamTestablePermissionsPermissionsOutputReference",
