...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkFirewallPolicy.GoogleComputeNetworkFirewallPolicyConfig",
		reflect.TypeOf((*GoogleComputeNetworkFirewallPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkFirewallPolicy.GoogleComputeNetworkFirewallPolicyTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkFirewallPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeNetworkFirewallPolicy.GoogleComputeNetworkFirewallPolicyTimeoutsOutputReference",
