...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudAssetSearchAllResources.DataGoogleCloudAssetSearchAllResourcesConfig",
		reflect.TypeOf((*DataGoogleCloudAssetSearchAllResourcesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudAssetSearchAllResources.DataGoogleCloudAssetSearchAllResourcesResults",
		reflect.TypeOf((*DataGoogleCloudAssetSearchAllResourcesResults)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleCloudAssetSearchAllResources.DataGoogleCloudAssetSearchAllResourcesResultsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleCloudAssetSearchAllResources.DataGoogleCloudAssetSearchAllResourcesResultsOutputReference",
