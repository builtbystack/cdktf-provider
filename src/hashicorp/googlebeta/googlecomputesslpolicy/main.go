...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyConfig",
		reflect.TypeOf((*GoogleComputeSslPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeouts",
		reflect.TypeOf((*GoogleComputeSslPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSslPolicy.GoogleComputeSslPolicyTimeoutsOutputReference",
