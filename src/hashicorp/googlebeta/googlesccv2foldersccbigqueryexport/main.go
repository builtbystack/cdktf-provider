...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2FolderSccBigQueryExport.GoogleSccV2FolderSccBigQueryExportConfig",
		reflect.TypeOf((*GoogleSccV2FolderSccBigQueryExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2FolderSccBigQueryExport.GoogleSccV2FolderSccBigQueryExportTimeouts",
		reflect.TypeOf((*GoogleSccV2FolderSccBigQueryExportTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccV2FolderSccBigQueryExport.GoogleSccV2FolderSccBigQueryExportTimeoutsOutputReference",
