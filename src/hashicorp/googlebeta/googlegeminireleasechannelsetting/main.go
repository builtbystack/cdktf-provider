...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingConfig",
		reflect.TypeOf((*GoogleGeminiReleaseChannelSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingTimeouts",
		reflect.TypeOf((*GoogleGeminiReleaseChannelSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGeminiReleaseChannelSetting.GoogleGeminiReleaseChannelSettingTimeoutsOutputReference",
