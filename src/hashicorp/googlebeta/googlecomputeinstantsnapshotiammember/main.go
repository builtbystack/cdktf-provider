...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshotIamMember.GoogleComputeInstantSnapshotIamMemberCondition",
		reflect.TypeOf((*GoogleComputeInstantSnapshotIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstantSnapshotIamMember.GoogleComputeInstantSnapshotIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshotIamMember.GoogleComputeInstantSnapshotIamMemberConfig",
