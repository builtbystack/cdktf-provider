...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlTiers.DataGoogleSqlTiersConfig",
		reflect.TypeOf((*DataGoogleSqlTiersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlTiers.DataGoogleSqlTiersTiers",
		reflect.TypeOf((*DataGoogleSqlTiersTiers)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlTiers.DataGoogleSqlTiersTiersList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlTiers.DataGoogleSqlTiersTiersOutputReference",
