...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleArtifactRegistryVpcscConfig.GoogleArtifactRegistryVpcscConfigConfig",
		reflect.TypeOf((*GoogleArtifactRegistryVpcscConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleArtifactRegistryVpcscConfig.GoogleArtifactRegistryVpcscConfigTimeouts",
		reflect.TypeOf((*GoogleArtifactRegistryVpcscConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleArtifactRegistryVpcscConfig.GoogleArtifactRegistryVpcscConfigTimeoutsOutputReference",
