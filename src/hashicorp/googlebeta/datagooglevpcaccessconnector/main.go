...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorConfig",
		reflect.TypeOf((*DataGoogleVpcAccessConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnet",
		reflect.TypeOf((*DataGoogleVpcAccessConnectorSubnet)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnetList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVpcAccessConnector.DataGoogleVpcAccessConnectorSubnetOutputReference",
