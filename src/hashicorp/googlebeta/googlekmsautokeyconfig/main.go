...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigConfig",
		reflect.TypeOf((*GoogleKmsAutokeyConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigTimeouts",
		reflect.TypeOf((*GoogleKmsAutokeyConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleKmsAutokeyConfig.GoogleKmsAutokeyConfigTimeoutsOutputReference",
