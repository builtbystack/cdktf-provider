...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogView.GoogleLoggingLogViewConfig",
		reflect.TypeOf((*GoogleLoggingLogViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogView.GoogleLoggingLogViewTimeouts",
		reflect.TypeOf((*GoogleLoggingLogViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingLogView.GoogleLoggingLogViewTimeoutsOutputReference",
