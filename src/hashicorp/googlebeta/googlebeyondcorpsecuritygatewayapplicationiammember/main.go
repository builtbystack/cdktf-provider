...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBeyondcorpSecurityGatewayApplicationIamMember.GoogleBeyondcorpSecurityGatewayApplicationIamMemberCondition",
		reflect.TypeOf((*GoogleBeyondcorpSecurityGatewayApplicationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBeyondcorpSecurityGatewayApplicationIamMember.GoogleBeyondcorpSecurityGatewayApplicationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBeyondcorpSecurityGatewayApplicationIamMember.GoogleBeyondcorpSecurityGatewayApplicationIamMemberConfig",
