...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingCondition",
		reflect.TypeOf((*GoogleBillingAccountIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingAccountIamBinding.GoogleBillingAccountIamBindingConfig",
