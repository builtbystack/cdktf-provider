...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkConfig",
		reflect.TypeOf((*GoogleEdgenetworkNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkTimeouts",
		reflect.TypeOf((*GoogleEdgenetworkNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEdgenetworkNetwork.GoogleEdgenetworkNetworkTimeoutsOutputReference",
