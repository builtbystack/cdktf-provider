...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetTcpProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeouts",
		reflect.TypeOf((*GoogleComputeTargetTcpProxyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeTargetTcpProxy.GoogleComputeTargetTcpProxyTimeoutsOutputReference",
