...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexEntryTypeIamMember.GoogleDataplexEntryTypeIamMemberCondition",
		reflect.TypeOf((*GoogleDataplexEntryTypeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexEntryTypeIamMember.GoogleDataplexEntryTypeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexEntryTypeIamMember.GoogleDataplexEntryTypeIamMemberConfig",
