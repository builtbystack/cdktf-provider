...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberCondition",
		reflect.TypeOf((*GoogleSpannerDatabaseIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSpannerDatabaseIamMember.GoogleSpannerDatabaseIamMemberConfig",
