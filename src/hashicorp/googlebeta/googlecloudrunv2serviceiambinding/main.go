...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudRunV2ServiceIamBinding.GoogleCloudRunV2ServiceIamBindingCondition",
		reflect.TypeOf((*GoogleCloudRunV2ServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudRunV2ServiceIamBinding.GoogleCloudRunV2ServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudRunV2ServiceIamBinding.GoogleCloudRunV2ServiceIamBindingConfig",
