...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeAddresses.DataGoogleComputeAddressesAddresses",
		reflect.TypeOf((*DataGoogleComputeAddressesAddresses)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeAddresses.DataGoogleComputeAddressesAddressesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeAddresses.DataGoogleComputeAddressesAddressesOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeAddresses.DataGoogleComputeAddressesConfig",
