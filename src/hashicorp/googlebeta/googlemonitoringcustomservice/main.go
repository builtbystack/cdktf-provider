...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceConfig",
		reflect.TypeOf((*GoogleMonitoringCustomServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetry",
		reflect.TypeOf((*GoogleMonitoringCustomServiceTelemetry)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTelemetryOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeouts",
		reflect.TypeOf((*GoogleMonitoringCustomServiceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleMonitoringCustomService.GoogleMonitoringCustomServiceTimeoutsOutputReference",
