...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysConfig",
		reflect.TypeOf((*DataGoogleTagsTagKeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeys",
		reflect.TypeOf((*DataGoogleTagsTagKeysKeys)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysOutputReference",
