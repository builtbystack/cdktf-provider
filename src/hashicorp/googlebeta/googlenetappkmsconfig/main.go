...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetappKmsconfig.GoogleNetappKmsconfigConfig",
		reflect.TypeOf((*GoogleNetappKmsconfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeouts",
		reflect.TypeOf((*GoogleNetappKmsconfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetappKmsconfig.GoogleNetappKmsconfigTimeoutsOutputReference",
