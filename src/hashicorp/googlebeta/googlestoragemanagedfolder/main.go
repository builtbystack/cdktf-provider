...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageManagedFolder.GoogleStorageManagedFolderConfig",
		reflect.TypeOf((*GoogleStorageManagedFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageManagedFolder.GoogleStorageManagedFolderTimeouts",
		reflect.TypeOf((*GoogleStorageManagedFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageManagedFolder.GoogleStorageManagedFolderTimeoutsOutputReference",
