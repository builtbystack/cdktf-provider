...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleiamorganizationspolicybinding/internal"
...
func NewGoogleIamOrganizationsPolicyBinding(scope constructs.Construct, id *string, config *GoogleIamOrganizationsPolicyBindingConfig) GoogleIamOrganizationsPolicyBinding {
	...
	_jsii_.Create(
		"googlebeta.googleIamOrganizationsPolicyBinding.GoogleIamOrganizationsPolicyBinding",
