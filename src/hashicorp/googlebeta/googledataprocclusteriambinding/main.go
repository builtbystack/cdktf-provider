...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocClusterIamBinding.GoogleDataprocClusterIamBindingCondition",
		reflect.TypeOf((*GoogleDataprocClusterIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataprocClusterIamBinding.GoogleDataprocClusterIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocClusterIamBinding.GoogleDataprocClusterIamBindingConfig",
