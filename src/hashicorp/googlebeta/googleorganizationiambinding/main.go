...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingCondition",
		reflect.TypeOf((*GoogleOrganizationIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOrganizationIamBinding.GoogleOrganizationIamBindingConfig",
