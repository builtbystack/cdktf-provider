...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberCondition",
		reflect.TypeOf((*GoogleLoggingLogViewIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogViewIamMember.GoogleLoggingLogViewIamMemberConfig",
