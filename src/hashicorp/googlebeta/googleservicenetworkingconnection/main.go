...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionConfig",
		reflect.TypeOf((*GoogleServiceNetworkingConnectionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionTimeouts",
		reflect.TypeOf((*GoogleServiceNetworkingConnectionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceNetworkingConnection.GoogleServiceNetworkingConnectionTimeoutsOutputReference",
