...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googledialogflowcxsecuritysettings/internal"
...
func NewGoogleDialogflowCxSecuritySettings(scope constructs.Construct, id *string, config *GoogleDialogflowCxSecuritySettingsConfig) GoogleDialogflowCxSecuritySettings {
	...
	_jsii_.Create(
		"googlebeta.googleDialogflowCxSecuritySettings.GoogleDialogflowCxSecuritySettings",
