...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlefirebaseappcheckdevicecheckconfig/internal"
...
func NewGoogleFirebaseAppCheckDeviceCheckConfig(scope constructs.Construct, id *string, config *GoogleFirebaseAppCheckDeviceCheckConfigConfig) GoogleFirebaseAppCheckDeviceCheckConfig {
	...
	_jsii_.Create(
		"googlebeta.googleFirebaseAppCheckDeviceCheckConfig.GoogleFirebaseAppCheckDeviceCheckConfig",
