...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshotIamBinding.GoogleComputeInstantSnapshotIamBindingCondition",
		reflect.TypeOf((*GoogleComputeInstantSnapshotIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstantSnapshotIamBinding.GoogleComputeInstantSnapshotIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstantSnapshotIamBinding.GoogleComputeInstantSnapshotIamBindingConfig",
