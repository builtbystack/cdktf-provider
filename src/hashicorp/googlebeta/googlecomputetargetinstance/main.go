...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceConfig",
		reflect.TypeOf((*GoogleComputeTargetInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeouts",
		reflect.TypeOf((*GoogleComputeTargetInstanceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeTargetInstance.GoogleComputeTargetInstanceTimeoutsOutputReference",
