...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeFirewallPolicyAssociation.GoogleComputeFirewallPolicyAssociationConfig",
		reflect.TypeOf((*GoogleComputeFirewallPolicyAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeFirewallPolicyAssociation.GoogleComputeFirewallPolicyAssociationTimeouts",
		reflect.TypeOf((*GoogleComputeFirewallPolicyAssociationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeFirewallPolicyAssociation.GoogleComputeFirewallPolicyAssociationTimeoutsOutputReference",
