...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingCondition",
		reflect.TypeOf((*GoogleStorageManagedFolderIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageManagedFolderIamBinding.GoogleStorageManagedFolderIamBindingConfig",
