...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingCondition",
		reflect.TypeOf((*GooglePubsubTopicIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubTopicIamBinding.GooglePubsubTopicIamBindingConfig",
