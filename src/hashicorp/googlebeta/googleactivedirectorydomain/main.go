...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainConfig",
		reflect.TypeOf((*GoogleActiveDirectoryDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeouts",
		reflect.TypeOf((*GoogleActiveDirectoryDomainTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleActiveDirectoryDomain.GoogleActiveDirectoryDomainTimeoutsOutputReference",
