...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccounts",
		reflect.TypeOf((*DataGoogleServiceAccountsAccounts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccountsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccountsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleServiceAccounts.DataGoogleServiceAccountsConfig",
