...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleserviceaccounts/internal"
...
func NewDataGoogleServiceAccounts(scope constructs.Construct, id *string, config *DataGoogleServiceAccountsConfig) DataGoogleServiceAccounts {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleServiceAccounts.DataGoogleServiceAccounts",
