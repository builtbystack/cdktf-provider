...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsConfig",
		reflect.TypeOf((*GoogleLoggingOrganizationSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsTimeouts",
		reflect.TypeOf((*GoogleLoggingOrganizationSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingOrganizationSettings.GoogleLoggingOrganizationSettingsTimeoutsOutputReference",
