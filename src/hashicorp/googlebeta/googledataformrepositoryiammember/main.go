...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberCondition",
		reflect.TypeOf((*GoogleDataformRepositoryIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataformRepositoryIamMember.GoogleDataformRepositoryIamMemberConfig",
