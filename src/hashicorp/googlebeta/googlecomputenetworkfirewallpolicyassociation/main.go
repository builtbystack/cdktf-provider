...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkFirewallPolicyAssociation.GoogleComputeNetworkFirewallPolicyAssociationConfig",
		reflect.TypeOf((*GoogleComputeNetworkFirewallPolicyAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkFirewallPolicyAssociation.GoogleComputeNetworkFirewallPolicyAssociationTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkFirewallPolicyAssociationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeNetworkFirewallPolicyAssociation.GoogleComputeNetworkFirewallPolicyAssociationTimeoutsOutputReference",
