...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleoracledatabaseexadbvmcluster/internal"
...
func NewGoogleOracleDatabaseExadbVmClusterPropertiesDataCollectionOptionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleOracleDatabaseExadbVmClusterPropertiesDataCollectionOptionsOutputReference {
	...
	_jsii_.Create(
		"googlebeta.googleOracleDatabaseExadbVmCluster.GoogleOracleDatabaseExadbVmClusterPropertiesDataCollectionOptionsOutputReference",
