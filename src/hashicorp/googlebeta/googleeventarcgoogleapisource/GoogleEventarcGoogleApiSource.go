...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleeventarcgoogleapisource/internal"
...
func NewGoogleEventarcGoogleApiSource(scope constructs.Construct, id *string, config *GoogleEventarcGoogleApiSourceConfig) GoogleEventarcGoogleApiSource {
	...
	_jsii_.Create(
		"googlebeta.googleEventarcGoogleApiSource.GoogleEventarcGoogleApiSource",
