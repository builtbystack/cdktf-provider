...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetConfig",
		reflect.TypeOf((*GoogleHealthcareDatasetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetEncryptionSpec",
		reflect.TypeOf((*GoogleHealthcareDatasetEncryptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetEncryptionSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetTimeouts",
		reflect.TypeOf((*GoogleHealthcareDatasetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareDataset.GoogleHealthcareDatasetTimeoutsOutputReference",
