...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelConfig",
		reflect.TypeOf((*GoogleGkeBackupRestoreChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeouts",
		reflect.TypeOf((*GoogleGkeBackupRestoreChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeBackupRestoreChannel.GoogleGkeBackupRestoreChannelTimeoutsOutputReference",
