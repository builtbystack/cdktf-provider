...
func (g *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (g *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validatePutCaParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsCa; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validatePutClientParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsClient; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validatePutHeaderParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsHeader; received %#v (a %T)", value, value)
		}
	}
...
func (g *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHosts; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_GoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewGoogleContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
