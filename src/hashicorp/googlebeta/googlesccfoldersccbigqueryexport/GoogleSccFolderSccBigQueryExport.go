...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlesccfoldersccbigqueryexport/internal"
...
func NewGoogleSccFolderSccBigQueryExport(scope constructs.Construct, id *string, config *GoogleSccFolderSccBigQueryExportConfig) GoogleSccFolderSccBigQueryExport {
	...
	_jsii_.Create(
		"googlebeta.googleSccFolderSccBigQueryExport.GoogleSccFolderSccBigQueryExport",
