...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZonesConfig",
		reflect.TypeOf((*DataGoogleDnsManagedZonesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZonesManagedZones",
		reflect.TypeOf((*DataGoogleDnsManagedZonesManagedZones)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZonesManagedZonesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZonesManagedZonesOutputReference",
