...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglednsmanagedzones/internal"
...
func NewDataGoogleDnsManagedZones(scope constructs.Construct, id *string, config *DataGoogleDnsManagedZonesConfig) DataGoogleDnsManagedZones {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleDnsManagedZones.DataGoogleDnsManagedZones",
