...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAndroidApp.GoogleFirebaseAndroidAppConfig",
		reflect.TypeOf((*GoogleFirebaseAndroidAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAndroidApp.GoogleFirebaseAndroidAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseAndroidAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseAndroidApp.GoogleFirebaseAndroidAppTimeoutsOutputReference",
