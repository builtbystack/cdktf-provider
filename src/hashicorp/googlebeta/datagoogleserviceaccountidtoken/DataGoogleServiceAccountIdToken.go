...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleserviceaccountidtoken/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_service_account_id_token google_service_account_id_token}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_service_account_id_token google_service_account_id_token} Data Source.
func NewDataGoogleServiceAccountIdToken(scope constructs.Construct, id *string, config *DataGoogleServiceAccountIdTokenConfig) DataGoogleServiceAccountIdToken {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleServiceAccountIdToken.DataGoogleServiceAccountIdToken",
