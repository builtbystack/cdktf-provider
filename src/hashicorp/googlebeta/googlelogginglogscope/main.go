...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogScope.GoogleLoggingLogScopeConfig",
		reflect.TypeOf((*GoogleLoggingLogScopeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogScope.GoogleLoggingLogScopeTimeouts",
		reflect.TypeOf((*GoogleLoggingLogScopeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingLogScope.GoogleLoggingLogScopeTimeoutsOutputReference",
