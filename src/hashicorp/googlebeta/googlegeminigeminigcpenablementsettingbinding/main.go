...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiGeminiGcpEnablementSettingBinding.GoogleGeminiGeminiGcpEnablementSettingBindingConfig",
		reflect.TypeOf((*GoogleGeminiGeminiGcpEnablementSettingBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiGeminiGcpEnablementSettingBinding.GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts",
		reflect.TypeOf((*GoogleGeminiGeminiGcpEnablementSettingBindingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGeminiGeminiGcpEnablementSettingBinding.GoogleGeminiGeminiGcpEnablementSettingBindingTimeoutsOutputReference",
