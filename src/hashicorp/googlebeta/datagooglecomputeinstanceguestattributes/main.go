...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValue",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesQueryValue)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValueList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValueOutputReference",
