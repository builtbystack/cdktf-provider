...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeMachineImageIamMember.GoogleComputeMachineImageIamMemberCondition",
		reflect.TypeOf((*GoogleComputeMachineImageIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeMachineImageIamMember.GoogleComputeMachineImageIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeMachineImageIamMember.GoogleComputeMachineImageIamMemberConfig",
