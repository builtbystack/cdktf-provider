...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingCondition",
		reflect.TypeOf((*GoogleStorageBucketIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingConfig",
		reflect.TypeOf((*GoogleStorageBucketIamBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageBucketIamBinding.GoogleStorageBucketIamBindingTimeouts",
