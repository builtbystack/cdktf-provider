...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceNetworkingPeeredDnsDomain.GoogleServiceNetworkingPeeredDnsDomainConfig",
		reflect.TypeOf((*GoogleServiceNetworkingPeeredDnsDomainConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceNetworkingPeeredDnsDomain.GoogleServiceNetworkingPeeredDnsDomainTimeouts",
		reflect.TypeOf((*GoogleServiceNetworkingPeeredDnsDomainTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceNetworkingPeeredDnsDomain.GoogleServiceNetworkingPeeredDnsDomainTimeoutsOutputReference",
