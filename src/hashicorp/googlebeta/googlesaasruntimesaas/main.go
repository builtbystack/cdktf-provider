...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasConfig",
		reflect.TypeOf((*GoogleSaasRuntimeSaasConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasLocations",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSaasRuntimeSaas.GoogleSaasRuntimeSaasTimeouts",
