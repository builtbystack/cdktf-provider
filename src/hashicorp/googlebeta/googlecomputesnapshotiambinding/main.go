...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSnapshotIamBinding.GoogleComputeSnapshotIamBindingCondition",
		reflect.TypeOf((*GoogleComputeSnapshotIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSnapshotIamBinding.GoogleComputeSnapshotIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSnapshotIamBinding.GoogleComputeSnapshotIamBindingConfig",
