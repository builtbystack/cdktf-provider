...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlCaCerts.DataGoogleSqlCaCertsCerts",
		reflect.TypeOf((*DataGoogleSqlCaCertsCerts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlCaCerts.DataGoogleSqlCaCertsCertsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlCaCerts.DataGoogleSqlCaCertsCertsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlCaCerts.DataGoogleSqlCaCertsConfig",
