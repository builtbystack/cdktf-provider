...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingCondition",
		reflect.TypeOf((*GooglePubsubSubscriptionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSubscriptionIamBinding.GooglePubsubSubscriptionIamBindingConfig",
