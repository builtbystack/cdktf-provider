...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudRunV2ServiceIamMember.GoogleCloudRunV2ServiceIamMemberCondition",
		reflect.TypeOf((*GoogleCloudRunV2ServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudRunV2ServiceIamMember.GoogleCloudRunV2ServiceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudRunV2ServiceIamMember.GoogleCloudRunV2ServiceIamMemberConfig",
