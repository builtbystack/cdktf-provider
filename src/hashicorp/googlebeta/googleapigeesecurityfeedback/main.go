...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackConfig",
		reflect.TypeOf((*GoogleApigeeSecurityFeedbackConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackFeedbackContexts",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityFeedback.GoogleApigeeSecurityFeedbackTimeouts",
