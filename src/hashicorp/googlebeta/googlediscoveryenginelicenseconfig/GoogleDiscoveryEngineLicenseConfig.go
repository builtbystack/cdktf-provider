...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlediscoveryenginelicenseconfig/internal"
...
func NewGoogleDiscoveryEngineLicenseConfig(scope constructs.Construct, id *string, config *GoogleDiscoveryEngineLicenseConfigConfig) GoogleDiscoveryEngineLicenseConfig {
	...
	_jsii_.Create(
		"googlebeta.googleDiscoveryEngineLicenseConfig.GoogleDiscoveryEngineLicenseConfig",
