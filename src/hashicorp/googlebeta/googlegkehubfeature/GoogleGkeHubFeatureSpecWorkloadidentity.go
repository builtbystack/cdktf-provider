...
type GoogleGkeHubFeatureSpecWorkloadidentity struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_gke_hub_feature#scope_tenancy_pool GoogleGkeHubFeature#scope_tenancy_pool}
