...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigqueryRowAccessPolicy.GoogleBigqueryRowAccessPolicyConfig",
		reflect.TypeOf((*GoogleBigqueryRowAccessPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigqueryRowAccessPolicy.GoogleBigqueryRowAccessPolicyTimeouts",
