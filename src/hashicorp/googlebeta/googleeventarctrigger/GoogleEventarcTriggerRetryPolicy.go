...
type GoogleEventarcTriggerRetryPolicy struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_eventarc_trigger#max_attempts GoogleEventarcTrigger#max_attempts}
