...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleArtifactRegistryRepositoryIamBinding.GoogleArtifactRegistryRepositoryIamBindingCondition",
		reflect.TypeOf((*GoogleArtifactRegistryRepositoryIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleArtifactRegistryRepositoryIamBinding.GoogleArtifactRegistryRepositoryIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleArtifactRegistryRepositoryIamBinding.GoogleArtifactRegistryRepositoryIamBindingConfig",
