...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleorganizationiamcustomrole/internal"
...
func NewDataGoogleOrganizationIamCustomRole(scope constructs.Construct, id *string, config *DataGoogleOrganizationIamCustomRoleConfig) DataGoogleOrganizationIamCustomRole {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleOrganizationIamCustomRole.DataGoogleOrganizationIamCustomRole",
