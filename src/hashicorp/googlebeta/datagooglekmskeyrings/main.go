...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsConfig",
		reflect.TypeOf((*DataGoogleKmsKeyRingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRings",
		reflect.TypeOf((*DataGoogleKmsKeyRingsKeyRings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRingsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRingsOutputReference",
