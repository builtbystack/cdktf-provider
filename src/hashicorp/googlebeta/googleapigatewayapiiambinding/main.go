...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingCondition",
		reflect.TypeOf((*GoogleApiGatewayApiIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayApiIamBinding.GoogleApiGatewayApiIamBindingConfig",
