...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleParameterManagerRegionalParameterVersion.GoogleParameterManagerRegionalParameterVersionConfig",
		reflect.TypeOf((*GoogleParameterManagerRegionalParameterVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleParameterManagerRegionalParameterVersion.GoogleParameterManagerRegionalParameterVersionTimeouts",
