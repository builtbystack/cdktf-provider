...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccount.GoogleServiceAccountConfig",
		reflect.TypeOf((*GoogleServiceAccountConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccount.GoogleServiceAccountTimeouts",
		reflect.TypeOf((*GoogleServiceAccountTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceAccount.GoogleServiceAccountTimeoutsOutputReference",
