...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkConfig",
		reflect.TypeOf((*DataGoogleComputeSubnetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRange",
		reflect.TypeOf((*DataGoogleComputeSubnetworkSecondaryIpRange)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRangeList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeSubnetwork.DataGoogleComputeSubnetworkSecondaryIpRangeOutputReference",
