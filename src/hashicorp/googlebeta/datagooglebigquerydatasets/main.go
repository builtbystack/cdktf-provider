...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsConfig",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasets",
		reflect.TypeOf((*DataGoogleBigqueryDatasetsDatasets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasetsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBigqueryDatasets.DataGoogleBigqueryDatasetsDatasetsOutputReference",
