...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRouterInterface.GoogleComputeRouterInterfaceConfig",
		reflect.TypeOf((*GoogleComputeRouterInterfaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRouterInterface.GoogleComputeRouterInterfaceTimeouts",
