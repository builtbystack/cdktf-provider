...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsProjectKajPolicyConfig.GoogleKmsProjectKajPolicyConfigConfig",
		reflect.TypeOf((*GoogleKmsProjectKajPolicyConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsProjectKajPolicyConfig.GoogleKmsProjectKajPolicyConfigDefaultKeyAccessJustificationPolicy",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsProjectKajPolicyConfig.GoogleKmsProjectKajPolicyConfigTimeouts",
