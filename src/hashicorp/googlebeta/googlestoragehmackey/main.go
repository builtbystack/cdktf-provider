...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageHmacKey.GoogleStorageHmacKeyConfig",
		reflect.TypeOf((*GoogleStorageHmacKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageHmacKey.GoogleStorageHmacKeyTimeouts",
		reflect.TypeOf((*GoogleStorageHmacKeyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageHmacKey.GoogleStorageHmacKeyTimeoutsOutputReference",
