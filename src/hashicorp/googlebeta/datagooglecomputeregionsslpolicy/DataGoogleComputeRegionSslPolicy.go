...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglecomputeregionsslpolicy/internal"
...
func NewDataGoogleComputeRegionSslPolicy(scope constructs.Construct, id *string, config *DataGoogleComputeRegionSslPolicyConfig) DataGoogleComputeRegionSslPolicy {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleComputeRegionSslPolicy.DataGoogleComputeRegionSslPolicy",
