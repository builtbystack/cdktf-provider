...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentConfig",
		reflect.TypeOf((*GoogleApigeeEndpointAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeouts",
		reflect.TypeOf((*GoogleApigeeEndpointAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeEndpointAttachment.GoogleApigeeEndpointAttachmentTimeoutsOutputReference",
