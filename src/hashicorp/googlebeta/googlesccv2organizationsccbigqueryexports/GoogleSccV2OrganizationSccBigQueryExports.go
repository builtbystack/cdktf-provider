...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlesccv2organizationsccbigqueryexports/internal"
...
func NewGoogleSccV2OrganizationSccBigQueryExports(scope constructs.Construct, id *string, config *GoogleSccV2OrganizationSccBigQueryExportsConfig) GoogleSccV2OrganizationSccBigQueryExports {
	...
	_jsii_.Create(
		"googlebeta.googleSccV2OrganizationSccBigQueryExports.GoogleSccV2OrganizationSccBigQueryExports",
