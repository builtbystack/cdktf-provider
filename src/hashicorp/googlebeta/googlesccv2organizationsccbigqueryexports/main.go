...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2OrganizationSccBigQueryExports.GoogleSccV2OrganizationSccBigQueryExportsConfig",
		reflect.TypeOf((*GoogleSccV2OrganizationSccBigQueryExportsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2OrganizationSccBigQueryExports.GoogleSccV2OrganizationSccBigQueryExportsTimeouts",
		reflect.TypeOf((*GoogleSccV2OrganizationSccBigQueryExportsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccV2OrganizationSccBigQueryExports.GoogleSccV2OrganizationSccBigQueryExportsTimeoutsOutputReference",
