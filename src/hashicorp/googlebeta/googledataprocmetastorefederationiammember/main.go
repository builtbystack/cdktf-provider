...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocMetastoreFederationIamMember.GoogleDataprocMetastoreFederationIamMemberCondition",
		reflect.TypeOf((*GoogleDataprocMetastoreFederationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataprocMetastoreFederationIamMember.GoogleDataprocMetastoreFederationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocMetastoreFederationIamMember.GoogleDataprocMetastoreFederationIamMemberConfig",
