...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapWebBackendServiceIamMember.GoogleIapWebBackendServiceIamMemberCondition",
		reflect.TypeOf((*GoogleIapWebBackendServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapWebBackendServiceIamMember.GoogleIapWebBackendServiceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapWebBackendServiceIamMember.GoogleIapWebBackendServiceIamMemberConfig",
