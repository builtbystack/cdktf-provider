...
func init() {
	_jsii_.RegisterClass(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGateway",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayConfig",
		reflect.TypeOf((*GoogleComputeVpnGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayParams",
		reflect.TypeOf((*GoogleComputeVpnGatewayParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayParamsOutputReference",
		reflect.TypeOf((*GoogleComputeVpnGatewayParamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeouts",
		reflect.TypeOf((*GoogleComputeVpnGatewayTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeVpnGateway.GoogleComputeVpnGatewayTimeoutsOutputReference",
