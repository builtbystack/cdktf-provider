...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberCondition",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudfunctions2FunctionIamMember.GoogleCloudfunctions2FunctionIamMemberConfig",
