...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlechronicleruledeployment/internal"
...
func NewGoogleChronicleRuleDeployment(scope constructs.Construct, id *string, config *GoogleChronicleRuleDeploymentConfig) GoogleChronicleRuleDeployment {
	...
	_jsii_.Create(
		"googlebeta.googleChronicleRuleDeployment.GoogleChronicleRuleDeployment",
