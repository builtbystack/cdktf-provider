...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupConfig",
		reflect.TypeOf((*GoogleApigeeEnvgroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeouts",
		reflect.TypeOf((*GoogleApigeeEnvgroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeEnvgroup.GoogleApigeeEnvgroupTimeoutsOutputReference",
