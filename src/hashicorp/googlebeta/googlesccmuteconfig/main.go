...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccMuteConfig.GoogleSccMuteConfigConfig",
		reflect.TypeOf((*GoogleSccMuteConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccMuteConfig.GoogleSccMuteConfigTimeouts",
		reflect.TypeOf((*GoogleSccMuteConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccMuteConfig.GoogleSccMuteConfigTimeoutsOutputReference",
