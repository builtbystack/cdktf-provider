...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageFolder.GoogleStorageFolderConfig",
		reflect.TypeOf((*GoogleStorageFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageFolder.GoogleStorageFolderTimeouts",
		reflect.TypeOf((*GoogleStorageFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageFolder.GoogleStorageFolderTimeoutsOutputReference",
