...
type GoogleCesToolDataStoreToolBoostSpecs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#data_stores GoogleCesTool#data_stores}
	DataStores *[]*string `field:"required" json:"dataStores" yaml:"dataStores"`
	// spec block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#spec GoogleCesTool#spec}
