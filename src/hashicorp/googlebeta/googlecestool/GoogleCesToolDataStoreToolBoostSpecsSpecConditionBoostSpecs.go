...
type GoogleCesToolDataStoreToolBoostSpecsSpecConditionBoostSpecs struct {
	...
	// (lang_code: ANY("en", "fr"))
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#condition GoogleCesTool#condition}
	...
	// ignored.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#boost GoogleCesTool#boost}
	Boost *float64 `field:"optional" json:"boost" yaml:"boost"`
	// boost_control_spec block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_ces_tool#boost_control_spec GoogleCesTool#boost_control_spec}
