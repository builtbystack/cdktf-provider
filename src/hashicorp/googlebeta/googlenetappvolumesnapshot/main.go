...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotConfig",
		reflect.TypeOf((*GoogleNetappVolumeSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotTimeouts",
		reflect.TypeOf((*GoogleNetappVolumeSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetappVolumeSnapshot.GoogleNetappVolumeSnapshotTimeoutsOutputReference",
