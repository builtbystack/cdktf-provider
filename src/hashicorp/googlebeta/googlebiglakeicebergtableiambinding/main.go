...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergTableIamBinding.GoogleBiglakeIcebergTableIamBindingCondition",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBiglakeIcebergTableIamBinding.GoogleBiglakeIcebergTableIamBindingConditionOutputReference",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergTableIamBinding.GoogleBiglakeIcebergTableIamBindingConfig",
		reflect.TypeOf((*GoogleBiglakeIcebergTableIamBindingConfig)(nil)).Elem(),
	)
}
