...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEventarcChannel.GoogleEventarcChannelConfig",
		reflect.TypeOf((*GoogleEventarcChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleEventarcChannel.GoogleEventarcChannelTimeouts",
		reflect.TypeOf((*GoogleEventarcChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEventarcChannel.GoogleEventarcChannelTimeoutsOutputReference",
