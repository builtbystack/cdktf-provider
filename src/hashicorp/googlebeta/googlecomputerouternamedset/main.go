...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetConfig",
		reflect.TypeOf((*GoogleComputeRouterNamedSetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetElements",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRouterNamedSet.GoogleComputeRouterNamedSetTimeouts",
