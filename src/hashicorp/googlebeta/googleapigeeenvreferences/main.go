...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvReferences.GoogleApigeeEnvReferencesConfig",
		reflect.TypeOf((*GoogleApigeeEnvReferencesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvReferences.GoogleApigeeEnvReferencesTimeouts",
		reflect.TypeOf((*GoogleApigeeEnvReferencesTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeEnvReferences.GoogleApigeeEnvReferencesTimeoutsOutputReference",
