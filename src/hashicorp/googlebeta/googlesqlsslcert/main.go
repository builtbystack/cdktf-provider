...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSqlSslCert.GoogleSqlSslCertConfig",
		reflect.TypeOf((*GoogleSqlSslCertConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSqlSslCert.GoogleSqlSslCertTimeouts",
		reflect.TypeOf((*GoogleSqlSslCertTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSqlSslCert.GoogleSqlSslCertTimeoutsOutputReference",
