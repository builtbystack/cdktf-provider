...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceConsumersIamBinding.GoogleEndpointsServiceConsumersIamBindingCondition",
		reflect.TypeOf((*GoogleEndpointsServiceConsumersIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEndpointsServiceConsumersIamBinding.GoogleEndpointsServiceConsumersIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceConsumersIamBinding.GoogleEndpointsServiceConsumersIamBindingConfig",
