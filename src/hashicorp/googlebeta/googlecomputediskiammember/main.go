...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberCondition",
		reflect.TypeOf((*GoogleComputeDiskIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeDiskIamMember.GoogleComputeDiskIamMemberConfig",
