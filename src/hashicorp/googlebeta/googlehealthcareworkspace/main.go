...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceConfig",
		reflect.TypeOf((*GoogleHealthcareWorkspaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceSettings",
		reflect.TypeOf((*GoogleHealthcareWorkspaceSettings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceSettingsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceTimeouts",
		reflect.TypeOf((*GoogleHealthcareWorkspaceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareWorkspace.GoogleHealthcareWorkspaceTimeoutsOutputReference",
