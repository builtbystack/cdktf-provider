...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlConfig",
		reflect.TypeOf((*GoogleStorageBucketAccessControlConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeouts",
		reflect.TypeOf((*GoogleStorageBucketAccessControlTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleStorageBucketAccessControl.GoogleStorageBucketAccessControlTimeoutsOutputReference",
