...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetSslProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyTimeouts",
		reflect.TypeOf((*GoogleComputeTargetSslProxyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeTargetSslProxy.GoogleComputeTargetSslProxyTimeoutsOutputReference",
