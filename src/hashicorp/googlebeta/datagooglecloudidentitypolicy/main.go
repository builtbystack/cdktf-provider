...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudIdentityPolicy.DataGoogleCloudIdentityPolicyConfig",
		reflect.TypeOf((*DataGoogleCloudIdentityPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudIdentityPolicy.DataGoogleCloudIdentityPolicyPolicyQuery",
