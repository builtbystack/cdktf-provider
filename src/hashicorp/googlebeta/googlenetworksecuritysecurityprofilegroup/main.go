...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecuritySecurityProfileGroup.GoogleNetworkSecuritySecurityProfileGroupConfig",
		reflect.TypeOf((*GoogleNetworkSecuritySecurityProfileGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecuritySecurityProfileGroup.GoogleNetworkSecuritySecurityProfileGroupTimeouts",
