...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexZoneIamBinding.GoogleDataplexZoneIamBindingCondition",
		reflect.TypeOf((*GoogleDataplexZoneIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexZoneIamBinding.GoogleDataplexZoneIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexZoneIamBinding.GoogleDataplexZoneIamBindingConfig",
