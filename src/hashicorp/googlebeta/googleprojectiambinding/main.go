...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectIamBinding.GoogleProjectIamBindingCondition",
		reflect.TypeOf((*GoogleProjectIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleProjectIamBinding.GoogleProjectIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectIamBinding.GoogleProjectIamBindingConfig",
