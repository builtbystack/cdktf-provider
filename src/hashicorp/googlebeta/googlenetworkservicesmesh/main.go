...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkServicesMesh.GoogleNetworkServicesMeshConfig",
		reflect.TypeOf((*GoogleNetworkServicesMeshConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkServicesMesh.GoogleNetworkServicesMeshTimeouts",
		reflect.TypeOf((*GoogleNetworkServicesMeshTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetworkServicesMesh.GoogleNetworkServicesMeshTimeoutsOutputReference",
