...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialConfig",
		reflect.TypeOf((*GoogleIamOauthClientCredentialConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialTimeouts",
		reflect.TypeOf((*GoogleIamOauthClientCredentialTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIamOauthClientCredential.GoogleIamOauthClientCredentialTimeoutsOutputReference",
