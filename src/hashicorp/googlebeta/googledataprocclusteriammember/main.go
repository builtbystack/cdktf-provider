...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocClusterIamMember.GoogleDataprocClusterIamMemberCondition",
		reflect.TypeOf((*GoogleDataprocClusterIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataprocClusterIamMember.GoogleDataprocClusterIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocClusterIamMember.GoogleDataprocClusterIamMemberConfig",
