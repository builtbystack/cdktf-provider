...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberCondition",
		reflect.TypeOf((*GoogleVertexAiEndpointIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiEndpointIamMember.GoogleVertexAiEndpointIamMemberConfig",
