...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFolderIamMember.GoogleFolderIamMemberCondition",
		reflect.TypeOf((*GoogleFolderIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFolderIamMember.GoogleFolderIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFolderIamMember.GoogleFolderIamMemberConfig",
