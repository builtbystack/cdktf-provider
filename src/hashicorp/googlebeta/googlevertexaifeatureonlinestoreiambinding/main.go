...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeatureOnlineStoreIamBinding.GoogleVertexAiFeatureOnlineStoreIamBindingCondition",
		reflect.TypeOf((*GoogleVertexAiFeatureOnlineStoreIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiFeatureOnlineStoreIamBinding.GoogleVertexAiFeatureOnlineStoreIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeatureOnlineStoreIamBinding.GoogleVertexAiFeatureOnlineStoreIamBindingConfig",
