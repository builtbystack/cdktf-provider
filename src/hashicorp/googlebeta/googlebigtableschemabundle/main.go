...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableSchemaBundle.GoogleBigtableSchemaBundleConfig",
		reflect.TypeOf((*GoogleBigtableSchemaBundleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableSchemaBundle.GoogleBigtableSchemaBundleProtoSchema",
		reflect.TypeOf((*GoogleBigtableSchemaBundleProtoSchema)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableSchemaBundle.GoogleBigtableSchemaBundleProtoSchemaOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableSchemaBundle.GoogleBigtableSchemaBundleTimeouts",
		reflect.TypeOf((*GoogleBigtableSchemaBundleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableSchemaBundle.GoogleBigtableSchemaBundleTimeoutsOutputReference",
