...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeFirewallPolicy.GoogleComputeFirewallPolicyConfig",
		reflect.TypeOf((*GoogleComputeFirewallPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeFirewallPolicy.GoogleComputeFirewallPolicyTimeouts",
		reflect.TypeOf((*GoogleComputeFirewallPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeFirewallPolicy.GoogleComputeFirewallPolicyTimeoutsOutputReference",
