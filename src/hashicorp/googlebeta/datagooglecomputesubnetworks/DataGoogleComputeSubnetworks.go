...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglecomputesubnetworks/internal"
...
func NewDataGoogleComputeSubnetworks(scope constructs.Construct, id *string, config *DataGoogleComputeSubnetworksConfig) DataGoogleComputeSubnetworks {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworks",
