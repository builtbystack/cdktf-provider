...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksConfig",
		reflect.TypeOf((*DataGoogleComputeSubnetworksConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworks",
		reflect.TypeOf((*DataGoogleComputeSubnetworksSubnetworks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksOutputReference",
