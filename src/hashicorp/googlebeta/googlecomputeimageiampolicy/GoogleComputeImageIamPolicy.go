...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecomputeimageiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_image_iam_policy google_compute_image_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_compute_image_iam_policy google_compute_image_iam_policy} Resource.
func NewGoogleComputeImageIamPolicy(scope constructs.Construct, id *string, config *GoogleComputeImageIamPolicyConfig) GoogleComputeImageIamPolicy {
	...
	_jsii_.Create(
		"googlebeta.googleComputeImageIamPolicy.GoogleComputeImageIamPolicy",
