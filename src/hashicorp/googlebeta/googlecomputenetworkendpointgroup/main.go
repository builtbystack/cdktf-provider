...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupConfig",
		reflect.TypeOf((*GoogleComputeNetworkEndpointGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkEndpointGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeNetworkEndpointGroup.GoogleComputeNetworkEndpointGroupTimeoutsOutputReference",
