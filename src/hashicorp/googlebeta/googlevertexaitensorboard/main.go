...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiTensorboard.GoogleVertexAiTensorboardConfig",
		reflect.TypeOf((*GoogleVertexAiTensorboardConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiTensorboard.GoogleVertexAiTensorboardEncryptionSpec",
		reflect.TypeOf((*GoogleVertexAiTensorboardEncryptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiTensorboard.GoogleVertexAiTensorboardEncryptionSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiTensorboard.GoogleVertexAiTensorboardTimeouts",
		reflect.TypeOf((*GoogleVertexAiTensorboardTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiTensorboard.GoogleVertexAiTensorboardTimeoutsOutputReference",
