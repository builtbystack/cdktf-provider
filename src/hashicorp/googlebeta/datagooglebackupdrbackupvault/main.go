...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultConfig",
		reflect.TypeOf((*DataGoogleBackupDrBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultEncryptionConfig",
