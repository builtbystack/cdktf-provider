...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeIcebergTableIamMember.GoogleBiglakeIcebergTableIamMemberConfig",
