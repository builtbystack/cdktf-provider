...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapClient.GoogleIapClientConfig",
		reflect.TypeOf((*GoogleIapClientConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleIapClient.GoogleIapClientTimeouts",
		reflect.TypeOf((*GoogleIapClientTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapClient.GoogleIapClientTimeoutsOutputReference",
