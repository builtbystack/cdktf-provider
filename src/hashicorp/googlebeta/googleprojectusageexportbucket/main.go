...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketConfig",
		reflect.TypeOf((*GoogleProjectUsageExportBucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeouts",
		reflect.TypeOf((*GoogleProjectUsageExportBucketTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleProjectUsageExportBucket.GoogleProjectUsageExportBucketTimeoutsOutputReference",
