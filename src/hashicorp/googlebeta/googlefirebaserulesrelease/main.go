...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseConfig",
		reflect.TypeOf((*GoogleFirebaserulesReleaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseTimeouts",
		reflect.TypeOf((*GoogleFirebaserulesReleaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaserulesRelease.GoogleFirebaserulesReleaseTimeoutsOutputReference",
