...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogledataprocmetastoretableiampolicy/internal"
...
func NewDataGoogleDataprocMetastoreTableIamPolicy(scope constructs.Construct, id *string, config *DataGoogleDataprocMetastoreTableIamPolicyConfig) DataGoogleDataprocMetastoreTableIamPolicy {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleDataprocMetastoreTableIamPolicy.DataGoogleDataprocMetastoreTableIamPolicy",
