...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAppCheckDebugToken.GoogleFirebaseAppCheckDebugTokenConfig",
		reflect.TypeOf((*GoogleFirebaseAppCheckDebugTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAppCheckDebugToken.GoogleFirebaseAppCheckDebugTokenTimeouts",
		reflect.TypeOf((*GoogleFirebaseAppCheckDebugTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseAppCheckDebugToken.GoogleFirebaseAppCheckDebugTokenTimeoutsOutputReference",
