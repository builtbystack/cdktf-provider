...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingCondition",
		reflect.TypeOf((*GoogleServiceAccountIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccountIamBinding.GoogleServiceAccountIamBindingConfig",
