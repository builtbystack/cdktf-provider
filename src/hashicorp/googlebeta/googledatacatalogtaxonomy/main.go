...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataCatalogTaxonomy.GoogleDataCatalogTaxonomyConfig",
		reflect.TypeOf((*GoogleDataCatalogTaxonomyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDataCatalogTaxonomy.GoogleDataCatalogTaxonomyTimeouts",
		reflect.TypeOf((*GoogleDataCatalogTaxonomyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataCatalogTaxonomy.GoogleDataCatalogTaxonomyTimeoutsOutputReference",
