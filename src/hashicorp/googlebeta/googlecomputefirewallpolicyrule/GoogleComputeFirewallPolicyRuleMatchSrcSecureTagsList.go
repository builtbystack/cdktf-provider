...
func NewGoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList {
	...
	_jsii_.Create(
		"googlebeta.googleComputeFirewallPolicyRule.GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList",
...
func (g *jsiiProxy_GoogleComputeFirewallPolicyRuleMatchSrcSecureTagsList) Resolve(_context cdktf.IResolveContext) interface{} {
