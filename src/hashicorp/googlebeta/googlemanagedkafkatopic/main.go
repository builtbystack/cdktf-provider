...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaTopic.GoogleManagedKafkaTopicConfig",
		reflect.TypeOf((*GoogleManagedKafkaTopicConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaTopic.GoogleManagedKafkaTopicTimeouts",
		reflect.TypeOf((*GoogleManagedKafkaTopicTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaTopic.GoogleManagedKafkaTopicTimeoutsOutputReference",
