...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "autoLabelingRuleId", GoGetter: "AutoLabelingRuleId"},
			_jsii_.MemberProperty{JsiiProperty: "autoLabelingRuleIdInput", GoGetter: "AutoLabelingRuleIdInput"},
			...
			_jsii_.MemberProperty{JsiiProperty: "labelKeyType", GoGetter: "LabelKeyType"},
			_jsii_.MemberProperty{JsiiProperty: "labelKeyTypeInput", GoGetter: "LabelKeyTypeInput"},
			...
			_jsii_.MemberMethod{JsiiMethod: "resetLabelKeyType", GoMethod: "ResetLabelKeyType"},
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContactCenterInsightsAutoLabelingRule.GoogleContactCenterInsightsAutoLabelingRuleConditions",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContactCenterInsightsAutoLabelingRule.GoogleContactCenterInsightsAutoLabelingRuleConfig",
		reflect.TypeOf((*GoogleContactCenterInsightsAutoLabelingRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleContactCenterInsightsAutoLabelingRule.GoogleContactCenterInsightsAutoLabelingRuleTimeouts",
