...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkConfig",
		reflect.TypeOf((*DataGoogleVmwareengineNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworks",
		reflect.TypeOf((*DataGoogleVmwareengineNetworkVpcNetworks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworksList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworksOutputReference",
