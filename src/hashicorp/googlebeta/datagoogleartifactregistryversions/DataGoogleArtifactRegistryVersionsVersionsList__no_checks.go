...
func (d *jsiiProxy_DataGoogleArtifactRegistryVersionsVersionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
	return nil
}

func (d *jsiiProxy_DataGoogleArtifactRegistryVersionsVersionsList) validateGetParameters(index *float64) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleArtifactRegistryVersionsVersionsList) validateSetTerraformAttributeParameters(val *string) error {
	return nil
}
...
func (j *jsiiProxy_DataGoogleArtifactRegistryVersionsVersionsList) validateSetWrapsSetParameters(val *bool) error {
	return nil
}
