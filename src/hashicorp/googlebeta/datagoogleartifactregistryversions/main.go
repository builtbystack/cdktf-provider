...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryVersions.DataGoogleArtifactRegistryVersionsConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryVersionsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryVersions.DataGoogleArtifactRegistryVersionsVersions",
		reflect.TypeOf((*DataGoogleArtifactRegistryVersionsVersions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleArtifactRegistryVersions.DataGoogleArtifactRegistryVersionsVersionsList",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryVersions.DataGoogleArtifactRegistryVersionsVersionsRelatedTags",
