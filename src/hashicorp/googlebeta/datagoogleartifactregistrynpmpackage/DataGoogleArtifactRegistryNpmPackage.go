...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleartifactregistrynpmpackage/internal"
...
func NewDataGoogleArtifactRegistryNpmPackage(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryNpmPackageConfig) DataGoogleArtifactRegistryNpmPackage {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleArtifactRegistryNpmPackage.DataGoogleArtifactRegistryNpmPackage",
