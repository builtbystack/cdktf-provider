...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexAssetIamBinding.GoogleDataplexAssetIamBindingCondition",
		reflect.TypeOf((*GoogleDataplexAssetIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexAssetIamBinding.GoogleDataplexAssetIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexAssetIamBinding.GoogleDataplexAssetIamBindingConfig",
