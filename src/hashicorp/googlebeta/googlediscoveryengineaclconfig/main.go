...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineAclConfig.GoogleDiscoveryEngineAclConfigConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineAclConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineAclConfig.GoogleDiscoveryEngineAclConfigIdpConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineAclConfigIdpConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineAclConfig.GoogleDiscoveryEngineAclConfigIdpConfigExternalIdpConfig",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineAclConfig.GoogleDiscoveryEngineAclConfigTimeouts",
