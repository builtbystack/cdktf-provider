...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberCondition",
		reflect.TypeOf((*GooglePubsubSubscriptionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSubscriptionIamMember.GooglePubsubSubscriptionIamMemberConfig",
