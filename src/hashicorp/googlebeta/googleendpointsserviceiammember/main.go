...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberCondition",
		reflect.TypeOf((*GoogleEndpointsServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceIamMember.GoogleEndpointsServiceIamMemberConfig",
