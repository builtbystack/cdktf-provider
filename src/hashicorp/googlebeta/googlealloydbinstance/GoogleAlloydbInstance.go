...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_alloydb_instance google_alloydb_instance}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_alloydb_instance google_alloydb_instance} Resource.
func NewGoogleAlloydbInstance(scope constructs.Construct, id *string, config *GoogleAlloydbInstanceConfig) GoogleAlloydbInstance {
	...
	_jsii_.Create(
		"googlebeta.googleAlloydbInstance.GoogleAlloydbInstance",
