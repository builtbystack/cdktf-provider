...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelConfig",
		reflect.TypeOf((*GoogleGkeBackupBackupChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeouts",
		reflect.TypeOf((*GoogleGkeBackupBackupChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeBackupBackupChannel.GoogleGkeBackupBackupChannelTimeoutsOutputReference",
