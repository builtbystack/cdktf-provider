...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingCondition",
		reflect.TypeOf((*GoogleComputeInstanceTemplateIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceTemplateIamBinding.GoogleComputeInstanceTemplateIamBindingConfig",
