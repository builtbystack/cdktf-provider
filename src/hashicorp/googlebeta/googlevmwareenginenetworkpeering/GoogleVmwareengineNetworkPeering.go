...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlevmwareenginenetworkpeering/internal"
...
func NewGoogleVmwareengineNetworkPeering(scope constructs.Construct, id *string, config *GoogleVmwareengineNetworkPeeringConfig) GoogleVmwareengineNetworkPeering {
	...
	_jsii_.Create(
		"googlebeta.googleVmwareengineNetworkPeering.GoogleVmwareengineNetworkPeering",
