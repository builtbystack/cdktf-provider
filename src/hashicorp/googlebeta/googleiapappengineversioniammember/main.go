...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberCondition",
		reflect.TypeOf((*GoogleIapAppEngineVersionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapAppEngineVersionIamMember.GoogleIapAppEngineVersionIamMemberConfig",
