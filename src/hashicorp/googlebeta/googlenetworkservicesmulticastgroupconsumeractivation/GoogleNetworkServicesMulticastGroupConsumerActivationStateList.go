...
func (j *jsiiProxy_GoogleNetworkServicesMulticastGroupConsumerActivationStateList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleNetworkServicesMulticastGroupConsumerActivationStateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleNetworkServicesMulticastGroupConsumerActivationStateList {
	_init_.Initialize()
	...
	_jsii_.Create(
		"googlebeta.googleNetworkServicesMulticastGroupConsumerActivation.GoogleNetworkServicesMulticastGroupConsumerActivationStateList",
...
func NewGoogleNetworkServicesMulticastGroupConsumerActivationStateList_Override(g GoogleNetworkServicesMulticastGroupConsumerActivationStateList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleNetworkServicesMulticastGroupConsumerActivationStateList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleNetworkServicesMulticastGroupConsumerActivationStateList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleNetworkServicesMulticastGroupConsumerActivationStateList) Resolve(_context cdktf.IResolveContext) interface{} {
