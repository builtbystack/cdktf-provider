...
func (j *jsiiProxy_GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList {
	_init_.Initialize()
...
func NewGoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList_Override(g GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (g *jsiiProxy_GoogleComputeRolloutPlanWavesOrchestrationOptionsDelaysList) Resolve(_context cdktf.IResolveContext) interface{} {
