...
func init() {
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstance",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceCluster",
		reflect.TypeOf((*GoogleBigtableInstanceCluster)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterAutoscalingConfig",
		reflect.TypeOf((*GoogleBigtableInstanceClusterAutoscalingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterAutoscalingConfigOutputReference",
	...
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterList",
	...
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceClusterOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceConfig",
		reflect.TypeOf((*GoogleBigtableInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceTimeouts",
		reflect.TypeOf((*GoogleBigtableInstanceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableInstance.GoogleBigtableInstanceTimeoutsOutputReference",
