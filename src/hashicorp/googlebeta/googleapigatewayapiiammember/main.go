...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberCondition",
		reflect.TypeOf((*GoogleApiGatewayApiIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayApiIamMember.GoogleApiGatewayApiIamMemberConfig",
