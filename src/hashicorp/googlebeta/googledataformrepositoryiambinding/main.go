...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataformRepositoryIamBinding.GoogleDataformRepositoryIamBindingCondition",
		reflect.TypeOf((*GoogleDataformRepositoryIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataformRepositoryIamBinding.GoogleDataformRepositoryIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataformRepositoryIamBinding.GoogleDataformRepositoryIamBindingConfig",
