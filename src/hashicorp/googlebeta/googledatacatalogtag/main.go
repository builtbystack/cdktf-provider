...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagConfig",
		reflect.TypeOf((*GoogleDataCatalogTagConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagFields",
		reflect.TypeOf((*GoogleDataCatalogTagFields)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagFieldsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagFieldsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagTimeouts",
		reflect.TypeOf((*GoogleDataCatalogTagTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataCatalogTag.GoogleDataCatalogTagTimeoutsOutputReference",
