...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeDnsZone.GoogleApigeeDnsZoneConfig",
		reflect.TypeOf((*GoogleApigeeDnsZoneConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeDnsZone.GoogleApigeeDnsZonePeeringConfig",
		reflect.TypeOf((*GoogleApigeeDnsZonePeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeDnsZone.GoogleApigeeDnsZonePeeringConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeDnsZone.GoogleApigeeDnsZoneTimeouts",
		reflect.TypeOf((*GoogleApigeeDnsZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeDnsZone.GoogleApigeeDnsZoneTimeoutsOutputReference",
