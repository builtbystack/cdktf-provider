...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkConfig",
		reflect.TypeOf((*GoogleOracleDatabaseOdbNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkTimeouts",
		reflect.TypeOf((*GoogleOracleDatabaseOdbNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleOracleDatabaseOdbNetwork.GoogleOracleDatabaseOdbNetworkTimeoutsOutputReference",
