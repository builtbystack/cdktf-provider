...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccOrganizationSccBigQueryExport.GoogleSccOrganizationSccBigQueryExportConfig",
		reflect.TypeOf((*GoogleSccOrganizationSccBigQueryExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccOrganizationSccBigQueryExport.GoogleSccOrganizationSccBigQueryExportTimeouts",
		reflect.TypeOf((*GoogleSccOrganizationSccBigQueryExportTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccOrganizationSccBigQueryExport.GoogleSccOrganizationSccBigQueryExportTimeoutsOutputReference",
