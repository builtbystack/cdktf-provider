...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewConfig",
		reflect.TypeOf((*GoogleBigtableMaterializedViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableMaterializedView.GoogleBigtableMaterializedViewTimeouts",
