...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsOrganizationKajPolicyConfig.GoogleKmsOrganizationKajPolicyConfigConfig",
		reflect.TypeOf((*GoogleKmsOrganizationKajPolicyConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsOrganizationKajPolicyConfig.GoogleKmsOrganizationKajPolicyConfigDefaultKeyAccessJustificationPolicy",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsOrganizationKajPolicyConfig.GoogleKmsOrganizationKajPolicyConfigTimeouts",
		reflect.TypeOf((*GoogleKmsOrganizationKajPolicyConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleKmsOrganizationKajPolicyConfig.GoogleKmsOrganizationKajPolicyConfigTimeoutsOutputReference",
