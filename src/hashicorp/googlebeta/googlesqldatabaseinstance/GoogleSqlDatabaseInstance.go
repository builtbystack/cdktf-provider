...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_sql_database_instance google_sql_database_instance}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_sql_database_instance google_sql_database_instance} Resource.
func NewGoogleSqlDatabaseInstance(scope constructs.Construct, id *string, config *GoogleSqlDatabaseInstanceConfig) GoogleSqlDatabaseInstance {
	...
	_jsii_.Create(
		"googlebeta.googleSqlDatabaseInstance.GoogleSqlDatabaseInstance",
