...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberCondition",
		reflect.TypeOf((*GoogleComputeRegionDiskIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionDiskIamMember.GoogleComputeRegionDiskIamMemberConfig",
