...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglecloudfunctions2functioniampolicy/internal"
...
func NewDataGoogleCloudfunctions2FunctionIamPolicy(scope constructs.Construct, id *string, config *DataGoogleCloudfunctions2FunctionIamPolicyConfig) DataGoogleCloudfunctions2FunctionIamPolicy {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleCloudfunctions2FunctionIamPolicy.DataGoogleCloudfunctions2FunctionIamPolicy",
