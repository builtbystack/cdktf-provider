...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccSourceIamMember.GoogleSccSourceIamMemberCondition",
		reflect.TypeOf((*GoogleSccSourceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccSourceIamMember.GoogleSccSourceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccSourceIamMember.GoogleSccSourceIamMemberConfig",
