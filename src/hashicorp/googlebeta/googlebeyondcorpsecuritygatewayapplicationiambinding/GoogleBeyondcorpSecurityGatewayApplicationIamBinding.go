...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlebeyondcorpsecuritygatewayapplicationiambinding/internal"
...
func NewGoogleBeyondcorpSecurityGatewayApplicationIamBinding(scope constructs.Construct, id *string, config *GoogleBeyondcorpSecurityGatewayApplicationIamBindingConfig) GoogleBeyondcorpSecurityGatewayApplicationIamBinding {
	...
	_jsii_.Create(
		"googlebeta.googleBeyondcorpSecurityGatewayApplicationIamBinding.GoogleBeyondcorpSecurityGatewayApplicationIamBinding",
