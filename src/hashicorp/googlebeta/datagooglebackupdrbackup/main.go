...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackups",
		reflect.TypeOf((*DataGoogleBackupDrBackupBackups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupConfig",
