...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleprivatecacertificatetemplateiambinding/internal"
...
func NewGooglePrivatecaCertificateTemplateIamBinding(scope constructs.Construct, id *string, config *GooglePrivatecaCertificateTemplateIamBindingConfig) GooglePrivatecaCertificateTemplateIamBinding {
	...
	_jsii_.Create(
		"googlebeta.googlePrivatecaCertificateTemplateIamBinding.GooglePrivatecaCertificateTemplateIamBinding",
