...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudIdentityPolicy.GoogleCloudIdentityPolicyConfig",
		reflect.TypeOf((*GoogleCloudIdentityPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudIdentityPolicy.GoogleCloudIdentityPolicyPolicyQuery",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudIdentityPolicy.GoogleCloudIdentityPolicySetting",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudIdentityPolicy.GoogleCloudIdentityPolicyTimeouts",
