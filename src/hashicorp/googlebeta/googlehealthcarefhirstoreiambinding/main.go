...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareFhirStoreIamBinding.GoogleHealthcareFhirStoreIamBindingCondition",
		reflect.TypeOf((*GoogleHealthcareFhirStoreIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareFhirStoreIamBinding.GoogleHealthcareFhirStoreIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareFhirStoreIamBinding.GoogleHealthcareFhirStoreIamBindingConfig",
