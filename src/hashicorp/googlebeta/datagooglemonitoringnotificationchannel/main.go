...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelConfig",
		reflect.TypeOf((*DataGoogleMonitoringNotificationChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelSensitiveLabels",
		reflect.TypeOf((*DataGoogleMonitoringNotificationChannelSensitiveLabels)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelSensitiveLabelsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleMonitoringNotificationChannel.DataGoogleMonitoringNotificationChannelSensitiveLabelsOutputReference",
