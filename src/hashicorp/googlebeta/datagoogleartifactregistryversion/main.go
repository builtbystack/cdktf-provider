...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryVersion.DataGoogleArtifactRegistryVersionConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryVersion.DataGoogleArtifactRegistryVersionRelatedTags",
		reflect.TypeOf((*DataGoogleArtifactRegistryVersionRelatedTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleArtifactRegistryVersion.DataGoogleArtifactRegistryVersionRelatedTagsList",
