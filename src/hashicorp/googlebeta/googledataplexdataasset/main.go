...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataAsset.GoogleDataplexDataAssetAccessGroupConfigs",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataAsset.GoogleDataplexDataAssetConfig",
		reflect.TypeOf((*GoogleDataplexDataAssetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataAsset.GoogleDataplexDataAssetTimeouts",
