...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2ProjectSccBigQueryExport.GoogleSccV2ProjectSccBigQueryExportConfig",
		reflect.TypeOf((*GoogleSccV2ProjectSccBigQueryExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2ProjectSccBigQueryExport.GoogleSccV2ProjectSccBigQueryExportTimeouts",
		reflect.TypeOf((*GoogleSccV2ProjectSccBigQueryExportTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccV2ProjectSccBigQueryExport.GoogleSccV2ProjectSccBigQueryExportTimeoutsOutputReference",
