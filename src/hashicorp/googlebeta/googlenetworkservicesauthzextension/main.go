...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionConfig",
		reflect.TypeOf((*GoogleNetworkServicesAuthzExtensionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkServicesAuthzExtension.GoogleNetworkServicesAuthzExtensionTimeouts",
