...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleOrganizations.DataGoogleOrganizationsConfig",
		reflect.TypeOf((*DataGoogleOrganizationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleOrganizations.DataGoogleOrganizationsOrganizations",
		reflect.TypeOf((*DataGoogleOrganizationsOrganizations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleOrganizations.DataGoogleOrganizationsOrganizationsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleOrganizations.DataGoogleOrganizationsOrganizationsOutputReference",
