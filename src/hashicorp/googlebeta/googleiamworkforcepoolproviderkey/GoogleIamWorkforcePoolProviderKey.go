...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleiamworkforcepoolproviderkey/internal"
...
func NewGoogleIamWorkforcePoolProviderKey(scope constructs.Construct, id *string, config *GoogleIamWorkforcePoolProviderKeyConfig) GoogleIamWorkforcePoolProviderKey {
	...
	_jsii_.Create(
		"googlebeta.googleIamWorkforcePoolProviderKey.GoogleIamWorkforcePoolProviderKey",
