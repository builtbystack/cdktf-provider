...
type GoogleNotebooksRuntimeVirtualMachineVirtualMachineConfigEncryptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_notebooks_runtime#kms_key GoogleNotebooksRuntime#kms_key}
