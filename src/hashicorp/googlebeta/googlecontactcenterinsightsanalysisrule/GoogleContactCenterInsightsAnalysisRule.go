...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecontactcenterinsightsanalysisrule/internal"
...
func NewGoogleContactCenterInsightsAnalysisRule(scope constructs.Construct, id *string, config *GoogleContactCenterInsightsAnalysisRuleConfig) GoogleContactCenterInsightsAnalysisRule {
	...
	_jsii_.Create(
		"googlebeta.googleContactCenterInsightsAnalysisRule.GoogleContactCenterInsightsAnalysisRule",
