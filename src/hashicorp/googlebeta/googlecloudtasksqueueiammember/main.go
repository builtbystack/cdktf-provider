...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberCondition",
		reflect.TypeOf((*GoogleCloudTasksQueueIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudTasksQueueIamMember.GoogleCloudTasksQueueIamMemberConfig",
