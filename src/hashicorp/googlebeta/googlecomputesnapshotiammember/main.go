...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSnapshotIamMember.GoogleComputeSnapshotIamMemberCondition",
		reflect.TypeOf((*GoogleComputeSnapshotIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSnapshotIamMember.GoogleComputeSnapshotIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSnapshotIamMember.GoogleComputeSnapshotIamMemberConfig",
