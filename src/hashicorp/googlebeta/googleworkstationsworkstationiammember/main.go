...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstationIamMember.GoogleWorkstationsWorkstationIamMemberCondition",
		reflect.TypeOf((*GoogleWorkstationsWorkstationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleWorkstationsWorkstationIamMember.GoogleWorkstationsWorkstationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstationIamMember.GoogleWorkstationsWorkstationIamMemberConfig",
