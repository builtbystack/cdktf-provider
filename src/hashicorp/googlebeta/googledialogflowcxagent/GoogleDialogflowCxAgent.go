...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dialogflow_cx_agent google_dialogflow_cx_agent}.
...
func (j *jsiiProxy_GoogleDialogflowCxAgent) SatisfiesPzi() cdktf.IResolvable {
...
func (j *jsiiProxy_GoogleDialogflowCxAgent) SatisfiesPzs() cdktf.IResolvable {
	var returns cdktf.IResolvable
	_jsii_.Get(
		j,
		"satisfiesPzs",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dialogflow_cx_agent google_dialogflow_cx_agent} Resource.
func NewGoogleDialogflowCxAgent(scope constructs.Construct, id *string, config *GoogleDialogflowCxAgentConfig) GoogleDialogflowCxAgent {
	...
	_jsii_.Create(
		"googlebeta.googleDialogflowCxAgent.GoogleDialogflowCxAgent",
