...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayConfig",
		reflect.TypeOf((*GoogleApiGatewayGatewayConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeouts",
		reflect.TypeOf((*GoogleApiGatewayGatewayTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApiGatewayGateway.GoogleApiGatewayGatewayTimeoutsOutputReference",
