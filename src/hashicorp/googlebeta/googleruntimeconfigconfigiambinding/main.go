...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingCondition",
		reflect.TypeOf((*GoogleRuntimeconfigConfigIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleRuntimeconfigConfigIamBinding.GoogleRuntimeconfigConfigIamBindingConfig",
