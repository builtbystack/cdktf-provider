...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberCondition",
		reflect.TypeOf((*GooglePubsubSchemaIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubSchemaIamMember.GooglePubsubSchemaIamMemberConfig",
