...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsConfig",
		reflect.TypeOf((*GoogleComputeInstanceSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsMetadata",
		reflect.TypeOf((*GoogleComputeInstanceSettingsMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsMetadataOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsTimeouts",
		reflect.TypeOf((*GoogleComputeInstanceSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstanceSettings.GoogleComputeInstanceSettingsTimeoutsOutputReference",
