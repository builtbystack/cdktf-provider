...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberCondition",
		reflect.TypeOf((*GoogleBillingAccountIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingAccountIamMember.GoogleBillingAccountIamMemberConfig",
