...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityTlsInspectionPolicy.GoogleNetworkSecurityTlsInspectionPolicyConfig",
		reflect.TypeOf((*GoogleNetworkSecurityTlsInspectionPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityTlsInspectionPolicy.GoogleNetworkSecurityTlsInspectionPolicyTimeouts",
