...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleResourceManagerLien.GoogleResourceManagerLienConfig",
		reflect.TypeOf((*GoogleResourceManagerLienConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleResourceManagerLien.GoogleResourceManagerLienTimeouts",
		reflect.TypeOf((*GoogleResourceManagerLienTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleResourceManagerLien.GoogleResourceManagerLienTimeoutsOutputReference",
