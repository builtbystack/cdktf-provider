...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpointConfig",
		reflect.TypeOf((*GoogleComputeNetworkEndpointConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpointTimeouts",
		reflect.TypeOf((*GoogleComputeNetworkEndpointTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeNetworkEndpoint.GoogleComputeNetworkEndpointTimeoutsOutputReference",
