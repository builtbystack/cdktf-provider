...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionConfig",
		reflect.TypeOf((*GoogleSpannerInstancePartitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeouts",
		reflect.TypeOf((*GoogleSpannerInstancePartitionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSpannerInstancePartition.GoogleSpannerInstancePartitionTimeoutsOutputReference",
