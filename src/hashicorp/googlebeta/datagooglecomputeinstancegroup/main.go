...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeInstanceGroup.DataGoogleComputeInstanceGroupConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeInstanceGroup.DataGoogleComputeInstanceGroupNamedPort",
		reflect.TypeOf((*DataGoogleComputeInstanceGroupNamedPort)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeInstanceGroup.DataGoogleComputeInstanceGroupNamedPortList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeInstanceGroup.DataGoogleComputeInstanceGroupNamedPortOutputReference",
