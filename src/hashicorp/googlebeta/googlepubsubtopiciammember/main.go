...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubTopicIamMember.GooglePubsubTopicIamMemberCondition",
		reflect.TypeOf((*GooglePubsubTopicIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubTopicIamMember.GooglePubsubTopicIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubTopicIamMember.GooglePubsubTopicIamMemberConfig",
