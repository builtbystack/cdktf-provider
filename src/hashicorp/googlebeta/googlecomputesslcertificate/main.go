...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateConfig",
		reflect.TypeOf((*GoogleComputeSslCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeouts",
		reflect.TypeOf((*GoogleComputeSslCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSslCertificate.GoogleComputeSslCertificateTimeoutsOutputReference",
