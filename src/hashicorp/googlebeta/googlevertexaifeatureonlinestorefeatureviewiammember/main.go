...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeatureOnlineStoreFeatureviewIamMember.GoogleVertexAiFeatureOnlineStoreFeatureviewIamMemberCondition",
		reflect.TypeOf((*GoogleVertexAiFeatureOnlineStoreFeatureviewIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiFeatureOnlineStoreFeatureviewIamMember.GoogleVertexAiFeatureOnlineStoreFeatureviewIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeatureOnlineStoreFeatureviewIamMember.GoogleVertexAiFeatureOnlineStoreFeatureviewIamMemberConfig",
