...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleAccessContextManagerAuthorizedOrgsDesc.GoogleAccessContextManagerAuthorizedOrgsDescConfig",
		reflect.TypeOf((*GoogleAccessContextManagerAuthorizedOrgsDescConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleAccessContextManagerAuthorizedOrgsDesc.GoogleAccessContextManagerAuthorizedOrgsDescTimeouts",
		reflect.TypeOf((*GoogleAccessContextManagerAuthorizedOrgsDescTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleAccessContextManagerAuthorizedOrgsDesc.GoogleAccessContextManagerAuthorizedOrgsDescTimeoutsOutputReference",
