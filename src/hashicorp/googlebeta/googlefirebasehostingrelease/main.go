...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingRelease.GoogleFirebaseHostingReleaseConfig",
		reflect.TypeOf((*GoogleFirebaseHostingReleaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingRelease.GoogleFirebaseHostingReleaseTimeouts",
		reflect.TypeOf((*GoogleFirebaseHostingReleaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseHostingRelease.GoogleFirebaseHostingReleaseTimeoutsOutputReference",
