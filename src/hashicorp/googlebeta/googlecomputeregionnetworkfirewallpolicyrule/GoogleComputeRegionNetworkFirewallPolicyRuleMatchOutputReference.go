...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecomputeregionnetworkfirewallpolicyrule/internal"
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) DestNetworkContext() *string {
	var returns *string
	_jsii_.Get(
		j,
		"destNetworkContext",
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) DestNetworkContextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) SrcNetworkContext() *string {
	var returns *string
	_jsii_.Get(
		j,
		"srcNetworkContext",
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) SrcNetworkContextInput() *string {
	var returns *string
	_jsii_.Get(
		j,
...
func NewGoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference {
	...
	_jsii_.Create(
		"googlebeta.googleComputeRegionNetworkFirewallPolicyRule.GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference",
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference)SetDestNetworkContext(val *string) {
...
func (j *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference)SetSrcNetworkContext(val *string) {
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) ResetDestNetworkContext() {
	_jsii_.InvokeVoid(
		g,
		"resetDestNetworkContext",
		nil, // no parameters
...
func (g *jsiiProxy_GoogleComputeRegionNetworkFirewallPolicyRuleMatchOutputReference) ResetSrcNetworkContext() {
	_jsii_.InvokeVoid(
		g,
		"resetSrcNetworkContext",
		nil, // no parameters
