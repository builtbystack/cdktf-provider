...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingCondition",
		reflect.TypeOf((*GoogleNotebooksInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksInstanceIamBinding.GoogleNotebooksInstanceIamBindingConfig",
