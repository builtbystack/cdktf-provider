...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberCondition",
		reflect.TypeOf((*GoogleNotebooksInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksInstanceIamMember.GoogleNotebooksInstanceIamMemberConfig",
