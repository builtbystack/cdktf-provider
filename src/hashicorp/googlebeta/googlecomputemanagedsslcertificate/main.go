...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateConfig",
		reflect.TypeOf((*GoogleComputeManagedSslCertificateConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateManaged",
		reflect.TypeOf((*GoogleComputeManagedSslCertificateManaged)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateManagedOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateTimeouts",
		reflect.TypeOf((*GoogleComputeManagedSslCertificateTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeManagedSslCertificate.GoogleComputeManagedSslCertificateTimeoutsOutputReference",
