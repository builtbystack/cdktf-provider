...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeaturestoreEntitytypeFeature.GoogleVertexAiFeaturestoreEntitytypeFeatureConfig",
		reflect.TypeOf((*GoogleVertexAiFeaturestoreEntitytypeFeatureConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiFeaturestoreEntitytypeFeature.GoogleVertexAiFeaturestoreEntitytypeFeatureTimeouts",
		reflect.TypeOf((*GoogleVertexAiFeaturestoreEntitytypeFeatureTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiFeaturestoreEntitytypeFeature.GoogleVertexAiFeaturestoreEntitytypeFeatureTimeoutsOutputReference",
