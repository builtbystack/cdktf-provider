...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_pubsub_subscription google_pubsub_subscription}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_pubsub_subscription google_pubsub_subscription} Resource.
func NewGooglePubsubSubscription(scope constructs.Construct, id *string, config *GooglePubsubSubscriptionConfig) GooglePubsubSubscription {
	...
	_jsii_.Create(
		"googlebeta.googlePubsubSubscription.GooglePubsubSubscription",
