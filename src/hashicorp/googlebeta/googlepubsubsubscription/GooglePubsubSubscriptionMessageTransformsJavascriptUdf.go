...
type GooglePubsubSubscriptionMessageTransformsJavascriptUdf struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_pubsub_subscription#function_name GooglePubsubSubscription#function_name}
