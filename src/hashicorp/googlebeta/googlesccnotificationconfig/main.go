...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigConfig",
		reflect.TypeOf((*GoogleSccNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfig",
		reflect.TypeOf((*GoogleSccNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigStreamingConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeouts",
		reflect.TypeOf((*GoogleSccNotificationConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccNotificationConfig.GoogleSccNotificationConfigTimeoutsOutputReference",
