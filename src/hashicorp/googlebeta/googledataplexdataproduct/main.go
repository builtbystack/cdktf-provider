...
func init() {
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProduct",
		reflect.TypeOf((*GoogleDataplexDataProduct)(nil)).Elem(),
		[]_jsii_.Member{
			_jsii_.MemberProperty{JsiiProperty: "accessGroups", GoGetter: "AccessGroups"},
			_jsii_.MemberProperty{JsiiProperty: "accessGroupsInput", GoGetter: "AccessGroupsInput"},
			_jsii_.MemberMethod{JsiiMethod: "addMoveTarget", GoMethod: "AddMoveTarget"},
			_jsii_.MemberMethod{JsiiMethod: "addOverride", GoMethod: "AddOverride"},
			_jsii_.MemberProperty{JsiiProperty: "assetCount", GoGetter: "AssetCount"},
			...
			_jsii_.MemberProperty{JsiiProperty: "ownerEmails", GoGetter: "OwnerEmails"},
			_jsii_.MemberProperty{JsiiProperty: "ownerEmailsInput", GoGetter: "OwnerEmailsInput"},
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductAccessGroups",
		reflect.TypeOf((*GoogleDataplexDataProductAccessGroups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductAccessGroupsList",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductAccessGroupsPrincipal",
		reflect.TypeOf((*GoogleDataplexDataProductAccessGroupsPrincipal)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductAccessGroupsPrincipalOutputReference",
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberMethod{JsiiMethod: "getStringAttribute", GoMethod: "GetStringAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "getStringMapAttribute", GoMethod: "GetStringMapAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "googleGroup", GoGetter: "GoogleGroup"},
			_jsii_.MemberProperty{JsiiProperty: "googleGroupInput", GoGetter: "GoogleGroupInput"},
			_jsii_.MemberProperty{JsiiProperty: "internalValue", GoGetter: "InternalValue"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationAsList", GoMethod: "InterpolationAsList"},
			_jsii_.MemberMethod{JsiiMethod: "interpolationForAttribute", GoMethod: "InterpolationForAttribute"},
			_jsii_.MemberMethod{JsiiMethod: "resetGoogleGroup", GoMethod: "ResetGoogleGroup"},
			_jsii_.MemberMethod{JsiiMethod: "resolve", GoMethod: "Resolve"},
			_jsii_.MemberProperty{JsiiProperty: "terraformAttribute", GoGetter: "TerraformAttribute"},
			_jsii_.MemberProperty{JsiiProperty: "terraformResource", GoGetter: "TerraformResource"},
			_jsii_.MemberMethod{JsiiMethod: "toString", GoMethod: "ToString"},
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductConfig",
		reflect.TypeOf((*GoogleDataplexDataProductConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexDataProduct.GoogleDataplexDataProductTimeouts",
