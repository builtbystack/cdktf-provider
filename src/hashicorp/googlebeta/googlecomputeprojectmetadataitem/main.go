...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemConfig",
		reflect.TypeOf((*GoogleComputeProjectMetadataItemConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemTimeouts",
		reflect.TypeOf((*GoogleComputeProjectMetadataItemTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeProjectMetadataItem.GoogleComputeProjectMetadataItemTimeoutsOutputReference",
