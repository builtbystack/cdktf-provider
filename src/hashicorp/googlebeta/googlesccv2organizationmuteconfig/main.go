...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2OrganizationMuteConfig.GoogleSccV2OrganizationMuteConfigConfig",
		reflect.TypeOf((*GoogleSccV2OrganizationMuteConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSccV2OrganizationMuteConfig.GoogleSccV2OrganizationMuteConfigTimeouts",
		reflect.TypeOf((*GoogleSccV2OrganizationMuteConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSccV2OrganizationMuteConfig.GoogleSccV2OrganizationMuteConfigTimeoutsOutputReference",
