...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudfunctions2FunctionIamBinding.GoogleCloudfunctions2FunctionIamBindingCondition",
		reflect.TypeOf((*GoogleCloudfunctions2FunctionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudfunctions2FunctionIamBinding.GoogleCloudfunctions2FunctionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudfunctions2FunctionIamBinding.GoogleCloudfunctions2FunctionIamBindingConfig",
