...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberCondition",
		reflect.TypeOf((*GoogleGkeHubMembershipIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubMembershipIamMember.GoogleGkeHubMembershipIamMemberConfig",
