...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleartifactregistrymavenartifact/internal"
...
func NewDataGoogleArtifactRegistryMavenArtifact(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryMavenArtifactConfig) DataGoogleArtifactRegistryMavenArtifact {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleArtifactRegistryMavenArtifact.DataGoogleArtifactRegistryMavenArtifact",
