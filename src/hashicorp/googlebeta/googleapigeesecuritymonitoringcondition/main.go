...
func init() {
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringCondition",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionConfig",
		reflect.TypeOf((*GoogleApigeeSecurityMonitoringConditionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionIncludeAllResources",
		reflect.TypeOf((*GoogleApigeeSecurityMonitoringConditionIncludeAllResources)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionIncludeAllResourcesOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionTimeouts",
		reflect.TypeOf((*GoogleApigeeSecurityMonitoringConditionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeSecurityMonitoringCondition.GoogleApigeeSecurityMonitoringConditionTimeoutsOutputReference",
