...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleProjects.DataGoogleProjectsConfig",
		reflect.TypeOf((*DataGoogleProjectsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleProjects.DataGoogleProjectsProjects",
		reflect.TypeOf((*DataGoogleProjectsProjects)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleProjects.DataGoogleProjectsProjectsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleProjects.DataGoogleProjectsProjectsOutputReference",
