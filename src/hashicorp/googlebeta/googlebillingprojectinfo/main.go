...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingProjectInfo.GoogleBillingProjectInfoConfig",
		reflect.TypeOf((*GoogleBillingProjectInfoConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBillingProjectInfo.GoogleBillingProjectInfoTimeouts",
		reflect.TypeOf((*GoogleBillingProjectInfoTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBillingProjectInfo.GoogleBillingProjectInfoTimeoutsOutputReference",
