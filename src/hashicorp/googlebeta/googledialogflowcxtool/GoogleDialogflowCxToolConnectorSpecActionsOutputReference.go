...
func (j *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewGoogleDialogflowCxToolConnectorSpecActionsOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) GoogleDialogflowCxToolConnectorSpecActionsOutputReference {
	_init_.Initialize()
...
func NewGoogleDialogflowCxToolConnectorSpecActionsOutputReference_Override(g GoogleDialogflowCxToolConnectorSpecActionsOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (g *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (g *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleDialogflowCxToolConnectorSpecActionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
