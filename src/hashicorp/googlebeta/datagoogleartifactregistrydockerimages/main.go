...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryDockerImages.DataGoogleArtifactRegistryDockerImagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryDockerImagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryDockerImages.DataGoogleArtifactRegistryDockerImagesDockerImages",
		reflect.TypeOf((*DataGoogleArtifactRegistryDockerImagesDockerImages)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleArtifactRegistryDockerImages.DataGoogleArtifactRegistryDockerImagesDockerImagesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleArtifactRegistryDockerImages.DataGoogleArtifactRegistryDockerImagesDockerImagesOutputReference",
