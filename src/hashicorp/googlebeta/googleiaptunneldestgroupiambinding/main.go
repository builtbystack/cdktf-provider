...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingCondition",
		reflect.TypeOf((*GoogleIapTunnelDestGroupIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelDestGroupIamBinding.GoogleIapTunnelDestGroupIamBindingConfig",
