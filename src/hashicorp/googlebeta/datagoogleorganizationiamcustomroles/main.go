...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleOrganizationIamCustomRoles.DataGoogleOrganizationIamCustomRolesConfig",
		reflect.TypeOf((*DataGoogleOrganizationIamCustomRolesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleOrganizationIamCustomRoles.DataGoogleOrganizationIamCustomRolesRoles",
		reflect.TypeOf((*DataGoogleOrganizationIamCustomRolesRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleOrganizationIamCustomRoles.DataGoogleOrganizationIamCustomRolesRolesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleOrganizationIamCustomRoles.DataGoogleOrganizationIamCustomRolesRolesOutputReference",
