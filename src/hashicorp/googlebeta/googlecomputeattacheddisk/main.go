...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskConfig",
		reflect.TypeOf((*GoogleComputeAttachedDiskConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeouts",
		reflect.TypeOf((*GoogleComputeAttachedDiskTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeAttachedDisk.GoogleComputeAttachedDiskTimeoutsOutputReference",
