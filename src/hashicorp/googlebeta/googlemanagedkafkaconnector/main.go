...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorConfig",
		reflect.TypeOf((*GoogleManagedKafkaConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTaskRestartPolicy",
		reflect.TypeOf((*GoogleManagedKafkaConnectorTaskRestartPolicy)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTaskRestartPolicyOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTimeouts",
		reflect.TypeOf((*GoogleManagedKafkaConnectorTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaConnector.GoogleManagedKafkaConnectorTimeoutsOutputReference",
