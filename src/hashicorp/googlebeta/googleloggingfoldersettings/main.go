...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingFolderSettings.GoogleLoggingFolderSettingsConfig",
		reflect.TypeOf((*GoogleLoggingFolderSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeouts",
		reflect.TypeOf((*GoogleLoggingFolderSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingFolderSettings.GoogleLoggingFolderSettingsTimeoutsOutputReference",
