...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleloggingfoldersettings/internal"
...
func NewGoogleLoggingFolderSettings(scope constructs.Construct, id *string, config *GoogleLoggingFolderSettingsConfig) GoogleLoggingFolderSettings {
	...
	_jsii_.Create(
		"googlebeta.googleLoggingFolderSettings.GoogleLoggingFolderSettings",
