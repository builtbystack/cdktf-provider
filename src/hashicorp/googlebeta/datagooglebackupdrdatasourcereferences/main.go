...
func init() {
	_jsii_.RegisterClass(
		...
		[]_jsii_.Member{
			...
			_jsii_.MemberProperty{JsiiProperty: "dataSourceReferences", GoGetter: "DataSourceReferences"},
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrDataSourceReferences.DataGoogleBackupDrDataSourceReferencesConfig",
		reflect.TypeOf((*DataGoogleBackupDrDataSourceReferencesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBackupDrDataSourceReferences.DataGoogleBackupDrDataSourceReferencesDataSourceReferences",
