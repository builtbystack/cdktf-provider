...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dialogflow_cx_webhook google_dialogflow_cx_webhook}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dialogflow_cx_webhook google_dialogflow_cx_webhook} Resource.
func NewGoogleDialogflowCxWebhook(scope constructs.Construct, id *string, config *GoogleDialogflowCxWebhookConfig) GoogleDialogflowCxWebhook {
	...
	_jsii_.Create(
		"googlebeta.googleDialogflowCxWebhook.GoogleDialogflowCxWebhook",
