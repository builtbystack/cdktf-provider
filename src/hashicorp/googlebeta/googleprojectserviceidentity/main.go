...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentityConfig",
		reflect.TypeOf((*GoogleProjectServiceIdentityConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentityTimeouts",
		reflect.TypeOf((*GoogleProjectServiceIdentityTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleProjectServiceIdentity.GoogleProjectServiceIdentityTimeoutsOutputReference",
