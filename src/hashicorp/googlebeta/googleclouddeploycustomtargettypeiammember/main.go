...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberCondition",
		reflect.TypeOf((*GoogleClouddeployCustomTargetTypeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployCustomTargetTypeIamMember.GoogleClouddeployCustomTargetTypeIamMemberConfig",
