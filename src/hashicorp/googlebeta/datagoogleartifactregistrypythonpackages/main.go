...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryPythonPackages.DataGoogleArtifactRegistryPythonPackagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryPythonPackagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleArtifactRegistryPythonPackages.DataGoogleArtifactRegistryPythonPackagesPythonPackages",
