...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlefirebasedataconnectservice/internal"
...
func NewGoogleFirebaseDataConnectService(scope constructs.Construct, id *string, config *GoogleFirebaseDataConnectServiceConfig) GoogleFirebaseDataConnectService {
	...
	_jsii_.Create(
		"googlebeta.googleFirebaseDataConnectService.GoogleFirebaseDataConnectService",
