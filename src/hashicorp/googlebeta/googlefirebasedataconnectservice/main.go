...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceConfig",
		reflect.TypeOf((*GoogleFirebaseDataConnectServiceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseDataConnectService.GoogleFirebaseDataConnectServiceTimeouts",
