...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConfig",
		reflect.TypeOf((*DataGoogleComputeNetworkAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpoints",
		reflect.TypeOf((*DataGoogleComputeNetworkAttachmentConnectionEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpointsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpointsOutputReference",
