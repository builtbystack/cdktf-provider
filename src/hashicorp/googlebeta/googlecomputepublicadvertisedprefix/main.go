...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixConfig",
		reflect.TypeOf((*GoogleComputePublicAdvertisedPrefixConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeouts",
		reflect.TypeOf((*GoogleComputePublicAdvertisedPrefixTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputePublicAdvertisedPrefix.GoogleComputePublicAdvertisedPrefixTimeoutsOutputReference",
