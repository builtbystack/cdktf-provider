...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSecureSourceManagerInstanceIamMember.GoogleSecureSourceManagerInstanceIamMemberCondition",
		reflect.TypeOf((*GoogleSecureSourceManagerInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleSecureSourceManagerInstanceIamMember.GoogleSecureSourceManagerInstanceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSecureSourceManagerInstanceIamMember.GoogleSecureSourceManagerInstanceIamMemberConfig",
