...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBuckets",
		reflect.TypeOf((*DataGoogleStorageBucketsBuckets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleStorageBuckets.DataGoogleStorageBucketsConfig",
