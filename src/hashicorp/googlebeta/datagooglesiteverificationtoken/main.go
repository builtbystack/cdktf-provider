...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenConfig",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeouts",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeoutsOutputReference",
