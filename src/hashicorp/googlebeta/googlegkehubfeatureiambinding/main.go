...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingCondition",
		reflect.TypeOf((*GoogleGkeHubFeatureIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubFeatureIamBinding.GoogleGkeHubFeatureIamBindingConfig",
