...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareConsentStoreIamMember.GoogleHealthcareConsentStoreIamMemberCondition",
		reflect.TypeOf((*GoogleHealthcareConsentStoreIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareConsentStoreIamMember.GoogleHealthcareConsentStoreIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareConsentStoreIamMember.GoogleHealthcareConsentStoreIamMemberConfig",
