...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberCondition",
		reflect.TypeOf((*GooglePrivatecaCaPoolIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePrivatecaCaPoolIamMember.GooglePrivatecaCaPoolIamMemberConfig",
