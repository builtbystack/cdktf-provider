...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglekmssecretciphertext/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_kms_secret_ciphertext google_kms_secret_ciphertext}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_kms_secret_ciphertext google_kms_secret_ciphertext} Data Source.
func NewDataGoogleKmsSecretCiphertext(scope constructs.Construct, id *string, config *DataGoogleKmsSecretCiphertextConfig) DataGoogleKmsSecretCiphertext {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleKmsSecretCiphertext.DataGoogleKmsSecretCiphertext",
