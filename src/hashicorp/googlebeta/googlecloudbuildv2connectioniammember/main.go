...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2ConnectionIamMember.GoogleCloudbuildv2ConnectionIamMemberCondition",
		reflect.TypeOf((*GoogleCloudbuildv2ConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudbuildv2ConnectionIamMember.GoogleCloudbuildv2ConnectionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudbuildv2ConnectionIamMember.GoogleCloudbuildv2ConnectionIamMemberConfig",
