...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceConfig",
		reflect.TypeOf((*GoogleFirebaseDatabaseInstanceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeouts",
		reflect.TypeOf((*GoogleFirebaseDatabaseInstanceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseDatabaseInstance.GoogleFirebaseDatabaseInstanceTimeoutsOutputReference",
