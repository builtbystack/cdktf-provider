...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingConfig",
		reflect.TypeOf((*GoogleGeminiLoggingSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeouts",
		reflect.TypeOf((*GoogleGeminiLoggingSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGeminiLoggingSetting.GoogleGeminiLoggingSettingTimeoutsOutputReference",
