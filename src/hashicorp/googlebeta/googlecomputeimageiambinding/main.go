...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeImageIamBinding.GoogleComputeImageIamBindingCondition",
		reflect.TypeOf((*GoogleComputeImageIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeImageIamBinding.GoogleComputeImageIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeImageIamBinding.GoogleComputeImageIamBindingConfig",
