...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionTargetHttpsProxy.GoogleComputeRegionTargetHttpsProxyConfig",
		reflect.TypeOf((*GoogleComputeRegionTargetHttpsProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionTargetHttpsProxy.GoogleComputeRegionTargetHttpsProxyTimeouts",
