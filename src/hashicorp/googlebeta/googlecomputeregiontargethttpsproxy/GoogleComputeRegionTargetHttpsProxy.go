...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlecomputeregiontargethttpsproxy/internal"
...
func NewGoogleComputeRegionTargetHttpsProxy(scope constructs.Construct, id *string, config *GoogleComputeRegionTargetHttpsProxyConfig) GoogleComputeRegionTargetHttpsProxy {
	...
	_jsii_.Create(
		"googlebeta.googleComputeRegionTargetHttpsProxy.GoogleComputeRegionTargetHttpsProxy",
