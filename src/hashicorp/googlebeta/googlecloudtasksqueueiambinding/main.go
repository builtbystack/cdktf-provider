...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingCondition",
		reflect.TypeOf((*GoogleCloudTasksQueueIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleCloudTasksQueueIamBinding.GoogleCloudTasksQueueIamBindingConfig",
