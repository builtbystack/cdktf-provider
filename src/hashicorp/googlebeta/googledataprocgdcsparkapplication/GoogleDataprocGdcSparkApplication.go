...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googledataprocgdcsparkapplication/internal"
...
func NewGoogleDataprocGdcSparkApplication(scope constructs.Construct, id *string, config *GoogleDataprocGdcSparkApplicationConfig) GoogleDataprocGdcSparkApplication {
	...
	_jsii_.Create(
		"googlebeta.googleDataprocGdcSparkApplication.GoogleDataprocGdcSparkApplication",
