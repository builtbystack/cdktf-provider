...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglecloudassetresourcessearchall/internal"
...
func NewDataGoogleCloudAssetResourcesSearchAll(scope constructs.Construct, id *string, config *DataGoogleCloudAssetResourcesSearchAllConfig) DataGoogleCloudAssetResourcesSearchAll {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleCloudAssetResourcesSearchAll.DataGoogleCloudAssetResourcesSearchAll",
