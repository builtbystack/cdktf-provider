...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudAssetResourcesSearchAll.DataGoogleCloudAssetResourcesSearchAllConfig",
		reflect.TypeOf((*DataGoogleCloudAssetResourcesSearchAllConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCloudAssetResourcesSearchAll.DataGoogleCloudAssetResourcesSearchAllResults",
		reflect.TypeOf((*DataGoogleCloudAssetResourcesSearchAllResults)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleCloudAssetResourcesSearchAll.DataGoogleCloudAssetResourcesSearchAllResultsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleCloudAssetResourcesSearchAll.DataGoogleCloudAssetResourcesSearchAllResultsOutputReference",
