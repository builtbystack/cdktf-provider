...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_storage_bucket_object google_storage_bucket_object}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_storage_bucket_object google_storage_bucket_object} Resource.
func NewGoogleStorageBucketObject(scope constructs.Construct, id *string, config *GoogleStorageBucketObjectConfig) GoogleStorageBucketObject {
	...
	_jsii_.Create(
		"googlebeta.googleStorageBucketObject.GoogleStorageBucketObject",
