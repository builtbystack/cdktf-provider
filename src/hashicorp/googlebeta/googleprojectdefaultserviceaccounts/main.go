...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsConfig",
		reflect.TypeOf((*GoogleProjectDefaultServiceAccountsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeouts",
		reflect.TypeOf((*GoogleProjectDefaultServiceAccountsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleProjectDefaultServiceAccounts.GoogleProjectDefaultServiceAccountsTimeoutsOutputReference",
