...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleKmsCryptoKeyLatestVersion.DataGoogleKmsCryptoKeyLatestVersionConfig",
		reflect.TypeOf((*DataGoogleKmsCryptoKeyLatestVersionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleKmsCryptoKeyLatestVersion.DataGoogleKmsCryptoKeyLatestVersionPublicKey",
		reflect.TypeOf((*DataGoogleKmsCryptoKeyLatestVersionPublicKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleKmsCryptoKeyLatestVersion.DataGoogleKmsCryptoKeyLatestVersionPublicKeyList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleKmsCryptoKeyLatestVersion.DataGoogleKmsCryptoKeyLatestVersionPublicKeyOutputReference",
