...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintConfig",
		reflect.TypeOf((*GoogleOrgPolicyCustomConstraintConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintTimeouts",
		reflect.TypeOf((*GoogleOrgPolicyCustomConstraintTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleOrgPolicyCustomConstraint.GoogleOrgPolicyCustomConstraintTimeoutsOutputReference",
