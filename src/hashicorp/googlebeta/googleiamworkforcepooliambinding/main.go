...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIamWorkforcePoolIamBinding.GoogleIamWorkforcePoolIamBindingCondition",
		reflect.TypeOf((*GoogleIamWorkforcePoolIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIamWorkforcePoolIamBinding.GoogleIamWorkforcePoolIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIamWorkforcePoolIamBinding.GoogleIamWorkforcePoolIamBindingConfig",
