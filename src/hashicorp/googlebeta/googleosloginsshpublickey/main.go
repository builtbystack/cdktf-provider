...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyConfig",
		reflect.TypeOf((*GoogleOsLoginSshPublicKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeouts",
		reflect.TypeOf((*GoogleOsLoginSshPublicKeyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleOsLoginSshPublicKey.GoogleOsLoginSshPublicKeyTimeoutsOutputReference",
