...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleParameterManagerParameter.DataGoogleParameterManagerParameterConfig",
		reflect.TypeOf((*DataGoogleParameterManagerParameterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleParameterManagerParameter.DataGoogleParameterManagerParameterPolicyMember",
		reflect.TypeOf((*DataGoogleParameterManagerParameterPolicyMember)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleParameterManagerParameter.DataGoogleParameterManagerParameterPolicyMemberList",
