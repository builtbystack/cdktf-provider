...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleparametermanagerparameter/internal"
...
func NewDataGoogleParameterManagerParameter(scope constructs.Construct, id *string, config *DataGoogleParameterManagerParameterConfig) DataGoogleParameterManagerParameter {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleParameterManagerParameter.DataGoogleParameterManagerParameter",
