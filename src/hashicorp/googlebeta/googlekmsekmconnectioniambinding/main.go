...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingCondition",
		reflect.TypeOf((*GoogleKmsEkmConnectionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsEkmConnectionIamBinding.GoogleKmsEkmConnectionIamBindingConfig",
