...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectIamMember.GoogleProjectIamMemberCondition",
		reflect.TypeOf((*GoogleProjectIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleProjectIamMember.GoogleProjectIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleProjectIamMember.GoogleProjectIamMemberConfig",
