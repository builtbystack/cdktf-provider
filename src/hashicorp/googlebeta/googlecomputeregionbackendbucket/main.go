...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionBackendBucket.GoogleComputeRegionBackendBucketConfig",
		reflect.TypeOf((*GoogleComputeRegionBackendBucketConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionBackendBucket.GoogleComputeRegionBackendBucketTimeouts",
