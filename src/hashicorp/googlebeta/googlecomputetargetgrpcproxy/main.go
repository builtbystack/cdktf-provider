...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetGrpcProxy.GoogleComputeTargetGrpcProxyConfig",
		reflect.TypeOf((*GoogleComputeTargetGrpcProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeTargetGrpcProxy.GoogleComputeTargetGrpcProxyTimeouts",
		reflect.TypeOf((*GoogleComputeTargetGrpcProxyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeTargetGrpcProxy.GoogleComputeTargetGrpcProxyTimeoutsOutputReference",
