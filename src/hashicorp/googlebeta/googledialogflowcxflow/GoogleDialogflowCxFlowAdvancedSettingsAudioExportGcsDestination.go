...
type GoogleDialogflowCxFlowAdvancedSettingsAudioExportGcsDestination struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_dialogflow_cx_flow#uri GoogleDialogflowCxFlow#uri}
