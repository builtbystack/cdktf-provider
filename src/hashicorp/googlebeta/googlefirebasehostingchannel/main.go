...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingChannel.GoogleFirebaseHostingChannelConfig",
		reflect.TypeOf((*GoogleFirebaseHostingChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseHostingChannel.GoogleFirebaseHostingChannelTimeouts",
		reflect.TypeOf((*GoogleFirebaseHostingChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseHostingChannel.GoogleFirebaseHostingChannelTimeoutsOutputReference",
