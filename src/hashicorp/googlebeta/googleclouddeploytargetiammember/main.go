...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployTargetIamMember.GoogleClouddeployTargetIamMemberCondition",
		reflect.TypeOf((*GoogleClouddeployTargetIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleClouddeployTargetIamMember.GoogleClouddeployTargetIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleClouddeployTargetIamMember.GoogleClouddeployTargetIamMemberConfig",
