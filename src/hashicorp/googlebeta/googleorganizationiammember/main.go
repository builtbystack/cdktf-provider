...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberCondition",
		reflect.TypeOf((*GoogleOrganizationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleOrganizationIamMember.GoogleOrganizationIamMemberConfig",
