...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberCondition",
		reflect.TypeOf((*GoogleAccessContextManagerAccessPolicyIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleAccessContextManagerAccessPolicyIamMember.GoogleAccessContextManagerAccessPolicyIamMemberConfig",
