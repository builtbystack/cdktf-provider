...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetConfig",
		reflect.TypeOf((*GoogleVertexAiDatasetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetEncryptionSpec",
		reflect.TypeOf((*GoogleVertexAiDatasetEncryptionSpec)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetEncryptionSpecOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetTimeouts",
		reflect.TypeOf((*GoogleVertexAiDatasetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleVertexAiDataset.GoogleVertexAiDatasetTimeoutsOutputReference",
