...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorizationConfig",
		reflect.TypeOf((*DataGoogleCertificateManagerDnsAuthorizationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorizationDnsResourceRecord",
