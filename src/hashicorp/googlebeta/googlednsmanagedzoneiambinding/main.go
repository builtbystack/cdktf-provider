...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDnsManagedZoneIamBinding.GoogleDnsManagedZoneIamBindingCondition",
		reflect.TypeOf((*GoogleDnsManagedZoneIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDnsManagedZoneIamBinding.GoogleDnsManagedZoneIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDnsManagedZoneIamBinding.GoogleDnsManagedZoneIamBindingConfig",
