...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlestorageanywherecache/internal"
...
func NewGoogleStorageAnywhereCache(scope constructs.Construct, id *string, config *GoogleStorageAnywhereCacheConfig) GoogleStorageAnywhereCache {
	...
	_jsii_.Create(
		"googlebeta.googleStorageAnywhereCache.GoogleStorageAnywhereCache",
