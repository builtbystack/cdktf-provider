...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupConfig",
		reflect.TypeOf((*GoogleIapTunnelDestGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupTimeouts",
		reflect.TypeOf((*GoogleIapTunnelDestGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapTunnelDestGroup.GoogleIapTunnelDestGroupTimeoutsOutputReference",
