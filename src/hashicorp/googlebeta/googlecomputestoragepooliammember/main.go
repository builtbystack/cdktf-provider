...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeStoragePoolIamMember.GoogleComputeStoragePoolIamMemberCondition",
		reflect.TypeOf((*GoogleComputeStoragePoolIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeStoragePoolIamMember.GoogleComputeStoragePoolIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeStoragePoolIamMember.GoogleComputeStoragePoolIamMemberConfig",
