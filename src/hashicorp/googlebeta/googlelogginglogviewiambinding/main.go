...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingCondition",
		reflect.TypeOf((*GoogleLoggingLogViewIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleLoggingLogViewIamBinding.GoogleLoggingLogViewIamBindingConfig",
