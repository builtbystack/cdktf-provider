...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionDiskResourcePolicyAttachment.GoogleComputeRegionDiskResourcePolicyAttachmentConfig",
		reflect.TypeOf((*GoogleComputeRegionDiskResourcePolicyAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionDiskResourcePolicyAttachment.GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts",
		reflect.TypeOf((*GoogleComputeRegionDiskResourcePolicyAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeRegionDiskResourcePolicyAttachment.GoogleComputeRegionDiskResourcePolicyAttachmentTimeoutsOutputReference",
