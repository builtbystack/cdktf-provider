...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableLogicalView.GoogleBigtableLogicalViewConfig",
		reflect.TypeOf((*GoogleBigtableLogicalViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeouts",
		reflect.TypeOf((*GoogleBigtableLogicalViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBigtableLogicalView.GoogleBigtableLogicalViewTimeoutsOutputReference",
