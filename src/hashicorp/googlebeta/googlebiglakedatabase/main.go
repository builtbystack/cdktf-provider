...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeDatabase.GoogleBiglakeDatabaseConfig",
		reflect.TypeOf((*GoogleBiglakeDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeDatabase.GoogleBiglakeDatabaseHiveOptions",
		reflect.TypeOf((*GoogleBiglakeDatabaseHiveOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBiglakeDatabase.GoogleBiglakeDatabaseHiveOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeDatabase.GoogleBiglakeDatabaseTimeouts",
		reflect.TypeOf((*GoogleBiglakeDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBiglakeDatabase.GoogleBiglakeDatabaseTimeoutsOutputReference",
