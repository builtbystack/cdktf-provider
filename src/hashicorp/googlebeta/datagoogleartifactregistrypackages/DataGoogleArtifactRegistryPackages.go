...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_artifact_registry_packages google_artifact_registry_packages}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/data-sources/google_artifact_registry_packages google_artifact_registry_packages} Data Source.
func NewDataGoogleArtifactRegistryPackages(scope constructs.Construct, id *string, config *DataGoogleArtifactRegistryPackagesConfig) DataGoogleArtifactRegistryPackages {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackages",
