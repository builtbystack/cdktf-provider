...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlefirebaseappcheckappattestconfig/internal"
...
func NewGoogleFirebaseAppCheckAppAttestConfig(scope constructs.Construct, id *string, config *GoogleFirebaseAppCheckAppAttestConfigConfig) GoogleFirebaseAppCheckAppAttestConfig {
	...
	_jsii_.Create(
		"googlebeta.googleFirebaseAppCheckAppAttestConfig.GoogleFirebaseAppCheckAppAttestConfig",
