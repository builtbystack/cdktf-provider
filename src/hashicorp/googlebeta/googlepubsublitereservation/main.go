...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubLiteReservation.GooglePubsubLiteReservationConfig",
		reflect.TypeOf((*GooglePubsubLiteReservationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googlePubsubLiteReservation.GooglePubsubLiteReservationTimeouts",
		reflect.TypeOf((*GooglePubsubLiteReservationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googlePubsubLiteReservation.GooglePubsubLiteReservationTimeoutsOutputReference",
