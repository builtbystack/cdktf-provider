...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppConfig",
		reflect.TypeOf((*GoogleFirebaseWebAppConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeouts",
		reflect.TypeOf((*GoogleFirebaseWebAppTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseWebApp.GoogleFirebaseWebAppTimeoutsOutputReference",
