...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvironmentIamMember.GoogleApigeeEnvironmentIamMemberCondition",
		reflect.TypeOf((*GoogleApigeeEnvironmentIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeEnvironmentIamMember.GoogleApigeeEnvironmentIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvironmentIamMember.GoogleApigeeEnvironmentIamMemberConfig",
