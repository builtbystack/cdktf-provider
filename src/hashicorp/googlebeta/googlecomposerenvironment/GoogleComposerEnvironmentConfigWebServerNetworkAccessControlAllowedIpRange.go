...
type GoogleComposerEnvironmentConfigWebServerNetworkAccessControlAllowedIpRange struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_composer_environment#value GoogleComposerEnvironment#value}
	Value *string `field:"required" json:"value" yaml:"value"`
	// A description of this ip range.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_composer_environment#description GoogleComposerEnvironment#description}
