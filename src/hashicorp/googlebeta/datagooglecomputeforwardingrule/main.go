...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleConfig",
		reflect.TypeOf((*DataGoogleComputeForwardingRuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrations",
		reflect.TypeOf((*DataGoogleComputeForwardingRuleServiceDirectoryRegistrations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeForwardingRule.DataGoogleComputeForwardingRuleServiceDirectoryRegistrationsOutputReference",
