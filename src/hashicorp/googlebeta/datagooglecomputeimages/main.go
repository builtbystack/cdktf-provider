...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeImages.DataGoogleComputeImagesConfig",
		reflect.TypeOf((*DataGoogleComputeImagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleComputeImages.DataGoogleComputeImagesImages",
		reflect.TypeOf((*DataGoogleComputeImagesImages)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeImages.DataGoogleComputeImagesImagesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleComputeImages.DataGoogleComputeImagesImagesOutputReference",
