...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFilestoreSnapshot.GoogleFilestoreSnapshotConfig",
		reflect.TypeOf((*GoogleFilestoreSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeouts",
		reflect.TypeOf((*GoogleFilestoreSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFilestoreSnapshot.GoogleFilestoreSnapshotTimeoutsOutputReference",
