...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyConfig",
		reflect.TypeOf((*GoogleComputeRegionTargetTcpProxyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyTimeouts",
		reflect.TypeOf((*GoogleComputeRegionTargetTcpProxyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeRegionTargetTcpProxy.GoogleComputeRegionTargetTcpProxyTimeoutsOutputReference",
