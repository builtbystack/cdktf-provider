...
func init() {
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAcl",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclAclEntries",
		reflect.TypeOf((*GoogleManagedKafkaAclAclEntries)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclAclEntriesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclAclEntriesOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclConfig",
		reflect.TypeOf((*GoogleManagedKafkaAclConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeouts",
		reflect.TypeOf((*GoogleManagedKafkaAclTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleManagedKafkaAcl.GoogleManagedKafkaAclTimeoutsOutputReference",
