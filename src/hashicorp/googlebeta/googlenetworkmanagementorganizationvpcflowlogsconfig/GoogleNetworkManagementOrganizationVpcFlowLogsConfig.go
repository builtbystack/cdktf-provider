...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlenetworkmanagementorganizationvpcflowlogsconfig/internal"
...
func NewGoogleNetworkManagementOrganizationVpcFlowLogsConfig(scope constructs.Construct, id *string, config *GoogleNetworkManagementOrganizationVpcFlowLogsConfigConfig) GoogleNetworkManagementOrganizationVpcFlowLogsConfig {
	...
	_jsii_.Create(
		"googlebeta.googleNetworkManagementOrganizationVpcFlowLogsConfig.GoogleNetworkManagementOrganizationVpcFlowLogsConfig",
