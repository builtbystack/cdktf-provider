...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirestoreDocument.GoogleFirestoreDocumentConfig",
		reflect.TypeOf((*GoogleFirestoreDocumentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirestoreDocument.GoogleFirestoreDocumentTimeouts",
		reflect.TypeOf((*GoogleFirestoreDocumentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirestoreDocument.GoogleFirestoreDocumentTimeoutsOutputReference",
