...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleclouddomainsregistration/internal"
...
func NewGoogleClouddomainsRegistration(scope constructs.Construct, id *string, config *GoogleClouddomainsRegistrationConfig) GoogleClouddomainsRegistration {
	...
	_jsii_.Create(
		"googlebeta.googleClouddomainsRegistration.GoogleClouddomainsRegistration",
