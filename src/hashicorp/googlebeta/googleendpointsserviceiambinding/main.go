...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingCondition",
		reflect.TypeOf((*GoogleEndpointsServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEndpointsServiceIamBinding.GoogleEndpointsServiceIamBindingConfig",
