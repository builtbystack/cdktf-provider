...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAiLogicPromptTemplateLock.GoogleFirebaseAiLogicPromptTemplateLockConfig",
		reflect.TypeOf((*GoogleFirebaseAiLogicPromptTemplateLockConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseAiLogicPromptTemplateLock.GoogleFirebaseAiLogicPromptTemplateLockTimeouts",
