...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlefirebaseappcheckplayintegrityconfig/internal"
...
func NewGoogleFirebaseAppCheckPlayIntegrityConfig(scope constructs.Construct, id *string, config *GoogleFirebaseAppCheckPlayIntegrityConfigConfig) GoogleFirebaseAppCheckPlayIntegrityConfig {
	...
	_jsii_.Create(
		"googlebeta.googleFirebaseAppCheckPlayIntegrityConfig.GoogleFirebaseAppCheckPlayIntegrityConfig",
