...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityBackendAuthenticationConfig.GoogleNetworkSecurityBackendAuthenticationConfigConfig",
		reflect.TypeOf((*GoogleNetworkSecurityBackendAuthenticationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkSecurityBackendAuthenticationConfig.GoogleNetworkSecurityBackendAuthenticationConfigTimeouts",
