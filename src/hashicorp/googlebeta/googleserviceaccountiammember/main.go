...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberCondition",
		reflect.TypeOf((*GoogleServiceAccountIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleServiceAccountIamMember.GoogleServiceAccountIamMemberConfig",
