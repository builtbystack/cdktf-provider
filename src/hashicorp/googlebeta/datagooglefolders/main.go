...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleFolders.DataGoogleFoldersConfig",
		reflect.TypeOf((*DataGoogleFoldersConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleFolders.DataGoogleFoldersFolders",
		reflect.TypeOf((*DataGoogleFoldersFolders)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleFolders.DataGoogleFoldersFoldersList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleFolders.DataGoogleFoldersFoldersOutputReference",
