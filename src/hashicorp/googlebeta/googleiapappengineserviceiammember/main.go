...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapAppEngineServiceIamMember.GoogleIapAppEngineServiceIamMemberCondition",
		reflect.TypeOf((*GoogleIapAppEngineServiceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleIapAppEngineServiceIamMember.GoogleIapAppEngineServiceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleIapAppEngineServiceIamMember.GoogleIapAppEngineServiceIamMemberConfig",
