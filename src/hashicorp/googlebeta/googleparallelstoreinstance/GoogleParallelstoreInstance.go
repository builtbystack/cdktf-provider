...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleparallelstoreinstance/internal"
...
func NewGoogleParallelstoreInstance(scope constructs.Construct, id *string, config *GoogleParallelstoreInstanceConfig) GoogleParallelstoreInstance {
	...
	_jsii_.Create(
		"googlebeta.googleParallelstoreInstance.GoogleParallelstoreInstance",
