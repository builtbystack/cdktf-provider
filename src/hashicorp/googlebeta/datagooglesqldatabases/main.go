...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlDatabases.DataGoogleSqlDatabasesConfig",
		reflect.TypeOf((*DataGoogleSqlDatabasesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleSqlDatabases.DataGoogleSqlDatabasesDatabases",
		reflect.TypeOf((*DataGoogleSqlDatabasesDatabases)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlDatabases.DataGoogleSqlDatabasesDatabasesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleSqlDatabases.DataGoogleSqlDatabasesDatabasesOutputReference",
