...
func (g *jsiiProxy_GoogleSaasRuntimeUnitConditionsList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleSaasRuntimeUnitConditionsList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleSaasRuntimeUnitConditionsList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleSaasRuntimeUnitConditionsList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
