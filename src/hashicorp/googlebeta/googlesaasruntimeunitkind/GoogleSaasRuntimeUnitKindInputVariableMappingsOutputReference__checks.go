...
func (j *jsiiProxy_GoogleSaasRuntimeUnitKindInputVariableMappingsOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *GoogleSaasRuntimeUnitKindInputVariableMappings; received %#v (a %T)", val, val)
		}
	}
