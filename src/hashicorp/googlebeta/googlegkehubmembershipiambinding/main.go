...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubMembershipIamBinding.GoogleGkeHubMembershipIamBindingCondition",
		reflect.TypeOf((*GoogleGkeHubMembershipIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeHubMembershipIamBinding.GoogleGkeHubMembershipIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubMembershipIamBinding.GoogleGkeHubMembershipIamBindingConfig",
