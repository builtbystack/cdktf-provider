...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingCondition",
		reflect.TypeOf((*GoogleApigeeEnvironmentIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeEnvironmentIamBinding.GoogleApigeeEnvironmentIamBindingConfig",
