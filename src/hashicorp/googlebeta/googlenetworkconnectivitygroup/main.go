...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupAutoAccept",
		reflect.TypeOf((*GoogleNetworkConnectivityGroupAutoAccept)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupAutoAcceptOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupConfig",
		reflect.TypeOf((*GoogleNetworkConnectivityGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupTimeouts",
		reflect.TypeOf((*GoogleNetworkConnectivityGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNetworkConnectivityGroup.GoogleNetworkConnectivityGroupTimeoutsOutputReference",
