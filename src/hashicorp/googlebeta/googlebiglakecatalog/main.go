...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeCatalog.GoogleBiglakeCatalogConfig",
		reflect.TypeOf((*GoogleBiglakeCatalogConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleBiglakeCatalog.GoogleBiglakeCatalogTimeouts",
		reflect.TypeOf((*GoogleBiglakeCatalogTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleBiglakeCatalog.GoogleBiglakeCatalogTimeoutsOutputReference",
