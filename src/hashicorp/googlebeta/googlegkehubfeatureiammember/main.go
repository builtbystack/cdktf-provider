...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberCondition",
		reflect.TypeOf((*GoogleGkeHubFeatureIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleGkeHubFeatureIamMember.GoogleGkeHubFeatureIamMemberConfig",
