...
type GoogleNetworkSecurityAuthzPolicyHttpRulesToOperationsMcpMethods struct {
	...
	// params block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_network_security_authz_policy#params GoogleNetworkSecurityAuthzPolicy#params}
