...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContainerAnalysisNoteIamBinding.GoogleContainerAnalysisNoteIamBindingCondition",
		reflect.TypeOf((*GoogleContainerAnalysisNoteIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleContainerAnalysisNoteIamBinding.GoogleContainerAnalysisNoteIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleContainerAnalysisNoteIamBinding.GoogleContainerAnalysisNoteIamBindingConfig",
