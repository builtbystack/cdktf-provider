...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBigqueryTables.DataGoogleBigqueryTablesConfig",
		reflect.TypeOf((*DataGoogleBigqueryTablesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTables",
		reflect.TypeOf((*DataGoogleBigqueryTablesTables)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTablesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTablesOutputReference",
