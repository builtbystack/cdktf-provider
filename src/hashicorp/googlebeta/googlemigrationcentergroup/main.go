...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleMigrationCenterGroup.GoogleMigrationCenterGroupConfig",
		reflect.TypeOf((*GoogleMigrationCenterGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeouts",
		reflect.TypeOf((*GoogleMigrationCenterGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleMigrationCenterGroup.GoogleMigrationCenterGroupTimeoutsOutputReference",
