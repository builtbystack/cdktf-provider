...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagooglekmskeyhandle/internal"
...
func NewDataGoogleKmsKeyHandle(scope constructs.Construct, id *string, config *DataGoogleKmsKeyHandleConfig) DataGoogleKmsKeyHandle {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleKmsKeyHandle.DataGoogleKmsKeyHandle",
