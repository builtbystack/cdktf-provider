...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringConfig",
		reflect.TypeOf((*GoogleActiveDirectoryPeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeouts",
		reflect.TypeOf((*GoogleActiveDirectoryPeeringTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleActiveDirectoryPeering.GoogleActiveDirectoryPeeringTimeoutsOutputReference",
