...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSubnetworkIamMember.GoogleComputeSubnetworkIamMemberCondition",
		reflect.TypeOf((*GoogleComputeSubnetworkIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeSubnetworkIamMember.GoogleComputeSubnetworkIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeSubnetworkIamMember.GoogleComputeSubnetworkIamMemberConfig",
