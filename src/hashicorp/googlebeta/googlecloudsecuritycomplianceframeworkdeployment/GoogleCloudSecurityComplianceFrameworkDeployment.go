...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_cloud_security_compliance_framework_deployment google_cloud_security_compliance_framework_deployment}.
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_cloud_security_compliance_framework_deployment google_cloud_security_compliance_framework_deployment} Resource.
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a GoogleCloudSecurityComplianceFrameworkDeployment resource upon running "cdktf plan <stack-name>".
func GoogleCloudSecurityComplianceFrameworkDeployment_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (g *jsiiProxy_GoogleCloudSecurityComplianceFrameworkDeployment) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
