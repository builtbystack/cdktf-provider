...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexAspectTypeIamMember.GoogleDataplexAspectTypeIamMemberCondition",
		reflect.TypeOf((*GoogleDataplexAspectTypeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataplexAspectTypeIamMember.GoogleDataplexAspectTypeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataplexAspectTypeIamMember.GoogleDataplexAspectTypeIamMemberConfig",
