...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsEkmConnectionIamMember.GoogleKmsEkmConnectionIamMemberCondition",
		reflect.TypeOf((*GoogleKmsEkmConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleKmsEkmConnectionIamMember.GoogleKmsEkmConnectionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleKmsEkmConnectionIamMember.GoogleKmsEkmConnectionIamMemberConfig",
