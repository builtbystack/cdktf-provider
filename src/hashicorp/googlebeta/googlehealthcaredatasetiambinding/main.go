...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingCondition",
		reflect.TypeOf((*GoogleHealthcareDatasetIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleHealthcareDatasetIamBinding.GoogleHealthcareDatasetIamBindingConfig",
