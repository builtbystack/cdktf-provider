...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortAConfig",
		reflect.TypeOf((*GoogleComputeInstanceGroupNamedPortAConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortTimeouts",
		reflect.TypeOf((*GoogleComputeInstanceGroupNamedPortTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeInstanceGroupNamedPort.GoogleComputeInstanceGroupNamedPortTimeoutsOutputReference",
