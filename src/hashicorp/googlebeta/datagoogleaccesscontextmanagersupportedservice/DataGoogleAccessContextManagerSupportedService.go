...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogleaccesscontextmanagersupportedservice/internal"
...
func NewDataGoogleAccessContextManagerSupportedService(scope constructs.Construct, id *string, config *DataGoogleAccessContextManagerSupportedServiceConfig) DataGoogleAccessContextManagerSupportedService {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleAccessContextManagerSupportedService.DataGoogleAccessContextManagerSupportedService",
