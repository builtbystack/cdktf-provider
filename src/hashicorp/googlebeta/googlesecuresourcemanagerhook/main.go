...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookConfig",
		reflect.TypeOf((*GoogleSecureSourceManagerHookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookPushOption",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleSecureSourceManagerHook.GoogleSecureSourceManagerHookTimeouts",
