...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_storage_bucket google_storage_bucket}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google-beta/7.24.0/docs/resources/google_storage_bucket google_storage_bucket} Resource.
func NewGoogleStorageBucket(scope constructs.Construct, id *string, config *GoogleStorageBucketConfig) GoogleStorageBucket {
	...
	_jsii_.Create(
		"googlebeta.googleStorageBucket.GoogleStorageBucket",
