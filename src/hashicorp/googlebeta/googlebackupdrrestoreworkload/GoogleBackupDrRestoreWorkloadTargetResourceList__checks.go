...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkloadTargetResourceList) validateAllWithMapKeyParameters(mapKeyAttributeName *string) error {
...
func (g *jsiiProxy_GoogleBackupDrRestoreWorkloadTargetResourceList) validateGetParameters(index *float64) error {
	if index == nil {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkloadTargetResourceList) validateSetTerraformAttributeParameters(val *string) error {
	if val == nil {
...
func (j *jsiiProxy_GoogleBackupDrRestoreWorkloadTargetResourceList) validateSetWrapsSetParameters(val *bool) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
