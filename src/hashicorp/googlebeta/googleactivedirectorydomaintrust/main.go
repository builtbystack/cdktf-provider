...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustConfig",
		reflect.TypeOf((*GoogleActiveDirectoryDomainTrustConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustTimeouts",
		reflect.TypeOf((*GoogleActiveDirectoryDomainTrustTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleActiveDirectoryDomainTrust.GoogleActiveDirectoryDomainTrustTimeoutsOutputReference",
