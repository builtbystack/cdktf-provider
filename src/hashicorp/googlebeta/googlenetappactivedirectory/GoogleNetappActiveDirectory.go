...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlenetappactivedirectory/internal"
...
func NewGoogleNetappActiveDirectory(scope constructs.Construct, id *string, config *GoogleNetappActiveDirectoryConfig) GoogleNetappActiveDirectory {
	...
	_jsii_.Create(
		"googlebeta.googleNetappActiveDirectory.GoogleNetappActiveDirectory",
