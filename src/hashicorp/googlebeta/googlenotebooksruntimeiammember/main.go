...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberCondition",
		reflect.TypeOf((*GoogleNotebooksRuntimeIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleNotebooksRuntimeIamMember.GoogleNotebooksRuntimeIamMemberConfig",
