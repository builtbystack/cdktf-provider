...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstationConfigIamBinding.GoogleWorkstationsWorkstationConfigIamBindingCondition",
		reflect.TypeOf((*GoogleWorkstationsWorkstationConfigIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleWorkstationsWorkstationConfigIamBinding.GoogleWorkstationsWorkstationConfigIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleWorkstationsWorkstationConfigIamBinding.GoogleWorkstationsWorkstationConfigIamBindingConfig",
