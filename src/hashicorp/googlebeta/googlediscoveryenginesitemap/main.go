...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapConfig",
		reflect.TypeOf((*GoogleDiscoveryEngineSitemapConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeouts",
		reflect.TypeOf((*GoogleDiscoveryEngineSitemapTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDiscoveryEngineSitemap.GoogleDiscoveryEngineSitemapTimeoutsOutputReference",
