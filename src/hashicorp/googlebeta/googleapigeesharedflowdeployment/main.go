...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentConfig",
		reflect.TypeOf((*GoogleApigeeSharedflowDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeouts",
		reflect.TypeOf((*GoogleApigeeSharedflowDeploymentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleApigeeSharedflowDeployment.GoogleApigeeSharedflowDeploymentTimeoutsOutputReference",
