...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleAlloydbUser.GoogleAlloydbUserConfig",
		reflect.TypeOf((*GoogleAlloydbUserConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleAlloydbUser.GoogleAlloydbUserTimeouts",
		reflect.TypeOf((*GoogleAlloydbUserTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleAlloydbUser.GoogleAlloydbUserTimeoutsOutputReference",
