...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetConfig",
		reflect.TypeOf((*DataGoogleVmwareengineSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetDhcpAddressRanges",
		reflect.TypeOf((*DataGoogleVmwareengineSubnetDhcpAddressRanges)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetDhcpAddressRangesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetDhcpAddressRangesOutputReference",
