...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocMetastoreServiceIamBinding.GoogleDataprocMetastoreServiceIamBindingCondition",
		reflect.TypeOf((*GoogleDataprocMetastoreServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleDataprocMetastoreServiceIamBinding.GoogleDataprocMetastoreServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleDataprocMetastoreServiceIamBinding.GoogleDataprocMetastoreServiceIamBindingConfig",
