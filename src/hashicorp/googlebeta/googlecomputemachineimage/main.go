...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeMachineImage.GoogleComputeMachineImageConfig",
		reflect.TypeOf((*GoogleComputeMachineImageConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKey",
		reflect.TypeOf((*GoogleComputeMachineImageMachineImageEncryptionKey)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeMachineImage.GoogleComputeMachineImageMachineImageEncryptionKeyOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleComputeMachineImage.GoogleComputeMachineImageTimeouts",
		reflect.TypeOf((*GoogleComputeMachineImageTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleComputeMachineImage.GoogleComputeMachineImageTimeoutsOutputReference",
