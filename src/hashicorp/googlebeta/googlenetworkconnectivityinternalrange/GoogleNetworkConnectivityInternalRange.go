...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googlenetworkconnectivityinternalrange/internal"
...
func NewGoogleNetworkConnectivityInternalRange(scope constructs.Construct, id *string, config *GoogleNetworkConnectivityInternalRangeConfig) GoogleNetworkConnectivityInternalRange {
	...
	_jsii_.Create(
		"googlebeta.googleNetworkConnectivityInternalRange.GoogleNetworkConnectivityInternalRange",
