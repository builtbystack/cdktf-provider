...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBusConfig",
		reflect.TypeOf((*GoogleEventarcMessageBusConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBusLoggingConfig",
		reflect.TypeOf((*GoogleEventarcMessageBusLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBusLoggingConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBusTimeouts",
		reflect.TypeOf((*GoogleEventarcMessageBusTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBusTimeoutsOutputReference",
