...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/googleeventarcmessagebus/internal"
...
func NewGoogleEventarcMessageBus(scope constructs.Construct, id *string, config *GoogleEventarcMessageBusConfig) GoogleEventarcMessageBus {
	...
	_jsii_.Create(
		"googlebeta.googleEventarcMessageBus.GoogleEventarcMessageBus",
