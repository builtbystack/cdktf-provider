...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsConfig",
		reflect.TypeOf((*DataGoogleAlloydbLocationsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsLocations",
		reflect.TypeOf((*DataGoogleAlloydbLocationsLocations)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsLocationsList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleAlloydbLocations.DataGoogleAlloydbLocationsLocationsOutputReference",
