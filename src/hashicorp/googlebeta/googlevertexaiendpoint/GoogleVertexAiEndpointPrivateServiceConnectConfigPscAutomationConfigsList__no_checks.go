...
func (g *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList) validateResolveParameters(_context cdktf.IResolveContext) error {
	return nil
}
...
func (j *jsiiProxy_GoogleVertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	return nil
}
...
func validateNewGoogleVertexAiEndpointPrivateServiceConnectConfigPscAutomationConfigsListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
	return nil
}
