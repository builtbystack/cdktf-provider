...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleTagsTagBinding.GoogleTagsTagBindingConfig",
		reflect.TypeOf((*GoogleTagsTagBindingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleTagsTagBinding.GoogleTagsTagBindingTimeouts",
		reflect.TypeOf((*GoogleTagsTagBindingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleTagsTagBinding.GoogleTagsTagBindingTimeoutsOutputReference",
