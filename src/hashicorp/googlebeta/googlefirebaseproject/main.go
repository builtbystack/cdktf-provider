...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseProject.GoogleFirebaseProjectConfig",
		reflect.TypeOf((*GoogleFirebaseProjectConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.googleFirebaseProject.GoogleFirebaseProjectTimeouts",
		reflect.TypeOf((*GoogleFirebaseProjectTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.googleFirebaseProject.GoogleFirebaseProjectTimeoutsOutputReference",
