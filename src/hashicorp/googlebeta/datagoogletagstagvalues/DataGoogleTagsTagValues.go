...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/googlebeta/datagoogletagstagvalues/internal"
...
func NewDataGoogleTagsTagValues(scope constructs.Construct, id *string, config *DataGoogleTagsTagValuesConfig) DataGoogleTagsTagValues {
	...
	_jsii_.Create(
		"googlebeta.dataGoogleTagsTagValues.DataGoogleTagsTagValues",
