...
func init() {
	...
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleTagsTagValues.DataGoogleTagsTagValuesConfig",
		reflect.TypeOf((*DataGoogleTagsTagValuesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"googlebeta.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValues",
		reflect.TypeOf((*DataGoogleTagsTagValuesValues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValuesList",
	...
	_jsii_.RegisterClass(
		"googlebeta.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValuesOutputReference",
