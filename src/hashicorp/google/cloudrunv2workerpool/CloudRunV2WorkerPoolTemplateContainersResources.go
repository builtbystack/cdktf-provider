...
type CloudRunV2WorkerPoolTemplateContainersResources struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/cloud_run_v2_worker_pool#limits CloudRunV2WorkerPool#limits}
