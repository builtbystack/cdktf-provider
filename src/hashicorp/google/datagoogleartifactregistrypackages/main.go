...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryPackagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryPackages.DataGoogleArtifactRegistryPackagesPackages",
