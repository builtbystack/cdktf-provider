...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.documentAiWarehouseLocation.DocumentAiWarehouseLocationConfig",
	...
	_jsii_.RegisterClass(
		"google.documentAiWarehouseLocation.DocumentAiWarehouseLocationTimeoutsOutputReference",
