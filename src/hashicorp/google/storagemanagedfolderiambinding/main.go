...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.storageManagedFolderIamBinding.StorageManagedFolderIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google.storageManagedFolderIamBinding.StorageManagedFolderIamBindingConfig",
