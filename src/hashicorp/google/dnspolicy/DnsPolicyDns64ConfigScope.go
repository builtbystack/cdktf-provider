...
type DnsPolicyDns64ConfigScope struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dns_policy#all_queries DnsPolicy#all_queries}
