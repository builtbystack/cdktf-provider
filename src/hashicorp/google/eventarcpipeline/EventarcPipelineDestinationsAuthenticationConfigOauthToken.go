...
type EventarcPipelineDestinationsAuthenticationConfigOauthToken struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/eventarc_pipeline#scope EventarcPipeline#scope}
