...
type EventarcPipelineLoggingConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/eventarc_pipeline#log_severity EventarcPipeline#log_severity}
