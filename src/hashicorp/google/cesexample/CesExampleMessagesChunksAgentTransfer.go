...
type CesExampleMessagesChunksAgentTransfer struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_example#target_agent CesExample#target_agent}
