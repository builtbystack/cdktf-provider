...
type ComputeRegionBackendServiceHaPolicyLeader struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_backend_service#backend_group ComputeRegionBackendService#backend_group}
	BackendGroup *string `field:"optional" json:"backendGroup" yaml:"backendGroup"`
	// network_endpoint block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_backend_service#network_endpoint ComputeRegionBackendService#network_endpoint}
