...
type ComputeRegionBackendServiceHaPolicyLeaderNetworkEndpoint struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_backend_service#instance ComputeRegionBackendService#instance}
