...
type ComputeRegionBackendServiceHaPolicy struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_backend_service#fast_ip_move ComputeRegionBackendService#fast_ip_move}
	FastIpMove *string `field:"optional" json:"fastIpMove" yaml:"fastIpMove"`
	// leader block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_backend_service#leader ComputeRegionBackendService#leader}
