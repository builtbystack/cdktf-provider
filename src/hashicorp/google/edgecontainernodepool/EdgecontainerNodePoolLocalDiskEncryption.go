...
type EdgecontainerNodePoolLocalDiskEncryption struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/edgecontainer_node_pool#kms_key EdgecontainerNodePool#kms_key}
