...
type ComposerEnvironmentConfigMaintenanceWindow struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/composer_environment#end_time ComposerEnvironment#end_time}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/composer_environment#recurrence ComposerEnvironment#recurrence}
	Recurrence *string `field:"required" json:"recurrence" yaml:"recurrence"`
	// Start time of the first recurrence of the maintenance window.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/composer_environment#start_time ComposerEnvironment#start_time}
