...
type ComposerEnvironmentConfigWebServerNetworkAccessControlAllowedIpRange struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/composer_environment#value ComposerEnvironment#value}
	Value *string `field:"required" json:"value" yaml:"value"`
	// A description of this ip range.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/composer_environment#description ComposerEnvironment#description}
