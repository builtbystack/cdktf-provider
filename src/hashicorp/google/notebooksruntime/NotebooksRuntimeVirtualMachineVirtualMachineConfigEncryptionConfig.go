...
type NotebooksRuntimeVirtualMachineVirtualMachineConfigEncryptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/notebooks_runtime#kms_key NotebooksRuntime#kms_key}
