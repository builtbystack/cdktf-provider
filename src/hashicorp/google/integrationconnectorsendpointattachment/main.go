...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.integrationConnectorsEndpointAttachment.IntegrationConnectorsEndpointAttachmentConfig",
		reflect.TypeOf((*IntegrationConnectorsEndpointAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.integrationConnectorsEndpointAttachment.IntegrationConnectorsEndpointAttachmentTimeouts",
		reflect.TypeOf((*IntegrationConnectorsEndpointAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.integrationConnectorsEndpointAttachment.IntegrationConnectorsEndpointAttachmentTimeoutsOutputReference",
