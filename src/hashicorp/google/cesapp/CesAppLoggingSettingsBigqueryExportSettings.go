...
type CesAppLoggingSettingsBigqueryExportSettings struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_app#dataset CesApp#dataset}
	Dataset *string `field:"optional" json:"dataset" yaml:"dataset"`
	// Indicates whether the BigQuery export is enabled.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_app#enabled CesApp#enabled}
