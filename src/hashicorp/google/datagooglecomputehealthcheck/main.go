...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeHealthCheck.DataGoogleComputeHealthCheckGrpcTlsHealthCheck",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeHealthCheck.DataGoogleComputeHealthCheckGrpcTlsHealthCheckOutputReference",
