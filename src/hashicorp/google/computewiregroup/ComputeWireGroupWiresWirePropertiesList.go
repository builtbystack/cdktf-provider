...
func (j *jsiiProxy_ComputeWireGroupWiresWirePropertiesList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewComputeWireGroupWiresWirePropertiesList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputeWireGroupWiresWirePropertiesList {
	_init_.Initialize()
...
func NewComputeWireGroupWiresWirePropertiesList_Override(c ComputeWireGroupWiresWirePropertiesList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputeWireGroupWiresWirePropertiesList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputeWireGroupWiresWirePropertiesList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputeWireGroupWiresWirePropertiesList) Resolve(_context cdktf.IResolveContext) interface{} {
