...
type SecurityposturePosturePolicySetsPoliciesConstraintSecurityHealthAnalyticsModule struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/securityposture_posture#module_name SecurityposturePosture#module_name}
