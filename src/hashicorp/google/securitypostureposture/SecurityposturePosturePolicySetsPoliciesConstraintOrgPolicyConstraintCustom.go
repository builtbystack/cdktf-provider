...
type SecurityposturePosturePolicySetsPoliciesConstraintOrgPolicyConstraintCustom struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/securityposture_posture#custom_constraint SecurityposturePosture#custom_constraint}
