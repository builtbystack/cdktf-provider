...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.apigeeEnvironmentKeyvaluemaps.ApigeeEnvironmentKeyvaluemapsTimeouts",
		reflect.TypeOf((*ApigeeEnvironmentKeyvaluemapsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.apigeeEnvironmentKeyvaluemaps.ApigeeEnvironmentKeyvaluemapsTimeoutsOutputReference",
