...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/netappstoragepool/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/netapp_storage_pool google_netapp_storage_pool}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/netapp_storage_pool google_netapp_storage_pool} Resource.
func NewNetappStoragePool(scope constructs.Construct, id *string, config *NetappStoragePoolConfig) NetappStoragePool {
	...
	_jsii_.Create(
		"google.netappStoragePool.NetappStoragePool",
