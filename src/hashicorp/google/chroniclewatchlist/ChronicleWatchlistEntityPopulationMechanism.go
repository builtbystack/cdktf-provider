...
type ChronicleWatchlistEntityPopulationMechanism struct {
	// manual block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/chronicle_watchlist#manual ChronicleWatchlist#manual}
