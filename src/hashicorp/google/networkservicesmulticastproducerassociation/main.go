...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkServicesMulticastProducerAssociation.NetworkServicesMulticastProducerAssociationConfig",
		reflect.TypeOf((*NetworkServicesMulticastProducerAssociationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkServicesMulticastProducerAssociation.NetworkServicesMulticastProducerAssociationState",
