...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryTags.DataGoogleArtifactRegistryTagsConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryTagsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryTags.DataGoogleArtifactRegistryTagsTags",
		reflect.TypeOf((*DataGoogleArtifactRegistryTagsTags)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleArtifactRegistryTags.DataGoogleArtifactRegistryTagsTagsList",
