...
type PubsubTopicIngestionDataSourceSettingsPlatformLogsSettings struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/pubsub_topic#severity PubsubTopic#severity}
