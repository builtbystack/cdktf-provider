...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleTagsTagValues.DataGoogleTagsTagValuesConfig",
		reflect.TypeOf((*DataGoogleTagsTagValuesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValues",
		reflect.TypeOf((*DataGoogleTagsTagValuesValues)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValuesList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleTagsTagValues.DataGoogleTagsTagValuesValuesOutputReference",
