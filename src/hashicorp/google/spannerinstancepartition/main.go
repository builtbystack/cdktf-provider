...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.spannerInstancePartition.SpannerInstancePartitionConfig",
		reflect.TypeOf((*SpannerInstancePartitionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.spannerInstancePartition.SpannerInstancePartitionTimeouts",
		reflect.TypeOf((*SpannerInstancePartitionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.spannerInstancePartition.SpannerInstancePartitionTimeoutsOutputReference",
