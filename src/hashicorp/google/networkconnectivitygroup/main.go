...
func init() {
	...
	_jsii_.RegisterClass(
		"google.networkConnectivityGroup.NetworkConnectivityGroupAutoAcceptOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.networkConnectivityGroup.NetworkConnectivityGroupConfig",
		reflect.TypeOf((*NetworkConnectivityGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkConnectivityGroup.NetworkConnectivityGroupTimeouts",
