...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreDatabaseIamMember.DataprocMetastoreDatabaseIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreDatabaseIamMember.DataprocMetastoreDatabaseIamMemberConfig",
