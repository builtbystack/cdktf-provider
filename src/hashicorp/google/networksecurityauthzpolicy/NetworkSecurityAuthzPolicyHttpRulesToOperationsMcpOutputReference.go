...
func (j *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference) ComplexObjectIndex() interface{} {
...
func (j *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference) MethodsInput() interface{} {
	var returns interface{}
	_jsii_.Get(
		j,
		"methodsInput",
...
func (j *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference)SetComplexObjectIndex(val interface{}) {
...
func (n *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference) GetAnyMapAttribute(terraformAttribute *string) *map[string]interface{} {
...
func (n *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference) PutMethods(value interface{}) {
...
func (n *jsiiProxy_NetworkSecurityAuthzPolicyHttpRulesToOperationsMcpOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
