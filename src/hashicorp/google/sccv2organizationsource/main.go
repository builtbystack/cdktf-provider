...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccV2OrganizationSource.SccV2OrganizationSourceConfig",
		reflect.TypeOf((*SccV2OrganizationSourceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccV2OrganizationSource.SccV2OrganizationSourceTimeouts",
		reflect.TypeOf((*SccV2OrganizationSourceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccV2OrganizationSource.SccV2OrganizationSourceTimeoutsOutputReference",
