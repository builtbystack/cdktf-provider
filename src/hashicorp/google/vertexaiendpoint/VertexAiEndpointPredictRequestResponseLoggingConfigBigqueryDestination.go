...
type VertexAiEndpointPredictRequestResponseLoggingConfigBigqueryDestination struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/vertex_ai_endpoint#output_uri VertexAiEndpoint#output_uri}
