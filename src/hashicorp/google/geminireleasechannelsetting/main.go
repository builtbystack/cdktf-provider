...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.geminiReleaseChannelSetting.GeminiReleaseChannelSettingConfig",
		reflect.TypeOf((*GeminiReleaseChannelSettingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.geminiReleaseChannelSetting.GeminiReleaseChannelSettingTimeouts",
		reflect.TypeOf((*GeminiReleaseChannelSettingTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.geminiReleaseChannelSetting.GeminiReleaseChannelSettingTimeoutsOutputReference",
