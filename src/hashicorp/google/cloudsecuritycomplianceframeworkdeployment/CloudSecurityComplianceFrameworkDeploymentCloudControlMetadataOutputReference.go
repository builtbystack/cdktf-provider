...
func (j *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference {
	_init_.Initialize()
...
func NewCloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference_Override(c CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceFrameworkDeploymentCloudControlMetadataOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
