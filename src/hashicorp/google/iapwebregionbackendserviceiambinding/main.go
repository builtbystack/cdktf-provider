...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iapWebRegionBackendServiceIamBinding.IapWebRegionBackendServiceIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google.iapWebRegionBackendServiceIamBinding.IapWebRegionBackendServiceIamBindingConfig",
