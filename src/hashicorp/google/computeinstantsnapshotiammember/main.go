...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshotIamMember.ComputeInstantSnapshotIamMemberCondition",
	...
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshotIamMember.ComputeInstantSnapshotIamMemberConfig",
