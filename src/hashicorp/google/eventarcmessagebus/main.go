...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.eventarcMessageBus.EventarcMessageBusConfig",
		reflect.TypeOf((*EventarcMessageBusConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.eventarcMessageBus.EventarcMessageBusLoggingConfig",
		reflect.TypeOf((*EventarcMessageBusLoggingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.eventarcMessageBus.EventarcMessageBusLoggingConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.eventarcMessageBus.EventarcMessageBusTimeouts",
		reflect.TypeOf((*EventarcMessageBusTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.eventarcMessageBus.EventarcMessageBusTimeoutsOutputReference",
