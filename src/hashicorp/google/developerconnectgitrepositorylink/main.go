...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.developerConnectGitRepositoryLink.DeveloperConnectGitRepositoryLinkConfig",
		reflect.TypeOf((*DeveloperConnectGitRepositoryLinkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.developerConnectGitRepositoryLink.DeveloperConnectGitRepositoryLinkTimeouts",
