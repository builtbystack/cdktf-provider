...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/networksecuritymirroringdeployment/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_mirroring_deployment google_network_security_mirroring_deployment}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_mirroring_deployment google_network_security_mirroring_deployment} Resource.
func NewNetworkSecurityMirroringDeployment(scope constructs.Construct, id *string, config *NetworkSecurityMirroringDeploymentConfig) NetworkSecurityMirroringDeployment {
	...
	_jsii_.Create(
		"google.networkSecurityMirroringDeployment.NetworkSecurityMirroringDeployment",
