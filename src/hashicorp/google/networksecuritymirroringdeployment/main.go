...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkSecurityMirroringDeployment.NetworkSecurityMirroringDeploymentConfig",
		reflect.TypeOf((*NetworkSecurityMirroringDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkSecurityMirroringDeployment.NetworkSecurityMirroringDeploymentTimeouts",
