...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.vertexAiFeatureGroupFeature.VertexAiFeatureGroupFeatureConfig",
		reflect.TypeOf((*VertexAiFeatureGroupFeatureConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.vertexAiFeatureGroupFeature.VertexAiFeatureGroupFeatureTimeouts",
		reflect.TypeOf((*VertexAiFeatureGroupFeatureTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.vertexAiFeatureGroupFeature.VertexAiFeatureGroupFeatureTimeoutsOutputReference",
