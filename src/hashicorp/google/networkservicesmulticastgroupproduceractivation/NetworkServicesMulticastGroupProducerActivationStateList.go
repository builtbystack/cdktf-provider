...
func (j *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) Fqn() *string {
	var returns *string
	_jsii_.Get(
		j,
		"fqn",
...
func (j *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) TerraformAttribute() *string {
	var returns *string
	_jsii_.Get(
		j,
		"terraformAttribute",
...
func (j *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) WrapsSet() *bool {
	var returns *bool
	_jsii_.Get(
		j,
		"wrapsSet",
...
func NewNetworkServicesMulticastGroupProducerActivationStateList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) NetworkServicesMulticastGroupProducerActivationStateList {
	...
	_jsii_.Create(
		"google.networkServicesMulticastGroupProducerActivation.NetworkServicesMulticastGroupProducerActivationStateList",
...
func (j *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList)SetTerraformAttribute(val *string) {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList)SetWrapsSet(val *bool) {
...
func (n *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) ComputeFqn() *string {
	var returns *string
...
func (n *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) Get(index *float64) NetworkServicesMulticastGroupProducerActivationStateOutputReference {
	if err := n.validateGetParameters(index); err != nil {
		panic(err)
	}
	var returns NetworkServicesMulticastGroupProducerActivationStateOutputReference
...
func (n *jsiiProxy_NetworkServicesMulticastGroupProducerActivationStateList) ToString() *string {
	var returns *string
