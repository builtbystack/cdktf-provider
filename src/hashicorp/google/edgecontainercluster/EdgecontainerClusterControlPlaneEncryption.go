...
type EdgecontainerClusterControlPlaneEncryption struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/edgecontainer_cluster#kms_key EdgecontainerCluster#kms_key}
