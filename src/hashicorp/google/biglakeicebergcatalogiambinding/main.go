...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergCatalogIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.biglakeIcebergCatalogIamBinding.BiglakeIcebergCatalogIamBindingCondition",
		reflect.TypeOf((*BiglakeIcebergCatalogIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.biglakeIcebergCatalogIamBinding.BiglakeIcebergCatalogIamBindingConditionOutputReference",
		reflect.TypeOf((*BiglakeIcebergCatalogIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*BiglakeIcebergCatalogIamBindingConfig)(nil)).Elem(),
	)
}
