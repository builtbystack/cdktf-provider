...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultConfig",
		reflect.TypeOf((*DataGoogleBackupDrBackupVaultConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrBackupVault.DataGoogleBackupDrBackupVaultEncryptionConfig",
