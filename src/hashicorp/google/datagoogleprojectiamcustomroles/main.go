...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesConfig",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRoles",
		reflect.TypeOf((*DataGoogleProjectIamCustomRolesRoles)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleProjectIamCustomRoles.DataGoogleProjectIamCustomRolesRolesOutputReference",
