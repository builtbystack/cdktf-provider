...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.beyondcorpSecurityGatewayApplicationIamMember.BeyondcorpSecurityGatewayApplicationIamMemberCondition",
		reflect.TypeOf((*BeyondcorpSecurityGatewayApplicationIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.beyondcorpSecurityGatewayApplicationIamMember.BeyondcorpSecurityGatewayApplicationIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.beyondcorpSecurityGatewayApplicationIamMember.BeyondcorpSecurityGatewayApplicationIamMemberConfig",
