...
type ApihubPluginConfigTemplateAuthConfigTemplate struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apihub_plugin#supported_auth_types ApihubPlugin#supported_auth_types}
	SupportedAuthTypes *[]*string `field:"required" json:"supportedAuthTypes" yaml:"supportedAuthTypes"`
	// service_account block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apihub_plugin#service_account ApihubPlugin#service_account}
