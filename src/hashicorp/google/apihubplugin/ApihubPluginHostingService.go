...
type ApihubPluginHostingService struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apihub_plugin#service_uri ApihubPlugin#service_uri}
