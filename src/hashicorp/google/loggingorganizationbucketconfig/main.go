...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingOrganizationBucketConfig.LoggingOrganizationBucketConfigIndexConfigs",
		reflect.TypeOf((*LoggingOrganizationBucketConfigIndexConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.loggingOrganizationBucketConfig.LoggingOrganizationBucketConfigIndexConfigsList",
	...
	_jsii_.RegisterClass(
		"google.loggingOrganizationBucketConfig.LoggingOrganizationBucketConfigIndexConfigsOutputReference",
