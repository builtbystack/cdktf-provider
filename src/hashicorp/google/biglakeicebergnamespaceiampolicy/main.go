...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergNamespaceIamPolicy)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.biglakeIcebergNamespaceIamPolicy.BiglakeIcebergNamespaceIamPolicyConfig",
		reflect.TypeOf((*BiglakeIcebergNamespaceIamPolicyConfig)(nil)).Elem(),
	)
}
