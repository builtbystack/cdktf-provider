...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/biglakeicebergnamespaceiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/biglake_iceberg_namespace_iam_policy google_biglake_iceberg_namespace_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/biglake_iceberg_namespace_iam_policy google_biglake_iceberg_namespace_iam_policy} Resource.
func NewBiglakeIcebergNamespaceIamPolicy(scope constructs.Construct, id *string, config *BiglakeIcebergNamespaceIamPolicyConfig) BiglakeIcebergNamespaceIamPolicy {
	...
	_jsii_.Create(
		"google.biglakeIcebergNamespaceIamPolicy.BiglakeIcebergNamespaceIamPolicy",
