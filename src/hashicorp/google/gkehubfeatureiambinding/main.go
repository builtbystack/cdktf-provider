...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.gkeHubFeatureIamBinding.GkeHubFeatureIamBindingCondition",
		reflect.TypeOf((*GkeHubFeatureIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.gkeHubFeatureIamBinding.GkeHubFeatureIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.gkeHubFeatureIamBinding.GkeHubFeatureIamBindingConfig",
