...
type FirestoreIndexFieldsVectorConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/firestore_index#dimension FirestoreIndex#dimension}
	Dimension *float64 `field:"optional" json:"dimension" yaml:"dimension"`
	// flat block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/firestore_index#flat FirestoreIndex#flat}
