...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firestoreIndex.FirestoreIndexFieldsVectorConfig",
		reflect.TypeOf((*FirestoreIndexFieldsVectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firestoreIndex.FirestoreIndexFieldsVectorConfigFlat",
		reflect.TypeOf((*FirestoreIndexFieldsVectorConfigFlat)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.firestoreIndex.FirestoreIndexFieldsVectorConfigFlatOutputReference",
	...
	_jsii_.RegisterClass(
		"google.firestoreIndex.FirestoreIndexFieldsVectorConfigOutputReference",
