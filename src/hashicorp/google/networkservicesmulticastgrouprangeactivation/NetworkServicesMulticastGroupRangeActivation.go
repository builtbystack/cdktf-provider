...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_services_multicast_group_range_activation google_network_services_multicast_group_range_activation}.
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_services_multicast_group_range_activation google_network_services_multicast_group_range_activation} Resource.
func NewNetworkServicesMulticastGroupRangeActivation(scope constructs.Construct, id *string, config *NetworkServicesMulticastGroupRangeActivationConfig) NetworkServicesMulticastGroupRangeActivation {
	...
	_jsii_.Create(
		"google.networkServicesMulticastGroupRangeActivation.NetworkServicesMulticastGroupRangeActivation",
...
// Generates CDKTF code for importing a NetworkServicesMulticastGroupRangeActivation resource upon running "cdktf plan <stack-name>".
func NetworkServicesMulticastGroupRangeActivation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (n *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (n *jsiiProxy_NetworkServicesMulticastGroupRangeActivation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
