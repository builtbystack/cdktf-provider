...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeVpnGateway.ComputeVpnGatewayParams",
		reflect.TypeOf((*ComputeVpnGatewayParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeVpnGateway.ComputeVpnGatewayParamsOutputReference",
		reflect.TypeOf((*ComputeVpnGatewayParamsOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
