...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicyConfig",
		reflect.TypeOf((*IamPrincipalAccessBoundaryPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicyDetails",
		reflect.TypeOf((*IamPrincipalAccessBoundaryPolicyDetails)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicyDetailsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicyTimeouts",
		reflect.TypeOf((*IamPrincipalAccessBoundaryPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicyTimeoutsOutputReference",
