...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/iamprincipalaccessboundarypolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iam_principal_access_boundary_policy google_iam_principal_access_boundary_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iam_principal_access_boundary_policy google_iam_principal_access_boundary_policy} Resource.
func NewIamPrincipalAccessBoundaryPolicy(scope constructs.Construct, id *string, config *IamPrincipalAccessBoundaryPolicyConfig) IamPrincipalAccessBoundaryPolicy {
	...
	_jsii_.Create(
		"google.iamPrincipalAccessBoundaryPolicy.IamPrincipalAccessBoundaryPolicy",
