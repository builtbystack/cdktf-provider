...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/apigeecontrolplaneaccess/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apigee_control_plane_access google_apigee_control_plane_access}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apigee_control_plane_access google_apigee_control_plane_access} Resource.
func NewApigeeControlPlaneAccess(scope constructs.Construct, id *string, config *ApigeeControlPlaneAccessConfig) ApigeeControlPlaneAccess {
	...
	_jsii_.Create(
		"google.apigeeControlPlaneAccess.ApigeeControlPlaneAccess",
