...
func (n *jsiiProxy_NetworkServicesLbEdgeExtensionExtensionChainsOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (n *jsiiProxy_NetworkServicesLbEdgeExtensionExtensionChainsOutputReference) validatePutExtensionsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*NetworkServicesLbEdgeExtensionExtensionChainsExtensions; received %#v (a %T)", value, value)
		}
	}
...
func (n *jsiiProxy_NetworkServicesLbEdgeExtensionExtensionChainsOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_NetworkServicesLbEdgeExtensionExtensionChainsOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewNetworkServicesLbEdgeExtensionExtensionChainsOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
