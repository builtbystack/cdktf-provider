...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.healthcareWorkspace.HealthcareWorkspaceConfig",
		reflect.TypeOf((*HealthcareWorkspaceConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.healthcareWorkspace.HealthcareWorkspaceSettings",
	...
	_jsii_.RegisterStruct(
		"google.healthcareWorkspace.HealthcareWorkspaceTimeouts",
		reflect.TypeOf((*HealthcareWorkspaceTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.healthcareWorkspace.HealthcareWorkspaceTimeoutsOutputReference",
