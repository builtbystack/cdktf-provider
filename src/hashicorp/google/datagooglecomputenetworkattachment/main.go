...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConfig",
		reflect.TypeOf((*DataGoogleComputeNetworkAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpoints",
		reflect.TypeOf((*DataGoogleComputeNetworkAttachmentConnectionEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpointsList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeNetworkAttachment.DataGoogleComputeNetworkAttachmentConnectionEndpointsOutputReference",
