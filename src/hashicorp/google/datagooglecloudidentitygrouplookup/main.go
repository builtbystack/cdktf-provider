...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookupConfig",
		reflect.TypeOf((*DataGoogleCloudIdentityGroupLookupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleCloudIdentityGroupLookup.DataGoogleCloudIdentityGroupLookupGroupKey",
