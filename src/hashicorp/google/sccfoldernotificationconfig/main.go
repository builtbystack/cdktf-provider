...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccFolderNotificationConfig.SccFolderNotificationConfigConfig",
		reflect.TypeOf((*SccFolderNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccFolderNotificationConfig.SccFolderNotificationConfigStreamingConfig",
		reflect.TypeOf((*SccFolderNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccFolderNotificationConfig.SccFolderNotificationConfigStreamingConfigOutputReference",
