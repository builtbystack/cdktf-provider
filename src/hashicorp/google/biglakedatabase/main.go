...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.biglakeDatabase.BiglakeDatabaseConfig",
		reflect.TypeOf((*BiglakeDatabaseConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.biglakeDatabase.BiglakeDatabaseHiveOptions",
		reflect.TypeOf((*BiglakeDatabaseHiveOptions)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.biglakeDatabase.BiglakeDatabaseHiveOptionsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.biglakeDatabase.BiglakeDatabaseTimeouts",
		reflect.TypeOf((*BiglakeDatabaseTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.biglakeDatabase.BiglakeDatabaseTimeoutsOutputReference",
