...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.bigtableSchemaBundle.BigtableSchemaBundleConfig",
		reflect.TypeOf((*BigtableSchemaBundleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.bigtableSchemaBundle.BigtableSchemaBundleProtoSchema",
		reflect.TypeOf((*BigtableSchemaBundleProtoSchema)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.bigtableSchemaBundle.BigtableSchemaBundleProtoSchemaOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.bigtableSchemaBundle.BigtableSchemaBundleTimeouts",
		reflect.TypeOf((*BigtableSchemaBundleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.bigtableSchemaBundle.BigtableSchemaBundleTimeoutsOutputReference",
