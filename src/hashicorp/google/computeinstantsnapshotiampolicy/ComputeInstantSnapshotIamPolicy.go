...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/computeinstantsnapshotiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_instant_snapshot_iam_policy google_compute_instant_snapshot_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_instant_snapshot_iam_policy google_compute_instant_snapshot_iam_policy} Resource.
func NewComputeInstantSnapshotIamPolicy(scope constructs.Construct, id *string, config *ComputeInstantSnapshotIamPolicyConfig) ComputeInstantSnapshotIamPolicy {
	...
	_jsii_.Create(
		"google.computeInstantSnapshotIamPolicy.ComputeInstantSnapshotIamPolicy",
