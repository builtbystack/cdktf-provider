...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeRegionNetworkEndpoint.ComputeRegionNetworkEndpointTimeouts",
		reflect.TypeOf((*ComputeRegionNetworkEndpointTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeRegionNetworkEndpoint.ComputeRegionNetworkEndpointTimeoutsOutputReference",
