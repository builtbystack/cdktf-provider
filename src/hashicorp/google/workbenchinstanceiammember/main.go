...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.workbenchInstanceIamMember.WorkbenchInstanceIamMemberCondition",
		reflect.TypeOf((*WorkbenchInstanceIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.workbenchInstanceIamMember.WorkbenchInstanceIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.workbenchInstanceIamMember.WorkbenchInstanceIamMemberConfig",
