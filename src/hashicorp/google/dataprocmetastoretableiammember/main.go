...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreTableIamMember.DataprocMetastoreTableIamMemberCondition",
		reflect.TypeOf((*DataprocMetastoreTableIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataprocMetastoreTableIamMember.DataprocMetastoreTableIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreTableIamMember.DataprocMetastoreTableIamMemberConfig",
