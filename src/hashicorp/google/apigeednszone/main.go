...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.apigeeDnsZone.ApigeeDnsZoneConfig",
		reflect.TypeOf((*ApigeeDnsZoneConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.apigeeDnsZone.ApigeeDnsZonePeeringConfig",
		reflect.TypeOf((*ApigeeDnsZonePeeringConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.apigeeDnsZone.ApigeeDnsZonePeeringConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.apigeeDnsZone.ApigeeDnsZoneTimeouts",
		reflect.TypeOf((*ApigeeDnsZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.apigeeDnsZone.ApigeeDnsZoneTimeoutsOutputReference",
