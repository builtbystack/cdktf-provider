...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/secure_source_manager_hook google_secure_source_manager_hook}.
...
func (j *jsiiProxy_SecureSourceManagerHook) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_SecureSourceManagerHook) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_SecureSourceManagerHook) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_SecureSourceManagerHook) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_SecureSourceManagerHook) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/secure_source_manager_hook google_secure_source_manager_hook} Resource.
...
// Generates CDKTF code for importing a SecureSourceManagerHook resource upon running "cdktf plan <stack-name>".
func SecureSourceManagerHook_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (s *jsiiProxy_SecureSourceManagerHook) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (s *jsiiProxy_SecureSourceManagerHook) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (s *jsiiProxy_SecureSourceManagerHook) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
