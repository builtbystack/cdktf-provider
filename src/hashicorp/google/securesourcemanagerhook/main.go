...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.secureSourceManagerHook.SecureSourceManagerHookConfig",
		reflect.TypeOf((*SecureSourceManagerHookConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.secureSourceManagerHook.SecureSourceManagerHookPushOption",
	...
	_jsii_.RegisterStruct(
		"google.secureSourceManagerHook.SecureSourceManagerHookTimeouts",
