...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsConfig",
		reflect.TypeOf((*DataGoogleKmsKeyRingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRings",
		reflect.TypeOf((*DataGoogleKmsKeyRingsKeyRings)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRingsList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleKmsKeyRings.DataGoogleKmsKeyRingsKeyRingsOutputReference",
