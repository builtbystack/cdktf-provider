...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.workbenchInstanceIamBinding.WorkbenchInstanceIamBindingCondition",
		reflect.TypeOf((*WorkbenchInstanceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.workbenchInstanceIamBinding.WorkbenchInstanceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.workbenchInstanceIamBinding.WorkbenchInstanceIamBindingConfig",
