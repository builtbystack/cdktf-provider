...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.integrationConnectorsManagedZone.IntegrationConnectorsManagedZoneTimeouts",
		reflect.TypeOf((*IntegrationConnectorsManagedZoneTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.integrationConnectorsManagedZone.IntegrationConnectorsManagedZoneTimeoutsOutputReference",
