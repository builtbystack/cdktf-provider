...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccounts",
		reflect.TypeOf((*DataGoogleServiceAccountsAccounts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleServiceAccounts.DataGoogleServiceAccountsAccountsList",
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleServiceAccounts.DataGoogleServiceAccountsConfig",
