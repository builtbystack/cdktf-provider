...
func (j *jsiiProxy_CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList {
	_init_.Initialize()
...
func NewCesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList_Override(c CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecsList) Resolve(_context cdktf.IResolveContext) interface{} {
