...
type CesToolDataStoreToolBoostSpecsSpecConditionBoostSpecs struct {
	...
	// (lang_code: ANY("en", "fr"))
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_tool#condition CesTool#condition}
	...
	// ignored.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_tool#boost CesTool#boost}
	Boost *float64 `field:"optional" json:"boost" yaml:"boost"`
	// boost_control_spec block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/ces_tool#boost_control_spec CesTool#boost_control_spec}
