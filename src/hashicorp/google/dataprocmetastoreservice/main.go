...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreService.DataprocMetastoreServiceHiveMetastoreConfigAuxiliaryVersions",
	...
	_jsii_.RegisterClass(
		"google.dataprocMetastoreService.DataprocMetastoreServiceMetadataIntegrationDataCatalogConfigOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreService.DataprocMetastoreServiceScheduledBackup",
