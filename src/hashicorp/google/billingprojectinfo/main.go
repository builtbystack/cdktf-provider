...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.billingProjectInfo.BillingProjectInfoConfig",
		reflect.TypeOf((*BillingProjectInfoConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.billingProjectInfo.BillingProjectInfoTimeouts",
		reflect.TypeOf((*BillingProjectInfoTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.billingProjectInfo.BillingProjectInfoTimeoutsOutputReference",
