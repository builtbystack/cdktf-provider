...
func (j *jsiiProxy_BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList {
	_init_.Initialize()
...
func NewBackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList_Override(b BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BackupDrRestoreWorkloadDiskRestorePropertiesGuestOsFeatureList) Resolve(_context cdktf.IResolveContext) interface{} {
