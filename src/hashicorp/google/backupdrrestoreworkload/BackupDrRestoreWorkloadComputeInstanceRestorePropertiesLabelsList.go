...
func (j *jsiiProxy_BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewBackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList {
	_init_.Initialize()
...
func NewBackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList_Override(b BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (b *jsiiProxy_BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (b *jsiiProxy_BackupDrRestoreWorkloadComputeInstanceRestorePropertiesLabelsList) Resolve(_context cdktf.IResolveContext) interface{} {
