...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.secretManagerRegionalSecretIamBinding.SecretManagerRegionalSecretIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google.secretManagerRegionalSecretIamBinding.SecretManagerRegionalSecretIamBindingConfig",
