...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingLogViewIamMember.LoggingLogViewIamMemberCondition",
		reflect.TypeOf((*LoggingLogViewIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.loggingLogViewIamMember.LoggingLogViewIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.loggingLogViewIamMember.LoggingLogViewIamMemberConfig",
