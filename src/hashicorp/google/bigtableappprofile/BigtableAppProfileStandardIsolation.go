...
type BigtableAppProfileStandardIsolation struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigtable_app_profile#priority BigtableAppProfile#priority}
