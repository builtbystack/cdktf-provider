...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleParameterManagerRegionalParameter.DataGoogleParameterManagerRegionalParameterConfig",
		reflect.TypeOf((*DataGoogleParameterManagerRegionalParameterConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleParameterManagerRegionalParameter.DataGoogleParameterManagerRegionalParameterPolicyMember",
		reflect.TypeOf((*DataGoogleParameterManagerRegionalParameterPolicyMember)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleParameterManagerRegionalParameter.DataGoogleParameterManagerRegionalParameterPolicyMemberList",
