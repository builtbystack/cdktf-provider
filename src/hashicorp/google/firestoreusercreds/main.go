...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firestoreUserCreds.FirestoreUserCredsConfig",
		reflect.TypeOf((*FirestoreUserCredsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firestoreUserCreds.FirestoreUserCredsResourceIdentity",
		reflect.TypeOf((*FirestoreUserCredsResourceIdentity)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.firestoreUserCreds.FirestoreUserCredsResourceIdentityList",
	...
	_jsii_.RegisterStruct(
		"google.firestoreUserCreds.FirestoreUserCredsTimeouts",
