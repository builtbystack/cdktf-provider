...
func (d *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsGoogleArtifactAnalysisOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (d *jsiiProxy_DeveloperConnectInsightsConfigArtifactConfigsGoogleArtifactAnalysisOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
