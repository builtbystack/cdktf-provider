...
type AlloydbInstanceClientConnectionConfigSslConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_instance#ssl_mode AlloydbInstance#ssl_mode}
