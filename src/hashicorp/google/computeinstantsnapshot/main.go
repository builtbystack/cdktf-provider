...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshot.ComputeInstantSnapshotConfig",
		reflect.TypeOf((*ComputeInstantSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshot.ComputeInstantSnapshotTimeouts",
		reflect.TypeOf((*ComputeInstantSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeInstantSnapshot.ComputeInstantSnapshotTimeoutsOutputReference",
