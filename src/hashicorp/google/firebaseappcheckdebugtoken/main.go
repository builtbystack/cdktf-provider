...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckDebugToken.FirebaseAppCheckDebugTokenConfig",
		reflect.TypeOf((*FirebaseAppCheckDebugTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckDebugToken.FirebaseAppCheckDebugTokenTimeouts",
		reflect.TypeOf((*FirebaseAppCheckDebugTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.firebaseAppCheckDebugToken.FirebaseAppCheckDebugTokenTimeoutsOutputReference",
