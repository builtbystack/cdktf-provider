...
type LookerInstanceControlledEgressConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/looker_instance#egress_fqdns LookerInstance#egress_fqdns}
	EgressFqdns *[]*string `field:"optional" json:"egressFqdns" yaml:"egressFqdns"`
	// Whether the Looker Marketplace is enabled.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/looker_instance#marketplace_enabled LookerInstance#marketplace_enabled}
