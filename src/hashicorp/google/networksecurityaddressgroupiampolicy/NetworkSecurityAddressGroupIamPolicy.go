...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/networksecurityaddressgroupiampolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_address_group_iam_policy google_network_security_address_group_iam_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_address_group_iam_policy google_network_security_address_group_iam_policy} Resource.
func NewNetworkSecurityAddressGroupIamPolicy(scope constructs.Construct, id *string, config *NetworkSecurityAddressGroupIamPolicyConfig) NetworkSecurityAddressGroupIamPolicy {
	...
	_jsii_.Create(
		"google.networkSecurityAddressGroupIamPolicy.NetworkSecurityAddressGroupIamPolicy",
