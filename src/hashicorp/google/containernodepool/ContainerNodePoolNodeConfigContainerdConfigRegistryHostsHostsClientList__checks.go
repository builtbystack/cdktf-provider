...
func (c *jsiiProxy_ContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsClientList) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_ContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsClientList) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewContainerNodePoolNodeConfigContainerdConfigRegistryHostsHostsClientListParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) error {
