...
func (j *jsiiProxy_ContainerNodePoolNodeDrainConfigOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewContainerNodePoolNodeDrainConfigOutputReference_Override(c ContainerNodePoolNodeDrainConfigOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (c *jsiiProxy_ContainerNodePoolNodeDrainConfigOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ContainerNodePoolNodeDrainConfigOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_ContainerNodePoolNodeDrainConfigOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
