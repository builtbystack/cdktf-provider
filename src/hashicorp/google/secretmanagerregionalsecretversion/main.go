...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionCustomerManagedEncryption",
		reflect.TypeOf((*SecretManagerRegionalSecretVersionCustomerManagedEncryption)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionCustomerManagedEncryptionList",
	...
	_jsii_.RegisterStruct(
		"google.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionTimeouts",
		reflect.TypeOf((*SecretManagerRegionalSecretVersionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionTimeoutsOutputReference",
