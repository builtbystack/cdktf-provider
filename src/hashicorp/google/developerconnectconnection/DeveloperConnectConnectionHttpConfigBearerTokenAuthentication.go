...
type DeveloperConnectConnectionHttpConfigBearerTokenAuthentication struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/developer_connect_connection#token_secret_version DeveloperConnectConnection#token_secret_version}
