...
type ManagedKafkaAclAclEntries struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_acl#operation ManagedKafkaAcl#operation}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_acl#principal ManagedKafkaAcl#principal}
	Principal *string `field:"required" json:"principal" yaml:"principal"`
	// The host. Must be set to "*" for Managed Service for Apache Kafka.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_acl#host ManagedKafkaAcl#host}
	Host *string `field:"optional" json:"host" yaml:"host"`
	// The permission type. Accepted values are (case insensitive): ALLOW, DENY.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_acl#permission_type ManagedKafkaAcl#permission_type}
