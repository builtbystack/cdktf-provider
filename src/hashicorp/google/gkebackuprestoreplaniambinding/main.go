...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.gkeBackupRestorePlanIamBinding.GkeBackupRestorePlanIamBindingCondition",
		reflect.TypeOf((*GkeBackupRestorePlanIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.gkeBackupRestorePlanIamBinding.GkeBackupRestorePlanIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.gkeBackupRestorePlanIamBinding.GkeBackupRestorePlanIamBindingConfig",
