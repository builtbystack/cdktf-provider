...
type DnsManagedZonePeeringConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dns_managed_zone#target_network DnsManagedZone#target_network}
