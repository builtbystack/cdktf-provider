...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.migrationCenterGroup.MigrationCenterGroupConfig",
		reflect.TypeOf((*MigrationCenterGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.migrationCenterGroup.MigrationCenterGroupTimeouts",
		reflect.TypeOf((*MigrationCenterGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.migrationCenterGroup.MigrationCenterGroupTimeoutsOutputReference",
