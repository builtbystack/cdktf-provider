...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/networksecuritytlsinspectionpolicy/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_tls_inspection_policy google_network_security_tls_inspection_policy}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_security_tls_inspection_policy google_network_security_tls_inspection_policy} Resource.
func NewNetworkSecurityTlsInspectionPolicy(scope constructs.Construct, id *string, config *NetworkSecurityTlsInspectionPolicyConfig) NetworkSecurityTlsInspectionPolicy {
	...
	_jsii_.Create(
		"google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicy",
