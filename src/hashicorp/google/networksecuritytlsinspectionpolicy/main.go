...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicyConfig",
		reflect.TypeOf((*NetworkSecurityTlsInspectionPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkSecurityTlsInspectionPolicy.NetworkSecurityTlsInspectionPolicyTimeouts",
