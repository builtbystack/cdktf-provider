...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.discoveryEngineSchema.DiscoveryEngineSchemaConfig",
		reflect.TypeOf((*DiscoveryEngineSchemaConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.discoveryEngineSchema.DiscoveryEngineSchemaTimeouts",
		reflect.TypeOf((*DiscoveryEngineSchemaTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.discoveryEngineSchema.DiscoveryEngineSchemaTimeoutsOutputReference",
