...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccV2OrganizationSccBigQueryExports.SccV2OrganizationSccBigQueryExportsConfig",
		reflect.TypeOf((*SccV2OrganizationSccBigQueryExportsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccV2OrganizationSccBigQueryExports.SccV2OrganizationSccBigQueryExportsTimeouts",
		reflect.TypeOf((*SccV2OrganizationSccBigQueryExportsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccV2OrganizationSccBigQueryExports.SccV2OrganizationSccBigQueryExportsTimeoutsOutputReference",
