...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/iamworkforcepoolproviderscimtenant/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iam_workforce_pool_provider_scim_tenant google_iam_workforce_pool_provider_scim_tenant}.
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IamWorkforcePoolProviderScimTenant) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iam_workforce_pool_provider_scim_tenant google_iam_workforce_pool_provider_scim_tenant} Resource.
func NewIamWorkforcePoolProviderScimTenant(scope constructs.Construct, id *string, config *IamWorkforcePoolProviderScimTenantConfig) IamWorkforcePoolProviderScimTenant {
	...
	_jsii_.Create(
		"google.iamWorkforcePoolProviderScimTenant.IamWorkforcePoolProviderScimTenant",
...
// Generates CDKTF code for importing a IamWorkforcePoolProviderScimTenant resource upon running "cdktf plan <stack-name>".
func IamWorkforcePoolProviderScimTenant_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IamWorkforcePoolProviderScimTenant) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
