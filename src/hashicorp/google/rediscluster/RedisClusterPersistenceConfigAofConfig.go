...
type RedisClusterPersistenceConfigAofConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/redis_cluster#append_fsync RedisCluster#append_fsync}
