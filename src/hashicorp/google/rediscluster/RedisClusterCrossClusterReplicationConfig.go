...
type RedisClusterCrossClusterReplicationConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/redis_cluster#cluster_role RedisCluster#cluster_role}
	ClusterRole *string `field:"optional" json:"clusterRole" yaml:"clusterRole"`
	// primary_cluster block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/redis_cluster#primary_cluster RedisCluster#primary_cluster}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/redis_cluster#secondary_clusters RedisCluster#secondary_clusters}
