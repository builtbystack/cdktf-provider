...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceSettings.ComputeInstanceSettingsConfig",
		reflect.TypeOf((*ComputeInstanceSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computeInstanceSettings.ComputeInstanceSettingsMetadata",
		reflect.TypeOf((*ComputeInstanceSettingsMetadata)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeInstanceSettings.ComputeInstanceSettingsMetadataOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceSettings.ComputeInstanceSettingsTimeouts",
