...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*BiglakeIcebergNamespaceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.biglakeIcebergNamespaceIamBinding.BiglakeIcebergNamespaceIamBindingCondition",
		reflect.TypeOf((*BiglakeIcebergNamespaceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.biglakeIcebergNamespaceIamBinding.BiglakeIcebergNamespaceIamBindingConditionOutputReference",
		reflect.TypeOf((*BiglakeIcebergNamespaceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.biglakeIcebergNamespaceIamBinding.BiglakeIcebergNamespaceIamBindingConfig",
		reflect.TypeOf((*BiglakeIcebergNamespaceIamBindingConfig)(nil)).Elem(),
	)
}
