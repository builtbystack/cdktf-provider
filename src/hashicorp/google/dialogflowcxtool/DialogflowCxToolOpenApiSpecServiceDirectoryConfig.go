...
type DialogflowCxToolOpenApiSpecServiceDirectoryConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dialogflow_cx_tool#service DialogflowCxTool#service}
