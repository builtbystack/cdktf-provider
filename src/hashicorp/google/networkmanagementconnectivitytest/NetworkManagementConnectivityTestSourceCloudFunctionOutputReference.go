...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/networkmanagementconnectivitytest/internal"
...
func NewNetworkManagementConnectivityTestSourceCloudFunctionOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string) NetworkManagementConnectivityTestSourceCloudFunctionOutputReference {
	...
	_jsii_.Create(
		"google.networkManagementConnectivityTest.NetworkManagementConnectivityTestSourceCloudFunctionOutputReference",
...
func (n *jsiiProxy_NetworkManagementConnectivityTestSourceCloudFunctionOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (n *jsiiProxy_NetworkManagementConnectivityTestSourceCloudFunctionOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
