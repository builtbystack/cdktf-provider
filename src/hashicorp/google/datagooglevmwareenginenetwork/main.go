...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkConfig",
		reflect.TypeOf((*DataGoogleVmwareengineNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworks",
		reflect.TypeOf((*DataGoogleVmwareengineNetworkVpcNetworks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworksList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleVmwareengineNetwork.DataGoogleVmwareengineNetworkVpcNetworksOutputReference",
