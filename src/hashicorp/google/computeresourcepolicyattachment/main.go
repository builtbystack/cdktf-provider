...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeResourcePolicyAttachment.ComputeResourcePolicyAttachmentConfig",
		reflect.TypeOf((*ComputeResourcePolicyAttachmentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computeResourcePolicyAttachment.ComputeResourcePolicyAttachmentTimeouts",
		reflect.TypeOf((*ComputeResourcePolicyAttachmentTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeResourcePolicyAttachment.ComputeResourcePolicyAttachmentTimeoutsOutputReference",
