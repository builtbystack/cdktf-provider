...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apigee_developer_app google_apigee_developer_app}.
...
func (j *jsiiProxy_ApigeeDeveloperApp) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ApigeeDeveloperApp) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ApigeeDeveloperApp) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ApigeeDeveloperApp) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ApigeeDeveloperApp) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apigee_developer_app google_apigee_developer_app} Resource.
...
// Generates CDKTF code for importing a ApigeeDeveloperApp resource upon running "cdktf plan <stack-name>".
func ApigeeDeveloperApp_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (a *jsiiProxy_ApigeeDeveloperApp) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (a *jsiiProxy_ApigeeDeveloperApp) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (a *jsiiProxy_ApigeeDeveloperApp) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
