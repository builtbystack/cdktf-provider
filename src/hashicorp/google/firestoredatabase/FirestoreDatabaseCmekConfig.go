...
type FirestoreDatabaseCmekConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/firestore_database#kms_key_name FirestoreDatabase#kms_key_name}
