...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.edgenetworkNetwork.EdgenetworkNetworkConfig",
		reflect.TypeOf((*EdgenetworkNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.edgenetworkNetwork.EdgenetworkNetworkTimeouts",
		reflect.TypeOf((*EdgenetworkNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.edgenetworkNetwork.EdgenetworkNetworkTimeoutsOutputReference",
