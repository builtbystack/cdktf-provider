...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.pubsubSchemaIamMember.PubsubSchemaIamMemberCondition",
		reflect.TypeOf((*PubsubSchemaIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.pubsubSchemaIamMember.PubsubSchemaIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.pubsubSchemaIamMember.PubsubSchemaIamMemberConfig",
