...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.bigqueryRowAccessPolicy.BigqueryRowAccessPolicyConfig",
		reflect.TypeOf((*BigqueryRowAccessPolicyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.bigqueryRowAccessPolicy.BigqueryRowAccessPolicyTimeouts",
		reflect.TypeOf((*BigqueryRowAccessPolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.bigqueryRowAccessPolicy.BigqueryRowAccessPolicyTimeoutsOutputReference",
