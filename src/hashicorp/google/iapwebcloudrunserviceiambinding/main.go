...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iapWebCloudRunServiceIamBinding.IapWebCloudRunServiceIamBindingCondition",
		reflect.TypeOf((*IapWebCloudRunServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iapWebCloudRunServiceIamBinding.IapWebCloudRunServiceIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.iapWebCloudRunServiceIamBinding.IapWebCloudRunServiceIamBindingConfig",
