...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_instance_template google_compute_region_instance_template}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_region_instance_template google_compute_region_instance_template} Resource.
func NewComputeRegionInstanceTemplate(scope constructs.Construct, id *string, config *ComputeRegionInstanceTemplateConfig) ComputeRegionInstanceTemplate {
	...
	_jsii_.Create(
		"google.computeRegionInstanceTemplate.ComputeRegionInstanceTemplate",
