...
type ArtifactRegistryRepositoryRemoteRepositoryConfigCommonRepository struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/artifact_registry_repository#uri ArtifactRegistryRepository#uri}
