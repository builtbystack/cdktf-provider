...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/networkconnectivityregionalendpoint/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_connectivity_regional_endpoint google_network_connectivity_regional_endpoint}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/network_connectivity_regional_endpoint google_network_connectivity_regional_endpoint} Resource.
func NewNetworkConnectivityRegionalEndpoint(scope constructs.Construct, id *string, config *NetworkConnectivityRegionalEndpointConfig) NetworkConnectivityRegionalEndpoint {
	...
	_jsii_.Create(
		"google.networkConnectivityRegionalEndpoint.NetworkConnectivityRegionalEndpoint",
