...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.pubsubSchemaIamBinding.PubsubSchemaIamBindingCondition",
		reflect.TypeOf((*PubsubSchemaIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.pubsubSchemaIamBinding.PubsubSchemaIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.pubsubSchemaIamBinding.PubsubSchemaIamBindingConfig",
