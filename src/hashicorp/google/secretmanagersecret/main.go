...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.secretManagerSecret.SecretManagerSecretReplicationAuto",
		reflect.TypeOf((*SecretManagerSecretReplicationAuto)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.secretManagerSecret.SecretManagerSecretReplicationAutoCustomerManagedEncryption",
	...
	_jsii_.RegisterClass(
		"google.secretManagerSecret.SecretManagerSecretReplicationAutoOutputReference",
