...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingState",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleGkeHubMembershipBinding.DataGoogleGkeHubMembershipBindingStateOutputReference",
