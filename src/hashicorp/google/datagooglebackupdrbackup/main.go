...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackups",
		reflect.TypeOf((*DataGoogleBackupDrBackupBackups)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupBackupsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrBackup.DataGoogleBackupDrBackupConfig",
