...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckRecaptchaV3Config.FirebaseAppCheckRecaptchaV3ConfigConfig",
		reflect.TypeOf((*FirebaseAppCheckRecaptchaV3ConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckRecaptchaV3Config.FirebaseAppCheckRecaptchaV3ConfigTimeouts",
		reflect.TypeOf((*FirebaseAppCheckRecaptchaV3ConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.firebaseAppCheckRecaptchaV3Config.FirebaseAppCheckRecaptchaV3ConfigTimeoutsOutputReference",
