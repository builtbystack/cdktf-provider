...
func NewComputeBackendServiceTlsSettingsSubjectAltNamesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) ComputeBackendServiceTlsSettingsSubjectAltNamesOutputReference {
	...
	_jsii_.Create(
		"google.computeBackendService.ComputeBackendServiceTlsSettingsSubjectAltNamesOutputReference",
...
func (c *jsiiProxy_ComputeBackendServiceTlsSettingsSubjectAltNamesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeBackendServiceTlsSettingsSubjectAltNamesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
