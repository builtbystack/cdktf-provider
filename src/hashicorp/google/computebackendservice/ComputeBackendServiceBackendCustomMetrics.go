...
type ComputeBackendServiceBackendCustomMetrics struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_backend_service#dry_run ComputeBackendService#dry_run}
