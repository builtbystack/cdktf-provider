...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.gkeBackupRestoreChannel.GkeBackupRestoreChannelConfig",
		reflect.TypeOf((*GkeBackupRestoreChannelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.gkeBackupRestoreChannel.GkeBackupRestoreChannelTimeouts",
		reflect.TypeOf((*GkeBackupRestoreChannelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.gkeBackupRestoreChannel.GkeBackupRestoreChannelTimeoutsOutputReference",
