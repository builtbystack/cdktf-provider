...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeImages.DataGoogleComputeImagesConfig",
		reflect.TypeOf((*DataGoogleComputeImagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeImages.DataGoogleComputeImagesImages",
		reflect.TypeOf((*DataGoogleComputeImagesImages)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleComputeImages.DataGoogleComputeImagesImagesList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeImages.DataGoogleComputeImagesImagesOutputReference",
