...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeStoragePoolIamBinding.ComputeStoragePoolIamBindingCondition",
		reflect.TypeOf((*ComputeStoragePoolIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeStoragePoolIamBinding.ComputeStoragePoolIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.computeStoragePoolIamBinding.ComputeStoragePoolIamBindingConfig",
