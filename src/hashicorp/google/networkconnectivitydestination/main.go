...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkConnectivityDestination.NetworkConnectivityDestinationConfig",
		reflect.TypeOf((*NetworkConnectivityDestinationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkConnectivityDestination.NetworkConnectivityDestinationEndpoints",
		reflect.TypeOf((*NetworkConnectivityDestinationEndpoints)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.networkConnectivityDestination.NetworkConnectivityDestinationEndpointsList",
