...
type DatastreamStreamBackfillAllOracleExcludedObjectsOracleSchemas struct {
	...
	// oracle_tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/datastream_stream#oracle_tables DatastreamStream#oracle_tables}
