...
type DatastreamStreamBackfillAllMysqlExcludedObjectsMysqlDatabases struct {
	...
	// mysql_tables block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/datastream_stream#mysql_tables DatastreamStream#mysql_tables}
