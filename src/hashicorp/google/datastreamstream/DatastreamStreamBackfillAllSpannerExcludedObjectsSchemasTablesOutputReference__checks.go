...
func (d *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReference) validateInterpolationForAttributeParameters(property *string) error {
	if property == nil {
...
func (d *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReference) validatePutColumnsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesColumns; received %#v (a %T)", value, value)
		}
	}
...
func (d *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReference) validateResolveParameters(_context cdktf.IResolveContext) error {
	if _context == nil {
...
func (j *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReference) validateSetInternalValueParameters(val interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(val) {
			return fmt.Errorf("parameter val must be one of the allowed types: cdktf.IResolvable, *DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTables; received %#v (a %T)", val, val)
		}
	}
...
func (j *jsiiProxy_DatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReference) validateSetTerraformResourceParameters(val cdktf.IInterpolatingParent) error {
	if val == nil {
		return fmt.Errorf("parameter val is required, but nil was provided")
	}
...
func validateNewDatastreamStreamBackfillAllSpannerExcludedObjectsSchemasTablesOutputReferenceParameters(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) error {
