...
func init() {
	_jsii_.RegisterClass(
		"google.sqlProvisionScript.SqlProvisionScript",
		reflect.TypeOf((*SqlProvisionScript)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.sqlProvisionScript.SqlProvisionScriptConfig",
		reflect.TypeOf((*SqlProvisionScriptConfig)(nil)).Elem(),
	)
}
