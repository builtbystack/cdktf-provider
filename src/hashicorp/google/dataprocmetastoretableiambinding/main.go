...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreTableIamBinding.DataprocMetastoreTableIamBindingCondition",
		reflect.TypeOf((*DataprocMetastoreTableIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataprocMetastoreTableIamBinding.DataprocMetastoreTableIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreTableIamBinding.DataprocMetastoreTableIamBindingConfig",
