...
func (j *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCloudSecurityComplianceCloudControlRulesOutputReference(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CloudSecurityComplianceCloudControlRulesOutputReference {
	_init_.Initialize()
...
func NewCloudSecurityComplianceCloudControlRulesOutputReference_Override(c CloudSecurityComplianceCloudControlRulesOutputReference, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference) InterpolationAsList() cdktf.IResolvable {
	var returns cdktf.IResolvable
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (c *jsiiProxy_CloudSecurityComplianceCloudControlRulesOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
