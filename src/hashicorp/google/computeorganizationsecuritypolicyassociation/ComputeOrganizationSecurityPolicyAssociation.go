...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_organization_security_policy_association google_compute_organization_security_policy_association}.
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_organization_security_policy_association google_compute_organization_security_policy_association} Resource.
func NewComputeOrganizationSecurityPolicyAssociation(scope constructs.Construct, id *string, config *ComputeOrganizationSecurityPolicyAssociationConfig) ComputeOrganizationSecurityPolicyAssociation {
	...
	_jsii_.Create(
		"google.computeOrganizationSecurityPolicyAssociation.ComputeOrganizationSecurityPolicyAssociation",
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a ComputeOrganizationSecurityPolicyAssociation resource upon running "cdktf plan <stack-name>".
func ComputeOrganizationSecurityPolicyAssociation_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (c *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (c *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (c *jsiiProxy_ComputeOrganizationSecurityPolicyAssociation) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
