...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccV2FolderNotificationConfig.SccV2FolderNotificationConfigConfig",
		reflect.TypeOf((*SccV2FolderNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccV2FolderNotificationConfig.SccV2FolderNotificationConfigStreamingConfig",
