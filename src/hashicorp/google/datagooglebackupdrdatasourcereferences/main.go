...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrDataSourceReferences.DataGoogleBackupDrDataSourceReferencesConfig",
		reflect.TypeOf((*DataGoogleBackupDrDataSourceReferencesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleBackupDrDataSourceReferences.DataGoogleBackupDrDataSourceReferencesDataSourceReferences",
