...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataplexAspectTypeIamBinding.DataplexAspectTypeIamBindingCondition",
		reflect.TypeOf((*DataplexAspectTypeIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataplexAspectTypeIamBinding.DataplexAspectTypeIamBindingConditionOutputReference",
