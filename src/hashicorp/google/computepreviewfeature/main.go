...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computePreviewFeature.ComputePreviewFeatureConfig",
		reflect.TypeOf((*ComputePreviewFeatureConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computePreviewFeature.ComputePreviewFeatureRolloutOperation",
	...
	_jsii_.RegisterStruct(
		"google.computePreviewFeature.ComputePreviewFeatureRolloutOperationRolloutInput",
	...
	_jsii_.RegisterStruct(
		"google.computePreviewFeature.ComputePreviewFeatureTimeouts",
