...
func init() {
	...
	_jsii_.RegisterClass(
		"google.dataprocMetastoreFederation.DataprocMetastoreFederationBackendMetastoresOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreFederation.DataprocMetastoreFederationConfig",
		reflect.TypeOf((*DataprocMetastoreFederationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataprocMetastoreFederation.DataprocMetastoreFederationTimeouts",
		reflect.TypeOf((*DataprocMetastoreFederationTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataprocMetastoreFederation.DataprocMetastoreFederationTimeoutsOutputReference",
