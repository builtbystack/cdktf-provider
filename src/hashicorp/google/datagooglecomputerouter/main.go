...
func init() {
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeRouter.DataGoogleComputeRouterMd5AuthenticationKeysList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeRouter.DataGoogleComputeRouterMd5AuthenticationKeysOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeRouter.DataGoogleComputeRouterParams",
		reflect.TypeOf((*DataGoogleComputeRouterParams)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleComputeRouter.DataGoogleComputeRouterParamsList",
