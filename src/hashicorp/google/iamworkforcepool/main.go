...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iamWorkforcePool.IamWorkforcePoolAccessRestrictions",
		reflect.TypeOf((*IamWorkforcePoolAccessRestrictions)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.iamWorkforcePool.IamWorkforcePoolAccessRestrictionsAllowedServices",
		reflect.TypeOf((*IamWorkforcePoolAccessRestrictionsAllowedServices)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iamWorkforcePool.IamWorkforcePoolAccessRestrictionsAllowedServicesList",
	...
	_jsii_.RegisterClass(
		"google.iamWorkforcePool.IamWorkforcePoolAccessRestrictionsAllowedServicesOutputReference",
	...
	_jsii_.RegisterClass(
		"google.iamWorkforcePool.IamWorkforcePoolAccessRestrictionsOutputReference",
