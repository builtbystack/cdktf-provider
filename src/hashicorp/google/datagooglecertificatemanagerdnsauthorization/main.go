...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorizationConfig",
		reflect.TypeOf((*DataGoogleCertificateManagerDnsAuthorizationConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleCertificateManagerDnsAuthorization.DataGoogleCertificateManagerDnsAuthorizationDnsResourceRecord",
