...
type ContainerClusterEnterpriseConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_cluster#desired_tier ContainerCluster#desired_tier}
