...
type ContainerClusterSecretManagerConfigRotationConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_cluster#rotation_interval ContainerCluster#rotation_interval}
