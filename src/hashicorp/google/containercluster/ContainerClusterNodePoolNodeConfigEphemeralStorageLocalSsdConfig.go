...
type ContainerClusterNodePoolNodeConfigEphemeralStorageLocalSsdConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_cluster#data_cache_count ContainerCluster#data_cache_count}
