...
type ContainerClusterNotificationConfigPubsubFilter struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_cluster#event_type ContainerCluster#event_type}
