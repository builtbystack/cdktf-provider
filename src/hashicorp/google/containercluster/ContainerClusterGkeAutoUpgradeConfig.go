...
type ContainerClusterGkeAutoUpgradeConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_cluster#patch_mode ContainerCluster#patch_mode}
