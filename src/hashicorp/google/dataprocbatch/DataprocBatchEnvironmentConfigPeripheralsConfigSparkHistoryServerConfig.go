...
type DataprocBatchEnvironmentConfigPeripheralsConfigSparkHistoryServerConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dataproc_batch#dataproc_cluster DataprocBatch#dataproc_cluster}
