...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceGroupMembership.ComputeInstanceGroupMembershipConfig",
		reflect.TypeOf((*ComputeInstanceGroupMembershipConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.computeInstanceGroupMembership.ComputeInstanceGroupMembershipTimeouts",
