...
func init() {
	_jsii_.RegisterClass(
		...
		reflect.TypeOf((*IapWebForwardingRuleServiceIamBinding)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		"google.iapWebForwardingRuleServiceIamBinding.IapWebForwardingRuleServiceIamBindingCondition",
		reflect.TypeOf((*IapWebForwardingRuleServiceIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iapWebForwardingRuleServiceIamBinding.IapWebForwardingRuleServiceIamBindingConditionOutputReference",
		reflect.TypeOf((*IapWebForwardingRuleServiceIamBindingConditionOutputReference)(nil)).Elem(),
		[]_jsii_.Member{
	...
	_jsii_.RegisterStruct(
		...
		reflect.TypeOf((*IapWebForwardingRuleServiceIamBindingConfig)(nil)).Elem(),
	)
}
