...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iap_web_forwarding_rule_service_iam_binding google_iap_web_forwarding_rule_service_iam_binding}.
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iap_web_forwarding_rule_service_iam_binding google_iap_web_forwarding_rule_service_iam_binding} Resource.
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding)SetForEach(val cdktf.ITerraformIterator) {
	_jsii_.Set(
		j,
		"forEach",
		val,
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding)SetLifecycle(val *cdktf.TerraformResourceLifecycle) {
...
func (j *jsiiProxy_IapWebForwardingRuleServiceIamBinding)SetProvider(val cdktf.TerraformProvider) {
	_jsii_.Set(
		j,
		"provider",
		val,
...
// Generates CDKTF code for importing a IapWebForwardingRuleServiceIamBinding resource upon running "cdktf plan <stack-name>".
func IapWebForwardingRuleServiceIamBinding_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (i *jsiiProxy_IapWebForwardingRuleServiceIamBinding) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (i *jsiiProxy_IapWebForwardingRuleServiceIamBinding) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (i *jsiiProxy_IapWebForwardingRuleServiceIamBinding) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
