...
type BigqueryDatasetExternalDatasetReference struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_dataset#connection BigqueryDataset#connection}
	Connection *string `field:"required" json:"connection" yaml:"connection"`
	// External source that backs this dataset.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_dataset#external_source BigqueryDataset#external_source}
