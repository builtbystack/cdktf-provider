...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.bigtableLogicalView.BigtableLogicalViewConfig",
		reflect.TypeOf((*BigtableLogicalViewConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.bigtableLogicalView.BigtableLogicalViewTimeouts",
		reflect.TypeOf((*BigtableLogicalViewTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.bigtableLogicalView.BigtableLogicalViewTimeoutsOutputReference",
