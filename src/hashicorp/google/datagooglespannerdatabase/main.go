...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseConfig",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleSpannerDatabase.DataGoogleSpannerDatabaseEncryptionConfigOutputReference",
