...
type BigqueryTableBiglakeConfiguration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_table#file_format BigqueryTable#file_format}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_table#storage_uri BigqueryTable#storage_uri}
	StorageUri *string `field:"required" json:"storageUri" yaml:"storageUri"`
	// The table format the metadata only snapshots are stored in.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_table#table_format BigqueryTable#table_format}
