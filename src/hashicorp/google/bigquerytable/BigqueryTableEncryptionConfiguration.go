...
type BigqueryTableEncryptionConfiguration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_table#kms_key_name BigqueryTable#kms_key_name}
