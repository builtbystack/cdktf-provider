...
type BigqueryTableExternalCatalogTableOptionsStorageDescriptorSerdeInfo struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_table#serialization_library BigqueryTable#serialization_library}
