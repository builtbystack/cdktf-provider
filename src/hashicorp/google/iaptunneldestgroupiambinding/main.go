...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingCondition",
		reflect.TypeOf((*IapTunnelDestGroupIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.iapTunnelDestGroupIamBinding.IapTunnelDestGroupIamBindingConfig",
