...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectRetention",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleStorageBucketObject.DataGoogleStorageBucketObjectRetentionOutputReference",
