...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dialogflowEncryptionSpec.DialogflowEncryptionSpecConfig",
		reflect.TypeOf((*DialogflowEncryptionSpecConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dialogflowEncryptionSpec.DialogflowEncryptionSpecEncryptionSpec",
	...
	_jsii_.RegisterClass(
		"google.dialogflowEncryptionSpec.DialogflowEncryptionSpecTimeoutsOutputReference",
