...
func (r *jsiiProxy_RedisClusterUserCreatedConnectionsClusterEndpointsConnectionsOutputReference) InterpolationForAttribute(property *string) cdktf.IResolvable {
...
func (r *jsiiProxy_RedisClusterUserCreatedConnectionsClusterEndpointsConnectionsOutputReference) Resolve(_context cdktf.IResolveContext) interface{} {
