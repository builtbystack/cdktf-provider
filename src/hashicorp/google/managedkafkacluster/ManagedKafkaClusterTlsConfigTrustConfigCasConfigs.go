...
type ManagedKafkaClusterTlsConfigTrustConfigCasConfigs struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_cluster#ca_pool ManagedKafkaCluster#ca_pool}
