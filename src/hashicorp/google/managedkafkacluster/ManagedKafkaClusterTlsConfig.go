...
type ManagedKafkaClusterTlsConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_cluster#ssl_principal_mapping_rules ManagedKafkaCluster#ssl_principal_mapping_rules}
	SslPrincipalMappingRules *string `field:"optional" json:"sslPrincipalMappingRules" yaml:"sslPrincipalMappingRules"`
	// trust_config block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_cluster#trust_config ManagedKafkaCluster#trust_config}
