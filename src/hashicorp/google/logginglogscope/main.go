...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingLogScope.LoggingLogScopeConfig",
		reflect.TypeOf((*LoggingLogScopeConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.loggingLogScope.LoggingLogScopeTimeouts",
		reflect.TypeOf((*LoggingLogScopeTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.loggingLogScope.LoggingLogScopeTimeoutsOutputReference",
