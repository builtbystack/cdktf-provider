...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/vmwareenginecluster/internal"
...
func (j *jsiiProxy_VmwareengineClusterDatastoreMountConfigList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewVmwareengineClusterDatastoreMountConfigList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) VmwareengineClusterDatastoreMountConfigList {
	_init_.Initialize()
...
func NewVmwareengineClusterDatastoreMountConfigList_Override(v VmwareengineClusterDatastoreMountConfigList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_VmwareengineClusterDatastoreMountConfigList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (v *jsiiProxy_VmwareengineClusterDatastoreMountConfigList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (v *jsiiProxy_VmwareengineClusterDatastoreMountConfigList) Resolve(_context cdktf.IResolveContext) interface{} {
