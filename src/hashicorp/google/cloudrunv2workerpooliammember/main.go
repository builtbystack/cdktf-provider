...
func init() {
	...
	_jsii_.RegisterClass(
		"google.cloudRunV2WorkerPoolIamMember.CloudRunV2WorkerPoolIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.cloudRunV2WorkerPoolIamMember.CloudRunV2WorkerPoolIamMemberConfig",
