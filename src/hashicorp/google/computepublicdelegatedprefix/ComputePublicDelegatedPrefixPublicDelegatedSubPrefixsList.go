...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/computepublicdelegatedprefix/internal"
...
func (j *jsiiProxy_ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList {
	_init_.Initialize()
...
func NewComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList_Override(c ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_ComputePublicDelegatedPrefixPublicDelegatedSubPrefixsList) Resolve(_context cdktf.IResolveContext) interface{} {
