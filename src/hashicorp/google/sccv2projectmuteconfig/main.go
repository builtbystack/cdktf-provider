...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccV2ProjectMuteConfig.SccV2ProjectMuteConfigConfig",
		reflect.TypeOf((*SccV2ProjectMuteConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccV2ProjectMuteConfig.SccV2ProjectMuteConfigTimeouts",
		reflect.TypeOf((*SccV2ProjectMuteConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccV2ProjectMuteConfig.SccV2ProjectMuteConfigTimeoutsOutputReference",
