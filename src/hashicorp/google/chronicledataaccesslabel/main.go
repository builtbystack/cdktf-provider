...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.chronicleDataAccessLabel.ChronicleDataAccessLabelConfig",
		reflect.TypeOf((*ChronicleDataAccessLabelConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.chronicleDataAccessLabel.ChronicleDataAccessLabelTimeouts",
		reflect.TypeOf((*ChronicleDataAccessLabelTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.chronicleDataAccessLabel.ChronicleDataAccessLabelTimeoutsOutputReference",
