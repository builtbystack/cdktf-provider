...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.managedKafkaTopic.ManagedKafkaTopicConfig",
		reflect.TypeOf((*ManagedKafkaTopicConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.managedKafkaTopic.ManagedKafkaTopicTimeouts",
		reflect.TypeOf((*ManagedKafkaTopicTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.managedKafkaTopic.ManagedKafkaTopicTimeoutsOutputReference",
