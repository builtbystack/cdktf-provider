...
type BigqueryJobQueryConnectionProperties struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_job#key BigqueryJob#key}
	Key *string `field:"required" json:"key" yaml:"key"`
	// The value of the property to set.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/bigquery_job#value BigqueryJob#value}
