...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.geminiRepositoryGroupIamBinding.GeminiRepositoryGroupIamBindingCondition",
		reflect.TypeOf((*GeminiRepositoryGroupIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.geminiRepositoryGroupIamBinding.GeminiRepositoryGroupIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.geminiRepositoryGroupIamBinding.GeminiRepositoryGroupIamBindingConfig",
