...
type DataprocClusterClusterConfigGceClusterConfigNodeGroupAffinity struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dataproc_cluster#node_group_uri DataprocCluster#node_group_uri}
