...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleBigqueryTables.DataGoogleBigqueryTablesConfig",
		reflect.TypeOf((*DataGoogleBigqueryTablesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTables",
		reflect.TypeOf((*DataGoogleBigqueryTablesTables)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTablesList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleBigqueryTables.DataGoogleBigqueryTablesTablesOutputReference",
