...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.networkServicesMesh.NetworkServicesMeshConfig",
		reflect.TypeOf((*NetworkServicesMeshConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.networkServicesMesh.NetworkServicesMeshTimeouts",
		reflect.TypeOf((*NetworkServicesMeshTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.networkServicesMesh.NetworkServicesMeshTimeoutsOutputReference",
