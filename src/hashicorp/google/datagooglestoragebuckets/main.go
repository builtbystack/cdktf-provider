...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleStorageBuckets.DataGoogleStorageBucketsBuckets",
		reflect.TypeOf((*DataGoogleStorageBucketsBuckets)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleStorageBuckets.DataGoogleStorageBucketsBucketsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleStorageBuckets.DataGoogleStorageBucketsConfig",
