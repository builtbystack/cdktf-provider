...
type FilestoreInstanceNetworksPscConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/filestore_instance#endpoint_project FilestoreInstance#endpoint_project}
