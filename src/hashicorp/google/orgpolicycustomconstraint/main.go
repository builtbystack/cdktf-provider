...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.orgPolicyCustomConstraint.OrgPolicyCustomConstraintConfig",
		reflect.TypeOf((*OrgPolicyCustomConstraintConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.orgPolicyCustomConstraint.OrgPolicyCustomConstraintTimeouts",
		reflect.TypeOf((*OrgPolicyCustomConstraintTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.orgPolicyCustomConstraint.OrgPolicyCustomConstraintTimeoutsOutputReference",
