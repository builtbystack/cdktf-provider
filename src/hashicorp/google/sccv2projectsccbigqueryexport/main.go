...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccV2ProjectSccBigQueryExport.SccV2ProjectSccBigQueryExportConfig",
		reflect.TypeOf((*SccV2ProjectSccBigQueryExportConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccV2ProjectSccBigQueryExport.SccV2ProjectSccBigQueryExportTimeouts",
		reflect.TypeOf((*SccV2ProjectSccBigQueryExportTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccV2ProjectSccBigQueryExport.SccV2ProjectSccBigQueryExportTimeoutsOutputReference",
