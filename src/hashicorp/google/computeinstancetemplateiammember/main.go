...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceTemplateIamMember.ComputeInstanceTemplateIamMemberCondition",
		reflect.TypeOf((*ComputeInstanceTemplateIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeInstanceTemplateIamMember.ComputeInstanceTemplateIamMemberConditionOutputReference",
