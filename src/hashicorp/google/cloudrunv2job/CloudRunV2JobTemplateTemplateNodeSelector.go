...
type CloudRunV2JobTemplateTemplateNodeSelector struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/cloud_run_v2_job#accelerator CloudRunV2Job#accelerator}
