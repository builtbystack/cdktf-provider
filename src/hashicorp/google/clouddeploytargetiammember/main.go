...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.clouddeployTargetIamMember.ClouddeployTargetIamMemberCondition",
		reflect.TypeOf((*ClouddeployTargetIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.clouddeployTargetIamMember.ClouddeployTargetIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.clouddeployTargetIamMember.ClouddeployTargetIamMemberConfig",
