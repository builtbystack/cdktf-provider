...
type ComputeSubnetworkSecondaryIpRange struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/compute_subnetwork#range_name ComputeSubnetwork#range_name}
