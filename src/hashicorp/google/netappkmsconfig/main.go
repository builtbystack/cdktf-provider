...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.netappKmsconfig.NetappKmsconfigConfig",
		reflect.TypeOf((*NetappKmsconfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.netappKmsconfig.NetappKmsconfigTimeouts",
		reflect.TypeOf((*NetappKmsconfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.netappKmsconfig.NetappKmsconfigTimeoutsOutputReference",
