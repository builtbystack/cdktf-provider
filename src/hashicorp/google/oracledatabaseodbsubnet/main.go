...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.oracleDatabaseOdbSubnet.OracleDatabaseOdbSubnetConfig",
		reflect.TypeOf((*OracleDatabaseOdbSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.oracleDatabaseOdbSubnet.OracleDatabaseOdbSubnetTimeouts",
		reflect.TypeOf((*OracleDatabaseOdbSubnetTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.oracleDatabaseOdbSubnet.OracleDatabaseOdbSubnetTimeoutsOutputReference",
