...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingFolderBucketConfig.LoggingFolderBucketConfigConfig",
	...
	_jsii_.RegisterClass(
		"google.loggingFolderBucketConfig.LoggingFolderBucketConfigIndexConfigsList",
	...
	_jsii_.RegisterClass(
		"google.loggingFolderBucketConfig.LoggingFolderBucketConfigIndexConfigsOutputReference",
