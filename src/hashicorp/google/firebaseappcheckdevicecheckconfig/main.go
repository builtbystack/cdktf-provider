...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckDeviceCheckConfig.FirebaseAppCheckDeviceCheckConfigConfig",
		reflect.TypeOf((*FirebaseAppCheckDeviceCheckConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckDeviceCheckConfig.FirebaseAppCheckDeviceCheckConfigTimeouts",
		reflect.TypeOf((*FirebaseAppCheckDeviceCheckConfigTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.firebaseAppCheckDeviceCheckConfig.FirebaseAppCheckDeviceCheckConfigTimeoutsOutputReference",
