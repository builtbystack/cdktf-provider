...
func init() {
	...
	_jsii_.RegisterClass(
		"google.containerAwsCluster.ContainerAwsClusterAuthorizationAdminGroupsList",
	...
	_jsii_.RegisterStruct(
		"google.containerAwsCluster.ContainerAwsClusterBinaryAuthorization",
		reflect.TypeOf((*ContainerAwsClusterBinaryAuthorization)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.containerAwsCluster.ContainerAwsClusterBinaryAuthorizationOutputReference",
