...
type TranscoderJobConfigOverlaysAnimations struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/transcoder_job#animation_fade TranscoderJob#animation_fade}
