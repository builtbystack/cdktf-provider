...
func (h *jsiiProxy_HypercomputeclusterClusterOrchestratorSlurmLoginNodesOutputReference) validatePutStorageConfigsParameters(value interface{}) error {
	...
	default:
		if !_jsii_.IsAnonymousProxy(value) {
			return fmt.Errorf("parameter value must be one of the allowed types: cdktf.IResolvable, *[]*HypercomputeclusterClusterOrchestratorSlurmLoginNodesStorageConfigs; received %#v (a %T)", value, value)
		}
	}
