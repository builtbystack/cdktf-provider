...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/hypercomputecluster_cluster google_hypercomputecluster_cluster}.
...
func (j *jsiiProxy_HypercomputeclusterCluster) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_HypercomputeclusterCluster) EffectiveLabels() cdktf.StringMap {
...
func (j *jsiiProxy_HypercomputeclusterCluster) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_HypercomputeclusterCluster) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_HypercomputeclusterCluster) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_HypercomputeclusterCluster) Reconciling() cdktf.IResolvable {
...
func (j *jsiiProxy_HypercomputeclusterCluster) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
func (j *jsiiProxy_HypercomputeclusterCluster) TerraformLabels() cdktf.StringMap {
	var returns cdktf.StringMap
	_jsii_.Get(
		j,
		"terraformLabels",
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/hypercomputecluster_cluster google_hypercomputecluster_cluster} Resource.
...
// Generates CDKTF code for importing a HypercomputeclusterCluster resource upon running "cdktf plan <stack-name>".
func HypercomputeclusterCluster_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (h *jsiiProxy_HypercomputeclusterCluster) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (h *jsiiProxy_HypercomputeclusterCluster) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (h *jsiiProxy_HypercomputeclusterCluster) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
