...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.managedKafkaConnector.ManagedKafkaConnectorConfig",
		reflect.TypeOf((*ManagedKafkaConnectorConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.managedKafkaConnector.ManagedKafkaConnectorTaskRestartPolicy",
	...
	_jsii_.RegisterStruct(
		"google.managedKafkaConnector.ManagedKafkaConnectorTimeouts",
