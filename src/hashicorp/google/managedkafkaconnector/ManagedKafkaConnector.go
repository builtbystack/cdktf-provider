...
// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_connector google_managed_kafka_connector}.
...
func (j *jsiiProxy_ManagedKafkaConnector) CdktfStack() cdktf.TerraformStack {
...
func (j *jsiiProxy_ManagedKafkaConnector) ForEach() cdktf.ITerraformIterator {
...
func (j *jsiiProxy_ManagedKafkaConnector) Lifecycle() *cdktf.TerraformResourceLifecycle {
...
func (j *jsiiProxy_ManagedKafkaConnector) Provider() cdktf.TerraformProvider {
...
func (j *jsiiProxy_ManagedKafkaConnector) TerraformGeneratorMetadata() *cdktf.TerraformProviderGeneratorMetadata {
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/managed_kafka_connector google_managed_kafka_connector} Resource.
func NewManagedKafkaConnector(scope constructs.Construct, id *string, config *ManagedKafkaConnectorConfig) ManagedKafkaConnector {
	...
	_jsii_.Create(
		"google.managedKafkaConnector.ManagedKafkaConnector",
...
// Generates CDKTF code for importing a ManagedKafkaConnector resource upon running "cdktf plan <stack-name>".
func ManagedKafkaConnector_GenerateConfigForImport(scope constructs.Construct, importToId *string, importFromId *string, provider cdktf.TerraformProvider) cdktf.ImportableResource {
	_init_.Initialize()
...
func (m *jsiiProxy_ManagedKafkaConnector) GetBooleanAttribute(terraformAttribute *string) cdktf.IResolvable {
...
func (m *jsiiProxy_ManagedKafkaConnector) ImportFrom(id *string, provider cdktf.TerraformProvider) {
...
func (m *jsiiProxy_ManagedKafkaConnector) InterpolationForAttribute(terraformAttribute *string) cdktf.IResolvable {
