...
type AppEngineFlexibleAppVersionDeploymentContainer struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/app_engine_flexible_app_version#image AppEngineFlexibleAppVersion#image}
