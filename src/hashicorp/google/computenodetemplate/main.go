...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeNodeTemplate.ComputeNodeTemplateAccelerators",
	...
	_jsii_.RegisterClass(
		"google.computeNodeTemplate.ComputeNodeTemplateAcceleratorsOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.computeNodeTemplate.ComputeNodeTemplateDisks",
		reflect.TypeOf((*ComputeNodeTemplateDisks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.computeNodeTemplate.ComputeNodeTemplateDisksList",
	...
	_jsii_.RegisterClass(
		"google.computeNodeTemplate.ComputeNodeTemplateDisksOutputReference",
