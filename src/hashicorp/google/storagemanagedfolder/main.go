...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.storageManagedFolder.StorageManagedFolderConfig",
		reflect.TypeOf((*StorageManagedFolderConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.storageManagedFolder.StorageManagedFolderTimeouts",
		reflect.TypeOf((*StorageManagedFolderTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.storageManagedFolder.StorageManagedFolderTimeoutsOutputReference",
