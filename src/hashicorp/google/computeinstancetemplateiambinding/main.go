...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceTemplateIamBinding.ComputeInstanceTemplateIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google.computeInstanceTemplateIamBinding.ComputeInstanceTemplateIamBindingConfig",
