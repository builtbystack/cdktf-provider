...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccProjectNotificationConfig.SccProjectNotificationConfigConfig",
		reflect.TypeOf((*SccProjectNotificationConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccProjectNotificationConfig.SccProjectNotificationConfigStreamingConfig",
		reflect.TypeOf((*SccProjectNotificationConfigStreamingConfig)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccProjectNotificationConfig.SccProjectNotificationConfigStreamingConfigOutputReference",
