...
func (j *jsiiProxy_CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList) TerraformResource() cdktf.IInterpolatingParent {
...
func NewCesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList(terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList {
	_init_.Initialize()
...
func NewCesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList_Override(c CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList, terraformResource cdktf.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList)SetTerraformResource(val cdktf.IInterpolatingParent) {
...
func (c *jsiiProxy_CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList) AllWithMapKey(mapKeyAttributeName *string) cdktf.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CesAppVersionSnapshotToolsDataStoreToolModalityConfigsRewriterConfigModelSettingsList) Resolve(_context cdktf.IResolveContext) interface{} {
