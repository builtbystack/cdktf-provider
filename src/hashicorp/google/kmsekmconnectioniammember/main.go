...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberCondition",
		reflect.TypeOf((*KmsEkmConnectionIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.kmsEkmConnectionIamMember.KmsEkmConnectionIamMemberConfig",
