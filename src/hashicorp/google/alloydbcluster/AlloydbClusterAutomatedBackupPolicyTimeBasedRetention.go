...
type AlloydbClusterAutomatedBackupPolicyTimeBasedRetention struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_cluster#retention_period AlloydbCluster#retention_period}
