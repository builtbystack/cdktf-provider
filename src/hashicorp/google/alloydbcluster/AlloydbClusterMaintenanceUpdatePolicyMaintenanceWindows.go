...
type AlloydbClusterMaintenanceUpdatePolicyMaintenanceWindows struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_cluster#day AlloydbCluster#day}
	Day *string `field:"required" json:"day" yaml:"day"`
	// start_time block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_cluster#start_time AlloydbCluster#start_time}
