...
type AlloydbClusterContinuousBackupConfigEncryptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_cluster#kms_key_name AlloydbCluster#kms_key_name}
