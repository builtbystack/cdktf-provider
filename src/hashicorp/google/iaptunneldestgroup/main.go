...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iapTunnelDestGroup.IapTunnelDestGroupConfig",
		reflect.TypeOf((*IapTunnelDestGroupConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.iapTunnelDestGroup.IapTunnelDestGroupTimeouts",
		reflect.TypeOf((*IapTunnelDestGroupTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iapTunnelDestGroup.IapTunnelDestGroupTimeoutsOutputReference",
