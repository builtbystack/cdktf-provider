...
type SqlDatabaseInstanceSettingsIpConfigurationPscConfigPscAutoConnections struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/sql_database_instance#consumer_network SqlDatabaseInstance#consumer_network}
	ConsumerNetwork *string `field:"required" json:"consumerNetwork" yaml:"consumerNetwork"`
	// The project ID of consumer service project of this consumer endpoint.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/sql_database_instance#consumer_service_project_id SqlDatabaseInstance#consumer_service_project_id}
