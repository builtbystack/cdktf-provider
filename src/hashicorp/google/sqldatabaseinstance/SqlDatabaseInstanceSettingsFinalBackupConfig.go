...
type SqlDatabaseInstanceSettingsFinalBackupConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/sql_database_instance#retention_days SqlDatabaseInstance#retention_days}
