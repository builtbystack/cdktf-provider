...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingFolderSettings.LoggingFolderSettingsConfig",
		reflect.TypeOf((*LoggingFolderSettingsConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.loggingFolderSettings.LoggingFolderSettingsTimeouts",
		reflect.TypeOf((*LoggingFolderSettingsTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.loggingFolderSettings.LoggingFolderSettingsTimeoutsOutputReference",
