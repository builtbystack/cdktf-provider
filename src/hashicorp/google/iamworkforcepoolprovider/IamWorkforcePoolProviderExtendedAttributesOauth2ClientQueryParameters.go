...
type IamWorkforcePoolProviderExtendedAttributesOauth2ClientQueryParameters struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/iam_workforce_pool_provider#filter IamWorkforcePoolProvider#filter}
