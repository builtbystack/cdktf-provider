...
type AlloydbBackupEncryptionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/alloydb_backup#kms_key_name AlloydbBackup#kms_key_name}
