...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.netappVolumeSnapshot.NetappVolumeSnapshotConfig",
		reflect.TypeOf((*NetappVolumeSnapshotConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.netappVolumeSnapshot.NetappVolumeSnapshotTimeouts",
		reflect.TypeOf((*NetappVolumeSnapshotTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.netappVolumeSnapshot.NetappVolumeSnapshotTimeoutsOutputReference",
