...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshotIamBinding.ComputeInstantSnapshotIamBindingCondition",
	...
	_jsii_.RegisterStruct(
		"google.computeInstantSnapshotIamBinding.ComputeInstantSnapshotIamBindingConfig",
