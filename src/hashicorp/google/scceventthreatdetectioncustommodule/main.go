...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccEventThreatDetectionCustomModule.SccEventThreatDetectionCustomModuleConfig",
		reflect.TypeOf((*SccEventThreatDetectionCustomModuleConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.sccEventThreatDetectionCustomModule.SccEventThreatDetectionCustomModuleTimeouts",
		reflect.TypeOf((*SccEventThreatDetectionCustomModuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccEventThreatDetectionCustomModule.SccEventThreatDetectionCustomModuleTimeoutsOutputReference",
