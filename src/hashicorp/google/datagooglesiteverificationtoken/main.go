...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenConfig",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeouts",
		reflect.TypeOf((*DataGoogleSiteVerificationTokenTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleSiteVerificationToken.DataGoogleSiteVerificationTokenTimeoutsOutputReference",
