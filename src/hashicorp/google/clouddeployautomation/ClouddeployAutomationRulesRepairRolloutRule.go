...
type ClouddeployAutomationRulesRepairRolloutRule struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/clouddeploy_automation#jobs ClouddeployAutomation#jobs}
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/clouddeploy_automation#phases ClouddeployAutomation#phases}
	Phases *[]*string `field:"optional" json:"phases" yaml:"phases"`
	// repair_phases block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/clouddeploy_automation#repair_phases ClouddeployAutomation#repair_phases}
