...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iamWorkforcePoolProviderScimToken.IamWorkforcePoolProviderScimTokenConfig",
		reflect.TypeOf((*IamWorkforcePoolProviderScimTokenConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.iamWorkforcePoolProviderScimToken.IamWorkforcePoolProviderScimTokenTimeouts",
