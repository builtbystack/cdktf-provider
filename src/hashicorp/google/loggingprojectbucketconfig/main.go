...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.loggingProjectBucketConfig.LoggingProjectBucketConfigIndexConfigs",
		reflect.TypeOf((*LoggingProjectBucketConfigIndexConfigs)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.loggingProjectBucketConfig.LoggingProjectBucketConfigIndexConfigsList",
	...
	_jsii_.RegisterClass(
		"google.loggingProjectBucketConfig.LoggingProjectBucketConfigIndexConfigsOutputReference",
