...
type GkeBackupRestorePlanRestoreConfigRestoreOrderGroupKindDependencies struct {
	// requiring block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/gke_backup_restore_plan#requiring GkeBackupRestorePlan#requiring}
	...
	// satisfying block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/gke_backup_restore_plan#satisfying GkeBackupRestorePlan#satisfying}
