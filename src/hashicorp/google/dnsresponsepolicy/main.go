...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dnsResponsePolicy.DnsResponsePolicyConfig",
	...
	_jsii_.RegisterStruct(
		"google.dnsResponsePolicy.DnsResponsePolicyTimeouts",
		reflect.TypeOf((*DnsResponsePolicyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dnsResponsePolicy.DnsResponsePolicyTimeoutsOutputReference",
