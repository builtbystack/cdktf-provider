...
type Cloudfunctions2FunctionServiceConfigSecretVolumesVersions struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/cloudfunctions2_function#path Cloudfunctions2Function#path}
