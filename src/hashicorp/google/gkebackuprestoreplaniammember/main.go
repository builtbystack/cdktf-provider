...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.gkeBackupRestorePlanIamMember.GkeBackupRestorePlanIamMemberCondition",
		reflect.TypeOf((*GkeBackupRestorePlanIamMemberCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.gkeBackupRestorePlanIamMember.GkeBackupRestorePlanIamMemberConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.gkeBackupRestorePlanIamMember.GkeBackupRestorePlanIamMemberConfig",
