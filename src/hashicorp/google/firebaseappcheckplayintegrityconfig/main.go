...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckPlayIntegrityConfig.FirebaseAppCheckPlayIntegrityConfigConfig",
		reflect.TypeOf((*FirebaseAppCheckPlayIntegrityConfigConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.firebaseAppCheckPlayIntegrityConfig.FirebaseAppCheckPlayIntegrityConfigTimeouts",
