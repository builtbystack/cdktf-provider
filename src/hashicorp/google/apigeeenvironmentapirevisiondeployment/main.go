...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.apigeeEnvironmentApiRevisionDeployment.ApigeeEnvironmentApiRevisionDeploymentConfig",
		reflect.TypeOf((*ApigeeEnvironmentApiRevisionDeploymentConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.apigeeEnvironmentApiRevisionDeployment.ApigeeEnvironmentApiRevisionDeploymentTimeouts",
