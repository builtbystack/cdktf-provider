...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/projectiammemberremove/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/project_iam_member_remove google_project_iam_member_remove}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/project_iam_member_remove google_project_iam_member_remove} Resource.
func NewProjectIamMemberRemove(scope constructs.Construct, id *string, config *ProjectIamMemberRemoveConfig) ProjectIamMemberRemove {
	...
	_jsii_.Create(
		"google.projectIamMemberRemove.ProjectIamMemberRemove",
