...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesConfig",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValue",
		reflect.TypeOf((*DataGoogleComputeInstanceGuestAttributesQueryValue)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValueList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeInstanceGuestAttributes.DataGoogleComputeInstanceGuestAttributesQueryValueOutputReference",
