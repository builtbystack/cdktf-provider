...
type DialogflowCxPlaybookInstructionSteps struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dialogflow_cx_playbook#text DialogflowCxPlaybook#text}
