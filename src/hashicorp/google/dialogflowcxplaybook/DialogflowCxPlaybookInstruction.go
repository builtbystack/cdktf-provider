...
type DialogflowCxPlaybookInstruction struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dialogflow_cx_playbook#guidelines DialogflowCxPlaybook#guidelines}
	Guidelines *string `field:"optional" json:"guidelines" yaml:"guidelines"`
	// steps block.
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/dialogflow_cx_playbook#steps DialogflowCxPlaybook#steps}
