...
type MemorystoreInstanceZoneDistributionConfig struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/memorystore_instance#zone MemorystoreInstance#zone}
