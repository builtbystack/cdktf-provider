...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkConfig",
		reflect.TypeOf((*OracleDatabaseOdbNetworkConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkTimeouts",
		reflect.TypeOf((*OracleDatabaseOdbNetworkTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkTimeoutsOutputReference",
