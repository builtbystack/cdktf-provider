...
type ApihubPluginInstanceActionsCurationConfigCustomCuration struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/apihub_plugin_instance#curation ApihubPluginInstance#curation}
