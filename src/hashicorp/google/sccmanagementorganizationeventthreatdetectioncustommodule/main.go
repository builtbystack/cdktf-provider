...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.sccManagementOrganizationEventThreatDetectionCustomModule.SccManagementOrganizationEventThreatDetectionCustomModuleTimeouts",
		reflect.TypeOf((*SccManagementOrganizationEventThreatDetectionCustomModuleTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.sccManagementOrganizationEventThreatDetectionCustomModule.SccManagementOrganizationEventThreatDetectionCustomModuleTimeoutsOutputReference",
