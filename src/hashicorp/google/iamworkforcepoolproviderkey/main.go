...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.iamWorkforcePoolProviderKey.IamWorkforcePoolProviderKeyConfig",
		reflect.TypeOf((*IamWorkforcePoolProviderKeyConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.iamWorkforcePoolProviderKey.IamWorkforcePoolProviderKeyKeyData",
		reflect.TypeOf((*IamWorkforcePoolProviderKeyKeyData)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iamWorkforcePoolProviderKey.IamWorkforcePoolProviderKeyKeyDataOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.iamWorkforcePoolProviderKey.IamWorkforcePoolProviderKeyTimeouts",
		reflect.TypeOf((*IamWorkforcePoolProviderKeyTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.iamWorkforcePoolProviderKey.IamWorkforcePoolProviderKeyTimeoutsOutputReference",
