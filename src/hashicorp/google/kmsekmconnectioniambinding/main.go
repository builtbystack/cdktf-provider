...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.kmsEkmConnectionIamBinding.KmsEkmConnectionIamBindingCondition",
		reflect.TypeOf((*KmsEkmConnectionIamBindingCondition)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.kmsEkmConnectionIamBinding.KmsEkmConnectionIamBindingConditionOutputReference",
	...
	_jsii_.RegisterStruct(
		"google.kmsEkmConnectionIamBinding.KmsEkmConnectionIamBindingConfig",
