...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryNpmPackages.DataGoogleArtifactRegistryNpmPackagesConfig",
		reflect.TypeOf((*DataGoogleArtifactRegistryNpmPackagesConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleArtifactRegistryNpmPackages.DataGoogleArtifactRegistryNpmPackagesNpmPackages",
