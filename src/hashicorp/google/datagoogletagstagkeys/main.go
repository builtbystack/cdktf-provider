...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysConfig",
		reflect.TypeOf((*DataGoogleTagsTagKeysConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeys",
		reflect.TypeOf((*DataGoogleTagsTagKeysKeys)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleTagsTagKeys.DataGoogleTagsTagKeysKeysOutputReference",
