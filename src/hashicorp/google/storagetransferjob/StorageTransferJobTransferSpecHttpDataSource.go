...
type StorageTransferJobTransferSpecHttpDataSource struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/storage_transfer_job#list_url StorageTransferJob#list_url}
