...
import (
	...
	"github.com/builtbystack/cdktf-provider/src/hashicorp/google/cloudquotasquotapreference/internal"
	"github.com/hashicorp/terraform-cdk-go/cdktf"
)

// Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/cloud_quotas_quota_preference google_cloud_quotas_quota_preference}.
...
// Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/cloud_quotas_quota_preference google_cloud_quotas_quota_preference} Resource.
func NewCloudQuotasQuotaPreference(scope constructs.Construct, id *string, config *CloudQuotasQuotaPreferenceConfig) CloudQuotasQuotaPreference {
	...
	_jsii_.Create(
		"google.cloudQuotasQuotaPreference.CloudQuotasQuotaPreference",
