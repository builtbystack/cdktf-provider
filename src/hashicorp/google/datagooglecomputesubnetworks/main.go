...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksConfig",
		reflect.TypeOf((*DataGoogleComputeSubnetworksConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworks",
		reflect.TypeOf((*DataGoogleComputeSubnetworksSubnetworks)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksList",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleComputeSubnetworks.DataGoogleComputeSubnetworksSubnetworksOutputReference",
