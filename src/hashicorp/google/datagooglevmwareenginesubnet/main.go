...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetConfig",
		reflect.TypeOf((*DataGoogleVmwareengineSubnetConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.dataGoogleVmwareengineSubnet.DataGoogleVmwareengineSubnetDhcpAddressRanges",
