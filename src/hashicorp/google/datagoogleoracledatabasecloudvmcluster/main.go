...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterConfig",
	...
	_jsii_.RegisterClass(
		"google.dataGoogleOracleDatabaseCloudVmCluster.DataGoogleOracleDatabaseCloudVmClusterPropertiesList",
