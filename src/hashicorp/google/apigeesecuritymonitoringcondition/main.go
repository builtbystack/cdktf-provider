...
func init() {
	...
	_jsii_.RegisterStruct(
		"google.apigeeSecurityMonitoringCondition.ApigeeSecurityMonitoringConditionConfig",
		reflect.TypeOf((*ApigeeSecurityMonitoringConditionConfig)(nil)).Elem(),
	)
	_jsii_.RegisterStruct(
		"google.apigeeSecurityMonitoringCondition.ApigeeSecurityMonitoringConditionIncludeAllResources",
	...
	_jsii_.RegisterStruct(
		"google.apigeeSecurityMonitoringCondition.ApigeeSecurityMonitoringConditionTimeouts",
		reflect.TypeOf((*ApigeeSecurityMonitoringConditionTimeouts)(nil)).Elem(),
	)
	_jsii_.RegisterClass(
		"google.apigeeSecurityMonitoringCondition.ApigeeSecurityMonitoringConditionTimeoutsOutputReference",
