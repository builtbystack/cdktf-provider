...
type ContainerAzureClusterControlPlaneMainVolume struct {
	...
	//
	// Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.24.0/docs/resources/container_azure_cluster#size_gib ContainerAzureCluster#size_gib}
